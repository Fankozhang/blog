...
```
 ...
 （2013,Lost connection to MySQL server during query 报错处理 长连接）

https://blog.csdn.net/weixin_39561473/article/details/90213914   （net_write_timeout = 900）
...
在阿里云服务器上要进行配置，否则navicat连接时报2003的错误，解决方法如下：

https://blog.csdn.net/kaifaxiaoliu/article/details/80403736

实例里面管理，加入安全组，并在安全组里配置 mysql的 3306 端口
