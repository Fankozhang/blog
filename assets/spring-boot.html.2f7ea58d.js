import{_ as p}from"./_plugin-vue_export-helper.cdc0426e.js";import{o,c as i,a as n,b as s,e as t,f as e,r as c}from"./app.da69e072.js";const l={},u=n("h1",{id:"springboot",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#springboot","aria-hidden":"true"},"#"),s(" springboot")],-1),r={href:"https://gitee.com/click33/springboot-pure",target:"_blank",rel:"noopener noreferrer"},d={id:"学前拓展-mybatis-b站视频资料",tabindex:"-1"},k=n("a",{class:"header-anchor",href:"#学前拓展-mybatis-b站视频资料","aria-hidden":"true"},"#",-1),v={href:"https://www.aliyundrive.com/drive/folder/64b62f7c7f489a9922244688af39ca6ae035ebb2",target:"_blank",rel:"noopener noreferrer"},m=n("p",null,"idea操作，编译报错解决",-1),b={href:"https://jingyan.baidu.com/article/48b558e35cbfc73e39c09a4e.html",target:"_blank",rel:"noopener noreferrer"},g=n("strong",null,"按下Ctrl+Shift+A",-1),h=n("p",null,"java： 错误：无效的源发行版：14",-1),y={href:"https://blog.csdn.net/weixin_43785284/article/details/122015400",target:"_blank",rel:"noopener noreferrer"},f=n("p",null,"JAVA‘无效目标发行版 17’的解决方案",-1),x={href:"https://blog.csdn.net/m0_67391121/article/details/126020133",target:"_blank",rel:"noopener noreferrer"},w=e(`<h2 id="springboot整合junit" tabindex="-1"><a class="header-anchor" href="#springboot整合junit" aria-hidden="true">#</a> springBoot整合junit</h2><p>1.导入测试对应的starter 2,测试类使用@SpringBootTest修饰 3,使用自动装配的形式添加要测试的对象</p><p>springBoot项目创建会自动生成测试类</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>example<span class="token punctuation">.</span>demo</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="表现层开发" tabindex="-1"><a class="header-anchor" href="#表现层开发" aria-hidden="true">#</a> 表现层开发</h3><p>​ 基于Restful进行表现层接口开发 ​ 使用Postman测试表现层接口功能</p><p>1.基于Restfu1制作表现层接口 新增：POST 删除：DELETE 修改：PUT 查询：GET 2.接收参数 实体数据：@RequestBody 路径变量：@PathVariable</p>`,92),_={href:"https://blog.csdn.net/CJPSR/article/details/131094717",target:"_blank",rel:"noopener noreferrer"},q=e(`<p>controller/BookController restful接口</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@RestController</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ProjectExceptionAdvice</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="打包" tabindex="-1"><a class="header-anchor" href="#打包" aria-hidden="true">#</a> 打包</h2><p>打开maven面板， 先clean,在点击package打包（点击 Toggle &#39;Skip Tests&#39;Mode 跳过测试过程，提示不安全）</p><p>（MAVEN:打包报错 Failed to execute goal org.apache.maven.plugins:maven-compiler-plugin:3.1:compile）</p>`,16),S={href:"https://blog.csdn.net/Int_Xu/article/details/108184768",target:"_blank",rel:"noopener noreferrer"},j=e(`<p>修改pom.xml （配置和版本如下）</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;build&gt;
		&lt;plugins&gt;
			&lt;plugin&gt;
		...
		&lt;/plugins&gt;
	&lt;/build&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>命令行 java -jar jar包文件名 运行</p><p>nohup java -jar jar包文件名</p><p>指定端口号 java -jar jar包文件名 <strong>--server.port=8085</strong></p>`,5),I={href:"https://blog.csdn.net/qq_44142640/article/details/111687863",target:"_blank",rel:"noopener noreferrer"},B={href:"https://blog.csdn.net/liu_feng_zi_/article/details/118730467",target:"_blank",rel:"noopener noreferrer"},T=e(`<p>打包后运行，按条件查询时，出现类似 evaluating expression ‘ew.sqlSegment != null and ew.sqlSegment != ‘‘ and ew. mybaties plus问题 的错误：原因是mybatis-plus的版本不兼容，（3.5.2可以正常使用）</p><p>Windonws.端口被占用</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#查询端口
netstat -ano
#查询指定端口
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>执行 使密码生效</strong> <code>flush privileges</code></p><p><strong>设置mysql远程登录</strong></p><p>1）切换数据库，使用use mysql;命令。</p><p>2）修改mysql库中host值，使用update user set host=&#39;%&#39; where user=&#39;root&#39; limit 1;命令。</p><p>3）刷新mysql权限，使用flush privileges;命令。</p><p>navicat连接虚拟机的MySQL连不上，查看打开修改虚拟机的端口</p>`,36),Q={href:"https://blog.csdn.net/weixin_49015210/article/details/117748687",target:"_blank",rel:"noopener noreferrer"},V=n("p",null,[s("服务器上指定端口号 java -jar jar包文件名 "),n("strong",null,"--server.port=8085"),s(" 运行jar包时，要开启端口号")],-1),z=n("p",null,"输入命令然后回车 /sbin/iptables -I INPUT -p tcp --dport 8085 -j ACCEPT",-1),F=n("p",null,"再次输入 iptables -vnL|grep 8085 回车即可看到8085端口状态信息",-1),H=n("p",null,"当端口都打开后，用postman测试接口，成功返回数据。",-1),X=n("p",null,"1.使用 jar 命令启动SpringBoot工程时可以使用临时属性替换配置文件中的属性 2.临时属性添加方式：java -jar 工程名.jar --属性名=值 3.多个临时属性之间使用空格分隔 4.临时属性必须是当前boot工程支持的属性，否则设置无效",-1),K=n("h3",{id:"扩展linux安装redis",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#扩展linux安装redis","aria-hidden":"true"},"#"),s(" 扩展linux安装redis")],-1),W=n("br",null,null,-1),G={href:"https://download.redis.io/releases/",target:"_blank",rel:"noopener noreferrer"},Y=n("p",null,"（注意下载版本，有的版本下载make报错）",-1),$=n("p",null,"2.解压安装包，命令：tar -zxvf redis-4.0.0.tar.gz -C /usr/local 3.安装Redis的依赖环境gcc,命令：yum install gcc-c++ 4.进入/usr/local/redis-4.0.0,进行编译，命令：make 5.进入redis的src目录，进行安装，命令：make install",-1),Z=n("p",null,"Linux中redis服务启动，可以使用redis-server,默认端口号为6379 ./redis.server",-1),nn=n("p",null,"Ctrl+C停止Redis服务",-1),sn=n("p",null,"启动redis客户端 ./redis-cli （命令keys * 查看所有数据 ）",-1),an=n("h3",{id:"扩展linux安装jdk",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#扩展linux安装jdk","aria-hidden":"true"},"#"),s(" 扩展linux安装jdk")],-1),tn={href:"https://blog.csdn.net/m0_50217781/article/details/112414571",target:"_blank",rel:"noopener noreferrer"},en={href:"https://so.csdn.net/so/search?q=openjdk&spm=1001.2101.3001.7020",target:"_blank",rel:"noopener noreferrer"},pn={href:"https://so.csdn.net/so/search?q=version&spm=1001.2101.3001.7020",target:"_blank",rel:"noopener noreferrer"},on=n("h3",{id:"linux下打开对外开放端口号",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#linux下打开对外开放端口号","aria-hidden":"true"},"#"),s(" linux下打开对外开放端口号")],-1),cn={href:"https://blog.csdn.net/laidanlove250/article/details/97667113",target:"_blank",rel:"noopener noreferrer"},ln=e(`<h2 id="临时属性设置-开发环境" tabindex="-1"><a class="header-anchor" href="#临时属性设置-开发环境" aria-hidden="true">#</a> 临时属性设置（开发环境）</h2><p>通过编程形式带参数启动SpringBoot程序，为程序添加运行参数</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@SpringBootApplication</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="springboot与maven的多环境兼容" tabindex="-1"><a class="header-anchor" href="#springboot与maven的多环境兼容" aria-hidden="true">#</a> springboot与maven的多环境兼容</h3>`,27),un={href:"https://blog.csdn.net/puzi0315/article/details/127196143",target:"_blank",rel:"noopener noreferrer"},rn=e(`<p>1 mave 的 pom.xml 下加入如下环境配置，每个profile配置一个环境变量， activation &gt; activeByDefault 为 true ,代表使用这个环境</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;profiles&gt;
        &lt;profile&gt;
            &lt;id&gt;dev&lt;/id&gt;
            &lt;properties&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3 执行Maven打包指令，并在生成的boot打包文件 .jar文件中查看对应信息</p><p>注意：</p><p>1 当Maven与SpringBoot同时对多环境进行控制时，以Mavn为主，SpringBoot使用@，，@占位符读取Maven.对应的配置属性值 2 基于SpringBoot读取Maveni配置属性的前提下，如果在Idea下测试工程时pom.xml每次更新需要手动compile方可生效</p><h2 id="日志" tabindex="-1"><a class="header-anchor" href="#日志" aria-hidden="true">#</a> 日志</h2><p>日志(log)作用：</p><p>编程期调试代码</p><p>运营期记录信息</p><p>​ 记录日常运营重要信息（峰值流量、平均响应时长…） ​ 记录应用报错信息（错误堆栈） ​ 记录运维过程数据（扩容、宕机、报警…)</p>`,12),dn={href:"https://blog.csdn.net/gjwloveforever/article/details/124774662",target:"_blank",rel:"noopener noreferrer"},kn=e(`<p>日志级别 TRACE:运行堆栈信息，使用率低 DEBUG:程序员调试代码使用 INFO:记录运维过程数据 WARN:记录运维过程报警数据 ERROR:记录错误堆栈信息 FATAL:灾难信息，合并计入ERROR</p><p>1,日志用于记录开发调试与运维过程消息 2,日志的级别共6种，通常使用4种即可，分别是DEBUG,INF0,WARN,ERROR 3,可以通过日志组或代码包的形式进行日志显示级别的控制</p><p>application.yml 日志配置</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">logging</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="热部署-只在开发环境有效" tabindex="-1"><a class="header-anchor" href="#热部署-只在开发环境有效" aria-hidden="true">#</a> 热部署（只在开发环境有效）</h2>`,5),vn={href:"https://blog.csdn.net/lwj_07/article/details/126226074",target:"_blank",rel:"noopener noreferrer"},mn=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>各种方式一定要加上devtools的依赖（在idea设置也需要引入devtools的依赖）
&lt;dependency&gt;
    &lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="springboot测试用例设置随机数据" tabindex="-1"><a class="header-anchor" href="#springboot测试用例设置随机数据" aria-hidden="true">#</a> SpringBoot测试用例设置随机数据</h3>`,52),bn={href:"https://blog.csdn.net/m0_45877477/article/details/125481585",target:"_blank",rel:"noopener noreferrer"},gn=e(`<h2 id="数据层解决方案" tabindex="-1"><a class="header-anchor" href="#数据层解决方案" aria-hidden="true">#</a> 数据层解决方案</h2><p>现有数据层解决方案技术选型 Druid +MyBatis-Plus +MySQL</p><h3 id="内嵌的数据源" tabindex="-1"><a class="header-anchor" href="#内嵌的数据源" aria-hidden="true">#</a> 内嵌的数据源</h3><p>SpringBoot提供了3种内嵌的数据源对象供开发者选择：</p><p>HikariCP:默认内置数据源对象 Tomcat提供DataSource：HikariCP不可用的情况下，且在web环境中，将使用tomcat服务器配置的数据源对象 Commons DBCP:Hikariz不可用，tomcat数据源也不可用，将使用dbcp数据源</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>spring:
  datasource:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="内置持久化解决方案一一jdbctemplate" tabindex="-1"><a class="header-anchor" href="#内置持久化解决方案一一jdbctemplate" aria-hidden="true">#</a> 内置持久化解决方案一一JdbcTemplate</h3>`,7),hn={href:"https://www.imooc.com/article/46879",target:"_blank",rel:"noopener noreferrer"},yn=e('<h3 id="内嵌数据库" tabindex="-1"><a class="header-anchor" href="#内嵌数据库" aria-hidden="true">#</a> 内嵌数据库</h3><p>SpringBoot提供了3种内嵌数据库供开发者选择，提高开发测试效率 H2，HSQL，Derby</p><h3 id="nosql-redis-mongo" tabindex="-1"><a class="header-anchor" href="#nosql-redis-mongo" aria-hidden="true">#</a> NoSQL（redis,mongo）</h3><p>市面上常见的NoSQL解决方案 Redis，Mongo，ES</p><h3 id="redis" tabindex="-1"><a class="header-anchor" href="#redis" aria-hidden="true">#</a> Redis</h3>',5),fn={href:"https://blog.csdn.net/weixin_45683550/article/details/122565733",target:"_blank",rel:"noopener noreferrer"},xn=n("p",null,"Redis是一款key-value存储结构的内存级NoSQL数据库 支持多种数据存储格式 支持持久化 支持集群",-1),wn={href:"https://www.bilibili.com/video/BV1CL411778r?p=1&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},_n={href:"https://juejin.cn/post/7103413121108148231?searchId=2023072217271551246D108BFEAC7A75B5",target:"_blank",rel:"noopener noreferrer"},qn={href:"https://juejin.cn/post/7225596319447187515?searchId=2023072217271551246D108BFEAC7A75B5#heading-18",target:"_blank",rel:"noopener noreferrer"},Sn={href:"https://juejin.cn/post/7083793185142505503?searchId=20230722175214B26171A4359A33735BBA",target:"_blank",rel:"noopener noreferrer"},jn=n("em",null,"redis可视化工具",-1),In={href:"https://gitee.com/qishibo/AnotherRedisDesktopManager/releases",target:"_blank",rel:"noopener noreferrer"},Bn=n("h5",{id:"springboot整合redis客户端",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#springboot整合redis客户端","aria-hidden":"true"},"#"),s(),n("strong",null,"springBoot整合redis"),s("客户端")],-1),Tn={href:"https://blog.csdn.net/lwj_07/article/details/126265935",target:"_blank",rel:"noopener noreferrer"},Cn={href:"https://blog.csdn.net/weixin_59654772/article/details/125692784",target:"_blank",rel:"noopener noreferrer"},Mn={href:"https://juejin.cn/post/7076244567569203208#heading-7",target:"_blank",rel:"noopener noreferrer"},Dn=e(`<p>依赖：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>        &lt;dependency&gt;
            &lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="redistemplate自定义配置及序列化" tabindex="-1"><a class="header-anchor" href="#redistemplate自定义配置及序列化" aria-hidden="true">#</a> RedisTemplate自定义配置及序列化</h5>`,11),Rn={href:"https://blog.csdn.net/Good_omen/article/details/123993468",target:"_blank",rel:"noopener noreferrer"},En={href:"https://blog.csdn.net/qq_58772217/article/details/128799831",target:"_blank",rel:"noopener noreferrer"},An={href:"https://blog.csdn.net/qq_51033936/article/details/127022985",target:"_blank",rel:"noopener noreferrer"},Pn=e(`<div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@Configuration</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="rediscache工具类封装" tabindex="-1"><a class="header-anchor" href="#rediscache工具类封装" aria-hidden="true">#</a> RedisCache工具类封装</h5>`,4),On={href:"https://blog.csdn.net/xiguasweet/article/details/105135242",target:"_blank",rel:"noopener noreferrer"},Ln=e(`<div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">RedisCache</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="redistemplate常用方法" tabindex="-1"><a class="header-anchor" href="#redistemplate常用方法" aria-hidden="true">#</a> RedisTemplate常用方法</h5>`,2),Nn={href:"https://blog.csdn.net/zzvar/article/details/118388897",target:"_blank",rel:"noopener noreferrer"},Jn={href:"https://juejin.cn/post/7175756564752990267#heading-48",target:"_blank",rel:"noopener noreferrer"},Un=n("h5",{id:"redistemplate-opsforvalue-方法",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#redistemplate-opsforvalue-方法","aria-hidden":"true"},"#"),s(" redisTemplate.opsForValue()方法")],-1),Qn={href:"https://blog.csdn.net/qq_43842093/article/details/121527498",target:"_blank",rel:"noopener noreferrer"},Vn={href:"https://blog.csdn.net/weixin_43658899/article/details/121062760",target:"_blank",rel:"noopener noreferrer"},zn=e(`<h5 id="redis使用-手机号获取验证码" tabindex="-1"><a class="header-anchor" href="#redis使用-手机号获取验证码" aria-hidden="true">#</a> redis使用（手机号获取验证码）</h5><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token comment">// redis测试</span>
...
<span class="token punctuation">}</span>
	...
	<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testProductQueue</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
		...
		<span class="token punctuation">}</span>
	<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="jedis" tabindex="-1"><a class="header-anchor" href="#jedis" aria-hidden="true">#</a> jedis</h5>`,13),Fn={href:"https://blog.csdn.net/I_r_o_n_M_a_n/article/details/122685882",target:"_blank",rel:"noopener noreferrer"},Hn=n("p",null,"lettcus与jedis区别 jedis连接Redis.服务器是直连模式，当多线程模式下使用jedis会存在线程安全问题，解决方案可以通过配置连接池使每个连接专用，这样整体性能就大受影响。 lettcus基于Netty框架进行与Redis服务器连接，底层设计中采用StatefulRedisConnection。StatefulRedisConnection自身是线程安全的，可以保障并发访问安全问题，所以一个连接可以被多线程复用。当然lettcus也支持多连接实例一起工作。",-1),Xn=n("h4",{id:"mongodb",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#mongodb","aria-hidden":"true"},"#"),s(" MongoDB")],-1),Kn=n("p",null,"MongoDB是一个开源、高性能、无模式的文档型数据库。NoSQL数据库产品中的一种，是最像关系型数据库的非 关系型数据库",-1),Wn=n("p",null,"MongoDB数据库的常用命令",-1),Gn={href:"https://blog.csdn.net/qq_55648724/article/details/128171457",target:"_blank",rel:"noopener noreferrer"},Yn=n("p",null,"springBoot整合 mongoDB",-1),$n={href:"https://blog.csdn.net/weixin_47343544/article/details/127175205",target:"_blank",rel:"noopener noreferrer"},Zn={href:"https://cloud.tencent.com/developer/article/2245018",target:"_blank",rel:"noopener noreferrer"},ns=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;!-- 引入mongodb--&gt;
        &lt;dependency&gt;
            &lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="elasticsearch-es" tabindex="-1"><a class="header-anchor" href="#elasticsearch-es" aria-hidden="true">#</a> Elasticsearch (ES)</h2><p>Elasticsearch是一个分布式全文搜索引擎(倒排索引)</p>`,4),ss={href:"https://www.elastic.co/cn/downloads/elasticsearch",target:"_blank",rel:"noopener noreferrer"},as={href:"https://blog.csdn.net/ganquanzhong/article/details/108633025",target:"_blank",rel:"noopener noreferrer"},ts={href:"https://mp.weixin.qq.com/s/7H8kjUcJNoQJRqwJTyfXOw",target:"_blank",rel:"noopener noreferrer"},es=n("p",null,"启动：bin/elasticsearch.bat",-1),ps=n("p",null,"warning: ignoring JAVA_HOME=C:\\Program Files\\Java\\jdk1.8.0_74; using bundled JDK",-1),os=n("p",null,"(jdk版本和elasticsearch版本不兼容，可以切换低版本的elasticsearch)",-1),is=n("p",null,"Elasticsearch 8.0报错：received plaintext http traffic on an https channel, closing connection",-1),cs=n("p",null,[s("解决： ES8默认开启了 SSL 认证。 "),n("strong",null,"使用 https 发送请求，即：把 http 请求改成 https 即可。")],-1),ls=n("p",null,"或者修改 config/elasticsearch.yml xpack.security.enabled: false",-1),us={href:"https://elasticsearch.bookhub.tech/",target:"_blank",rel:"noopener noreferrer"},rs={href:"https://blog.csdn.net/Acloasia/article/details/130683934",target:"_blank",rel:"noopener noreferrer"},ds={href:"https://juejin.cn/post/7074115690340286472",target:"_blank",rel:"noopener noreferrer"},ks=n("h3",{id:"docker-安装-es",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#docker-安装-es","aria-hidden":"true"},"#"),s(" docker 安装 es")],-1),vs={href:"https://juejin.cn/post/7074115690340286472",target:"_blank",rel:"noopener noreferrer"},ms=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 采用docker安装首先要确认网段，为了方便操作，我们直接创建一个网络
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="kibana安装-可视化工具" tabindex="-1"><a class="header-anchor" href="#kibana安装-可视化工具" aria-hidden="true">#</a> Kibana安装 (可视化工具)</h3><p>ELASTICSEARCH_HOSTS 需要改为自己的es地址</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker run -d \\
--name kibana \\
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="ik分词器安装-符合中文分词" tabindex="-1"><a class="header-anchor" href="#ik分词器安装-符合中文分词" aria-hidden="true">#</a> IK分词器安装 (符合中文分词)</h3><p>作用：创建倒排索引时对文档分词， 用户搜索时，对输入的文档分词</p>`,6),bs={href:"https://github.com/medcl/elasticsearch-analysis-ik/releases?page=8",target:"_blank",rel:"noopener noreferrer"},gs=e(`<p>docker volume inspect es-plugins 获取数据卷地址，将下载好的压缩包解压后改名为 ik 上传到数据卷的地址</p><p>docker restart elasticsearch 重启容器</p><p><code>IK</code>分词器包含两种模式：</p><ul><li><code>ik_smart</code>：最少切分，智能切分，粗粒度</li><li><code>ik_max_word</code>：最细切分，细粒度</li></ul><p>ik分词器设置，拓展和停用词条 ： ik目录下 修改<code>config/IKAnalyzer.cfg.xml</code></p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code><span class="token prolog">&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>properties</span><span class="token punctuation">&gt;</span></span>
	...
	<span class="token comment">&lt;!--此处使用ext.dic文件里面的拓展词，若当前目录下没有ext.dic文件，则自己创建这个文件并在里面添加自己要的拓展词--&gt;</span>
	<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>entry</span> <span class="token attr-name">key</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>ext_dict<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>ext.dic<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>entry</span><span class="token punctuation">&gt;</span></span>
	 ...
	 <span class="token comment">&lt;!--此处使用stopword.dic文件里面的拓展词，若当前目录下没有stopword.dic文件，则自己创建这个文件并在里面添加自己要的拓展停止词--&gt;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在不影响方法执行的情况下更新缓存时用CachePut</p><p>@CachePut(value=&quot;cacheSpace&quot;,key=&quot;#id&quot;)</p><p>不推荐将 @Cacheable 和 @CachePut 注解到同一个方法。</p><p>整合其他的缓存技术</p>`,23),fs={href:"https://blog.csdn.net/Learning_xzj/article/details/125510872",target:"_blank",rel:"noopener noreferrer"},xs={href:"https://blog.csdn.net/weixin_44299027/article/details/125559446",target:"_blank",rel:"noopener noreferrer"},ws={href:"https://gitee.com/ld/J2Cache",target:"_blank",rel:"noopener noreferrer"},_s=n("h2",{id:"任务",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#任务","aria-hidden":"true"},"#"),s(" 任务")],-1),qs=n("h3",{id:"定时任务",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#定时任务","aria-hidden":"true"},"#"),s(" 定时任务")],-1),Ss={href:"https://javaguide.cn/system-design/schedule-task.html#redis",target:"_blank",rel:"noopener noreferrer"},js=n("p",null,"市面上流行的定时任务技术：Quartz ，Spring Task",-1),Is=n("p",null,"springboot整合Quartz",-1),Bs=n("p",null,"相关概念： 工作（job):用于定义具体执行的工作 工作明细（JobDetail):用于描述定时工作相关的信息 触发器(Trigger):用于描述触发工作的规则，通常使用cron表达式定义调度规则 调度器(Scheduler):描述了工作明细与触发器的对应关系",-1),Ts=n("h4",{id:"xxl-job",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#xxl-job","aria-hidden":"true"},"#"),s(" xxl-job")],-1),Cs={href:"http://xuxueli.com",target:"_blank",rel:"noopener noreferrer"},Ms={href:"https://www.xuxueli.com/xxl-job/#1.5",target:"_blank",rel:"noopener noreferrer"},Ds={href:"https://blog.csdn.net/f2315895270/article/details/104714692",target:"_blank",rel:"noopener noreferrer"},Rs={href:"https://blog.csdn.net/qq_53775184/article/details/130843805",target:"_blank",rel:"noopener noreferrer"},Es={href:"https://blog.csdn.net/m0_52985087/article/details/135646151",target:"_blank",rel:"noopener noreferrer"},As=n("p",null,[n("strong",null,"源码仓库地址")],-1),Ps=n("thead",null,[n("tr",null,[n("th",{style:{"text-align":"left"}},"源码仓库地址"),n("th",{style:{"text-align":"left"}},"Release Download")])],-1),Os={style:{"text-align":"left"}},Ls={href:"https://github.com/xuxueli/xxl-job",target:"_blank",rel:"noopener noreferrer"},Ns={style:{"text-align":"left"}},Js={href:"https://github.com/xuxueli/xxl-job/releases",target:"_blank",rel:"noopener noreferrer"},Us={style:{"text-align":"left"}},Qs={href:"http://gitee.com/xuxueli0323/xxl-job",target:"_blank",rel:"noopener noreferrer"},Vs={style:{"text-align":"left"}},zs={href:"http://gitee.com/xuxueli0323/xxl-job/releases",target:"_blank",rel:"noopener noreferrer"},Fs=e(`<p>下载源码后，导入数据库文件（sql文件位于doc/db）</p><p>修改 xxl-job-admin 下的端口配置， （运行端口，数据库连接配置，邮件配置等，按需修改）</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token comment">### web   运行端口，网页打开的端口</span>
server.port=9090

<span class="token comment">### xxl-job, email(配置 报警邮箱配置  即调度任务失败时，可以把错误日志发送指定的负责人，通知他们去处理   )</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),Hs={href:"http://localhost:9090/xxl-job-admin/",target:"_blank",rel:"noopener noreferrer"},Xs={href:"https://blog.csdn.net/m0_37527542/article/details/104507810#:~:text=1xxl-job,%E6%88%B7%E7%AB%AF%E7%9A%84%E4%B8%93%E7%94%A8%E5%AF%86%E7%A0%81%E3%80%82",target:"_blank",rel:"noopener noreferrer"},Ks=e(`<p><strong>执行器管理（调用定时任务）：</strong></p><p>xxl-job-excutor-samples/xxl-job-excutor-samples-springboot/ 下修改配置文件</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token comment"># web port 执行器启动的端口</span>
server.port=9998

<span class="token comment"># xxl-admin 运行后的浏览器地址</span>
xxl.job.admin.addresses=http<span class="token punctuation">:</span>//127.0.0.1<span class="token punctuation">:</span>9090/xxl<span class="token punctuation">-</span>job<span class="token punctuation">-</span>admin

<span class="token comment"># 执行器的运行端口（网页配置执行器。手动输入时的机器地址   http://localhost:9999/）</span>
xxl.job.executor.port=9999
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>配置好文件之后，运行XxlJobExcutorApplication 。</p><p>网页上配置执行器管理-》任务管理增加定时任务-》调度日志查看定时器任务运行结果</p><p>定时任务的代码示例在 jobhandler文件下，可以参考示例编写自己的执行器代码，在网页配置任务的运行调度时间。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code>    <span class="token annotation punctuation">@XxlJob</span><span class="token punctuation">(</span><span class="token string">&quot;demoJobHandler1&quot;</span><span class="token punctuation">)</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">demoJobHandler1</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">&quot;demoJobHandler1&quot;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span>

	<span class="token comment">// 带参数的定时任务，参数从网页上获取，  多个参数可以用,隔开  </span>
    <span class="token annotation punctuation">@XxlJob</span><span class="token punctuation">(</span><span class="token string">&quot;demoJobHandler3&quot;</span><span class="token punctuation">)</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">demoJobHandler3</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
        ...
        <span class="token comment">// 多个参数用,隔开，获取每个参数</span>
        <span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> methodParams <span class="token operator">=</span> param<span class="token punctuation">.</span><span class="token function">split</span><span class="token punctuation">(</span><span class="token string">&quot;,&quot;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token comment">// 使用for循环遍历数组并打印每个参数</span>
        <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">int</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> methodParams<span class="token punctuation">.</span>length<span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
            <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">&quot;数组元素111: &quot;</span> <span class="token operator">+</span> methodParams<span class="token punctuation">[</span>i<span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><em><strong>springboot项目集成xxl-job</strong></em></p><p>在已有的Spring项目中集成XXL-JOB，你需要按照以下步骤进行：</p><ol><li><p><strong>引入依赖</strong>： 在你的Spring项目的<code>pom.xml</code>文件中，添加XXL-JOB的核心依赖。确保你使用的版本与你的项目兼容。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
    &lt;groupId&gt;com.xuxueli&lt;/groupId&gt;
    &lt;artifactId&gt;xxl-job-core&lt;/artifactId&gt;
    &lt;version&gt;2.4.0&lt;/version&gt; &lt;!-- 使用适合你项目的版本 --&gt;
&lt;/dependency&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p><strong>配置XXL-JOB</strong>： 在你的<code>application.properties</code>或<code>application.yml</code>文件中，添加XXL-JOB的配置信息。这些配置信息包括调度中心的地址、执行器的名称、端口号等。</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token comment"># web port</span>
server.port=9988
<span class="token comment"># no web</span>
<span class="token comment">#spring.main.web-environment=false</span>

<span class="token comment"># log config</span>
<span class="token comment">#logging.config=classpath:logback.xml</span>


<span class="token comment">### xxl-job admin address list, such as &quot;http://address&quot; or &quot;http://address01,http://address02&quot;  admin管理平台地址</span>
xxl.job.admin.addresses=http<span class="token punctuation">:</span>//127.0.0.1<span class="token punctuation">:</span>9090/xxl<span class="token punctuation">-</span>job<span class="token punctuation">-</span>admin

<span class="token comment">### xxl-job, access token</span>
xxl.job.accessToken=default_token

<span class="token comment">### xxl-job executor appname       执行器名称，在执行器管理中配置</span>
xxl.job.executor.appname=xxl<span class="token punctuation">-</span>job<span class="token punctuation">-</span>executor<span class="token punctuation">-</span>sample<span class="token punctuation">-</span>test      
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p><strong>创建配置类</strong>： 创建一个配置类来加载和设置XXL-JOB的配置。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@Configuration</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">XxlJobConfig</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p><strong>创建任务处理器</strong>： 创建一个或多个任务处理器类，并使用<code>@XxlJob</code>注解来标记任务方法。这些方法将被XXL-JOB调度执行。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@Component</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyJobHandler</span> <span class="token punctuation">{</span>
    <span class="token annotation punctuation">@XxlJob</span><span class="token punctuation">(</span><span class="token string">&quot;myJobHandler&quot;</span><span class="token punctuation">)</span>
    <span class="token keyword">public</span> <span class="token class-name">ReturnT</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">String</span><span class="token punctuation">&gt;</span></span> <span class="token function">myJobHandler</span><span class="token punctuation">(</span><span class="token class-name">String</span> param<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
        ...
        <span class="token comment">// 返回任务执行结果</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p><strong>启动XXL-JOB执行器</strong>： 确保你的Spring项目启动时，XXL-JOB的执行器也会随之启动。这通常在配置类中通过<code>@Bean</code>方法实现。</p></li><li><p><strong>在XXL-JOB管理平台配置任务</strong>： 在XXL-JOB的管理平台（调度中心）中，添加执行器并创建任务。指定任务的Cron表达式、路由策略等，并关联到你的任务处理器。</p></li><li><p><strong>启动项目并验证</strong>： 启动你的Spring项目，然后登录到XXL-JOB的管理平台，检查执行器是否已成功注册，并且可以开始配置和启动任务。</p></li></ol><p>以上步骤完成后，你的Spring项目应该已经成功集成了XXL-JOB，并且可以通过XXL-JOB的调度中心来管理和监控任务的执行。</p><h2 id="springboot-项目常用maven配置" tabindex="-1"><a class="header-anchor" href="#springboot-项目常用maven配置" aria-hidden="true">#</a> springBoot 项目常用maven配置</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;
...
reggie:
  #  指定上传文件暂存的位置
  path: D:\\img\\
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="jwt" tabindex="-1"><a class="header-anchor" href="#jwt" aria-hidden="true">#</a> JWT</h2><p>什么是JWT? JSON Web Token,通过数字签名的方式，以JSQN对象为载体，在不同的服务终端之间安全的传输信息。 JWT有什么用？ JW工最常见的场景就是授权认证，一旦用户登录，后续每个请求都将包含JWT，系统在每次处理用户请求的之前，都要先进行JWT安全校验，通过之后再进行处理。 JWT的组成 JWT由3部分组成，用拼接</p>`,17),Ws={href:"https://blog.csdn.net/qq_44972847/article/details/109249604",target:"_blank",rel:"noopener noreferrer"},Gs=e(`<ul><li>头部(header)</li><li>载荷(payload)</li><li>签证(signature)</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> &lt;dependency&gt;
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="登录" tabindex="-1"><a class="header-anchor" href="#登录" aria-hidden="true">#</a> 登录</h2><h3 id="工具类-jwtutil" tabindex="-1"><a class="header-anchor" href="#工具类-jwtutil" aria-hidden="true">#</a> <strong>工具类</strong> JwtUtil</h3>`,6),Ys={href:"https://blog.csdn.net/qq_51553982/article/details/122778454",target:"_blank",rel:"noopener noreferrer"},$s=e(`<div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token comment">//  工具类</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),Zs={href:"https://blog.csdn.net/qq_41450736/article/details/113523308",target:"_blank",rel:"noopener noreferrer"},na=n("h2",{id:"rabbitmq",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#rabbitmq","aria-hidden":"true"},"#"),s(" RabbitMQ")],-1),sa={href:"https://juejin.cn/post/7198430801850105916",target:"_blank",rel:"noopener noreferrer"},aa={href:"https://developer.aliyun.com/article/769883",target:"_blank",rel:"noopener noreferrer"},ta={href:"https://blog.csdn.net/huzecom/article/details/103499692",target:"_blank",rel:"noopener noreferrer"},ea={href:"https://www.bilibili.com/video/BV1Xm4y1i7HP?p=1&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},pa=e(`<h3 id="docker安装rabbitmq" tabindex="-1"><a class="header-anchor" href="#docker安装rabbitmq" aria-hidden="true">#</a> docker安装RabbitMQ</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker pull rabbitmq:management
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li><code>15672</code>端口：RabbitMQ的<strong>管理页面</strong>端口</li><li><code>5672</code>端口：RabbitMQ的<strong>消息接收</strong>端口</li><li><code>RABBITMQ_DEFAULT_USER</code>环境变量：指定RabbitMQ的<strong>用户名</strong>，这里我指定为<code>fankozhang</code>，大家部署时替换成自己定义的</li><li><code>RABBITMQ_DEFAULT_PASS</code>环境变量：指定RabbitMQ的<strong>密码</strong>，这里我指定为<code>123456</code>，大家部署时替换成自己定义的</li></ul><p>这样容器就部署完成了！在浏览器访问你的<code>服务器地址:15672</code>即可访问到RabbitMQ的管理界面，用户名和密码即为刚刚指定的环境变量的配置值。</p>`,6),oa={href:"http://127.0.0.1:15672",target:"_blank",rel:"noopener noreferrer"},ia=e("<p>RabbitMQ的组成，它是有这几部分：</p><ul><li>Broker：消息队列服务进程。此进程包括两个部分：Exchange和Queue。</li><li>Exchange：消息队列交换机。<strong>按一定的规则将消息路由转发到某个队列</strong>。</li><li>Queue：消息队列，存储消息的队列。</li><li>Producer：消息生产者。生产方客户端将消息同交换机路由发送到队列中。</li><li>Consumer：消息消费者。消费队列中存储的消息。</li></ul><p>这些组成部分是如何协同工作的呢，大概的流程如下</p><ul><li>消息生产者连接到RabbitMQ Broker，创建connection，开启channel。</li><li>生产者声明交换机类型、名称、是否持久化等。</li><li>生产者发送消息，并指定消息是否持久化等属性和routing key。</li><li>exchange收到消息之后，<strong>根据routing key路由到跟当前交换机绑定的相匹配的队列</strong>里面。</li><li>消费者监听接收到消息之后开始业务处理。</li></ul>",4),ca={id:"示例-b站视频地址",tabindex:"-1"},la=n("a",{class:"header-anchor",href:"#示例-b站视频地址","aria-hidden":"true"},"#",-1),ua={href:"https://www.bilibili.com/video/BV1Am4y1z7Tu?p=1&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},ra=e(`<p>创建生产者</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@SpringBootApplication</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="rabbitmq交换机类型" tabindex="-1"><a class="header-anchor" href="#rabbitmq交换机类型" aria-hidden="true">#</a> RabbitMQ交换机类型</h3>`,5),da={href:"https://www.cnblogs.com/hsiang/p/14747030.html",target:"_blank",rel:"noopener noreferrer"},ka=n("p",null,"RabbitMQ一共四种交换机，如下所示：",-1),va=n("ol",null,[n("li",null,"Direct Exchange：直连交换机，根据Routing Key(路由键)进行投递到不同队列。"),n("li",null,"Fanout Exchange：扇形交换机，采用广播模式，根据绑定的交换机，路由到与之对应的所有队列。"),n("li",null,"Topic Exchange：主题交换机，对路由键进行模式匹配后进行投递，符号#表示一个或多个词，*表示一个词。"),n("li",null,"Header Exchange：头交换机，不处理路由键。而是根据发送的消息内容中的headers属性进行匹配。")],-1),ma=n("h2",{id:"模板引擎-thymeleaf",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#模板引擎-thymeleaf","aria-hidden":"true"},"#"),s(" 模板引擎（thymeleaf）")],-1),ba={href:"https://blog.csdn.net/Lzy410992/article/details/115371017",target:"_blank",rel:"noopener noreferrer"},ga={href:"https://fanlychie.github.io/post/thymeleaf.html",target:"_blank",rel:"noopener noreferrer"},ha=e(`<p>依赖</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
			&lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;
			&lt;artifactId&gt;spring-boot-starter-thymeleaf&lt;/artifactId&gt;
		&lt;/dependency&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="实践" tabindex="-1"><a class="header-anchor" href="#实践" aria-hidden="true">#</a> 实践：</h3>`,3),ya=n("p",null,[s('resources/template/index.html (资源里面新建 index.html 文件) th:text="'),n("span",{class:"katex"},[n("span",{class:"katex-mathml"},[n("math",{xmlns:"http://www.w3.org/1998/Math/MathML"},[n("semantics",null,[n("mrow",null,[n("mrow",null,[n("mi",null,"m"),n("mi",null,"s"),n("mi",null,"g")]),n("mi",{mathvariant:"normal"},'"'),n("mtext",null,"的")]),n("annotation",{encoding:"application/x-tex"},'{msg}"的')])])]),n("span",{class:"katex-html","aria-hidden":"true"},[n("span",{class:"base"},[n("span",{class:"strut",style:{height:"0.8889em","vertical-align":"-0.1944em"}}),n("span",{class:"mord"},[n("span",{class:"mord mathnormal"},"m"),n("span",{class:"mord mathnormal"},"s"),n("span",{class:"mord mathnormal",style:{"margin-right":"0.03588em"}},"g")]),n("span",{class:"mord"},'"'),n("span",{class:"mord cjk_fallback"},"的")])])]),s("msg 是thymeleaf占位符语法")],-1),fa=e(`<div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">&gt;</span></span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> thymeController <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>输入网页地址，可以看到 msg 为 欢迎使用 thymeleaf 展示在 html 中</p><h3 id="整合thymeleaf-实现模板文件转word打印" tabindex="-1"><a class="header-anchor" href="#整合thymeleaf-实现模板文件转word打印" aria-hidden="true">#</a> 整合thymeleaf 实现模板文件转word打印</h3>`,5),xa={href:"https://blog.csdn.net/HXNLYW/article/details/106330927",target:"_blank",rel:"noopener noreferrer"},wa=n("h3",{id:"整合flyingsaucer-thymeleaf-实现模板文件转pdf打印",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#整合flyingsaucer-thymeleaf-实现模板文件转pdf打印","aria-hidden":"true"},"#"),s(" 整合FlyingSaucer + thymeleaf 实现模板文件转pdf打印")],-1),_a={href:"https://blog.csdn.net/HXNLYW/article/details/104478142",target:"_blank",rel:"noopener noreferrer"},qa=n("p",null,"字体文件放在 resources/static/font/simsun.ttf 位置 ，不加入字体文件导出pdf时会格式错误",-1),Sa={href:"https://wwmj.lanzoue.com/iYBOx1a6cbab",target:"_blank",rel:"noopener noreferrer"},ja=n("h2",{id:"模板引擎-thymeleaf-1",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#模板引擎-thymeleaf-1","aria-hidden":"true"},"#"),s(" 模板引擎（thymeleaf）")],-1),Ia=n("h2",{id:"文件相关",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#文件相关","aria-hidden":"true"},"#"),s(" 文件相关")],-1),Ba={href:"https://blog.csdn.net/qq_32419139/category_12269593.html",target:"_blank",rel:"noopener noreferrer"},Ta=n("h3",{id:"minio",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#minio","aria-hidden":"true"},"#"),s(" Minio")],-1),Ca=n("h4",{id:"linux-安装",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#linux-安装","aria-hidden":"true"},"#"),s(" linux 安装")],-1),Ma={href:"https://www.minio.org.cn/docs/minio/linux/index.html",target:"_blank",rel:"noopener noreferrer"},Da=n("h4",{id:"docker-安装-实测可用",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#docker-安装-实测可用","aria-hidden":"true"},"#"),s(" docker 安装（实测可用）")],-1),Ra={href:"https://blog.csdn.net/BThinker/article/details/125412751",target:"_blank",rel:"noopener noreferrer"},Ea=e('<p><strong>下载Minio镜像</strong></p><table><thead><tr><th style="text-align:left;">命令</th><th style="text-align:left;">描述</th></tr></thead><tbody><tr><td style="text-align:left;">docker pull minio/minio</td><td style="text-align:left;">下载最新版Minio镜像 (其实此命令就等同于 : docker pull minio/minio:latest )</td></tr><tr><td style="text-align:left;">docker pull minio/minio:RELEASE.2022-06-20T23-13-45Z.fips</td><td style="text-align:left;">下载指定版本的Minio镜像 (xxx指具体版本号)</td></tr></tbody></table>',2),Aa={href:"https://so.csdn.net/so/search?q=Docker&spm=1001.2101.3001.7020",target:"_blank",rel:"noopener noreferrer"},Pa=e(`<p><strong>创建目录</strong></p><blockquote><p>一个用来存放配置，一个用来存储上传文件的目录</p><p>启动前需要先创建Minio外部挂载的配置文件（ /home/minio/config）,和存储上传文件的目录（ /home/minio/data）</p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mkdir -p /home/minio/config
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>9090端口指的是minio的客户端端口</p><p>MINIO_ACCESS_KEY ：账号</p><p>MINIO_SECRET_KEY ：密码（账号长度必须大于等于5，密码长度必须大于等于8位）</p><p><strong>访问</strong></p>`,12),Oa={href:"http://127.0.0.1:9090/login",target:"_blank",rel:"noopener noreferrer"},La={href:"https://blog.csdn.net/destin223/article/details/134110194#:~:text=%E8%AE%BF%E9%97%AE%E6%96%87%E4%BB%B6%E7%BD%91%E5%9D%80%E4%B8%BA%EF%BC%9Aip%3Aaddress%2Fbucket%E7%9A%84%E5%90%8D%E5%AD%97%2F%E6%96%87%E4%BB%B6%E7%9A%84%E5%90%8D%E5%AD%97%E3%80%82,2%E3%80%81%E8%BF%9B%E5%85%A5%E9%A1%B5%E9%9D%A2%E5%90%8E%EF%BC%8C%E9%85%8D%E7%BD%AE%E5%8F%AA%E8%AF%BB%E8%AE%BF%E9%97%AE%E6%9D%83%E9%99%90%EF%BC%8Cprefix%E6%8C%89%E7%85%A7%E6%8F%90%E7%A4%BA%E8%BE%93%E5%85%A5%E5%B0%B1%E5%A5%BD%E3%80%82",target:"_blank",rel:"noopener noreferrer"},Na=n("p",null,"在minio上传的文件以 ip:address/bucket的名字/文件的名字 路径来访问",-1),Ja={href:"https://mp.weixin.qq.com/s/Ejz4RMt9m0nBgFFPGFtjrg",target:"_blank",rel:"noopener noreferrer"},Ua=n("h2",{id:"文章收藏",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#文章收藏","aria-hidden":"true"},"#"),s(" 文章收藏")],-1),Qa=n("h3",{id:"springboot-拦截器与统一功能处理",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#springboot-拦截器与统一功能处理","aria-hidden":"true"},"#"),s(" SpringBoot 拦截器与统一功能处理")],-1),Va={href:"https://mp.weixin.qq.com/s/evA1d1vY9Nqt72zFNQvgeA",target:"_blank",rel:"noopener noreferrer"},za=n("h3",{id:"dto、bo、po、vo",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#dto、bo、po、vo","aria-hidden":"true"},"#"),s(" DTO、BO、PO、VO")],-1),Fa={href:"https://juejin.cn/post/7334691453833166848",target:"_blank",rel:"noopener noreferrer"};function Ha(Xa,Ka){const a=c("ExternalLinkIcon");return o(),i("div",null,[u,n("p",null,[s("纯净的springBoot示例项目："),n("a",r,[s("刘潇/springboot-pure - 码云 - 开源中国 (gitee.com)"),t(a)])]),n("h3",d,[k,s(" 学前拓展：mybatis "),n("a",v,[s("B站视频资料"),t(a)])]),m,n("p",null,[n("a",b,[s("IDEA最右侧栏的Maven窗口不见了怎么调出来-百度经验 (baidu.com)"),t(a)]),s(),g]),h,n("p",null,[n("a",y,[s("https://blog.csdn.net/weixin_43785284/article/details/122015400"),t(a)])]),f,n("p",null,[n("a",x,[s("https://blog.csdn.net/m0_67391121/article/details/126020133"),t(a)])]),w,n("p",null,[n("a",_,[s("(228条消息) Controller层接收前端页面传参种类及实现_前端传值到controller_爱学习的小健的博客-CSDN博客"),t(a)])]),q,n("p",null,[n("a",S,[s("(210条消息) MAVEN:打包报错 Failed to execute goal org.apache.maven.plugins:maven-compiler-plugin:3.1:compile_Int_Xu的博客-CSDN博客"),t(a)])]),j,n("p",null,[n("a",I,[s("(227条消息) jar包在linux上持续运行及终止运行的命令_linux 停止持久运行_羊糕的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",B,[s("(227条消息) Linux 解决nohup: 忽略输入并把输出追加到“nohup.out“和nohup: 忽略输入重定向错误到标准输出端_千与千与千的博客-CSDN博客"),t(a)])]),T,n("p",null,[s("VIM中常用命令 "),n("a",C,[s("https://blog.csdn.net/feosun/article/details/73196299"),t(a)])]),M,D,R,n("p",null,[n("a",E,[s("(210条消息) linux 安装mysql8.0 超详细图文教程__亮亮同學的博客-CSDN博客"),t(a)])]),n("p",null,[s("安装mysql，进行初始化时失败报错 ： "),n("a",A,[s(" 初始化Mysql报错：初始化数据库显示libaio.so.1_兔飞小朋友的博客-CSDN博客"),t(a)])]),n("p",null,[s("报错：log-error set to '/var/log/mariadb/mariadb.log', however file don't exists. Create writable for user 'mysql'. "),n("a",P,[s("(219条消息) Linux安装MySQL时候出现log-error set to '/var/log/mariadb/mariadb.log', however file don't exists._BertonYip的博客-CSDN博客"),t(a)])]),O,n("p",null,[n("a",L,[s("(219条消息) Mysql 启动报错解析：Starting MySQL.. ERROR! The server quit without updating PID file (/usr/local/mysql/dat_清风的BLOG的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",N,[s("Linux 安装 MySQL 8.0.26 超详细图文步骤 - yoodb - 博客园 (cnblogs.com)"),t(a)]),s(" (实测有效)")]),n("p",null,[n("a",J,[s("(210条消息) Linux怎样到切换到超级用户_linux超级用户权限怎么打开_bo_无问西东的博客-CSDN博客"),t(a)])]),U,n("p",null,[n("a",Q,[s("(210条消息) 05.navicat连接不上虚拟机内的mysql_navicat连不上虚拟机中的mysql_weixin_49015210的博客-CSDN博客"),t(a)])]),V,z,F,H,X,K,n("p",null,[s("Redis下载与安装"),W,s(" 在Linux系统安装Redis步骤： 1.将Redis安装包上传到Linux 下载地址("),n("a",G,[s("https://download.redis.io/releases/"),t(a)]),s(")")]),Y,$,Z,nn,sn,an,n("p",null,[n("a",tn,[s("(227条消息) linux 安装jdk 两种方法：手动安装 和yum安装：_阿尔卑斯狼__的博客-CSDN博客"),t(a)])]),n("p",null,[s("yum install -y java-1.8.0-"),n("a",en,[s("openjdk"),t(a)]),s(".x86_64")]),n("p",null,[s("查看 java -"),n("a",pn,[s("version"),t(a)])]),on,n("p",null,[n("a",cn,[s("(227条消息) linux下打开对外开放端口号_linux开通端口_laidanlove250的博客-CSDN博客"),t(a)])]),ln,n("p",null,[n("a",un,[s("(214条消息) springboot与maven的多环境兼容解决方案_springboot兼容pom_沐雪架构师的博客-CSDN博客"),t(a)])]),rn,n("p",null,[n("a",dn,[s("(214条消息) SpringBoot的日志_springboot 日志_威少总冠军的博客-CSDN博客"),t(a)])]),kn,n("p",null,[n("a",vn,[s("(214条消息) springboot实现热部署_springboot热部署_lwj_07的博客-CSDN博客"),t(a)])]),mn,n("p",null,[n("a",bn,[s("(215条消息) SpringBoot测试用例设置随机数据_springboot生成随机id_梨轻巧的博客-CSDN博客"),t(a)])]),gn,n("p",null,[n("a",hn,[s("SpringBoot使用JdbcTemplate_慕课手记 (imooc.com)"),t(a)])]),yn,n("p",null,[n("a",fn,[s("Redis 详解-CSDN博客"),t(a)])]),xn,n("p",null,[n("a",wn,[s("参考B站redis视频"),t(a)])]),n("p",null,[s("redis配置文件： "),n("a",_n,[s("Redis配置文件详解 - 掘金 (juejin.cn)"),t(a)]),s(),n("a",qn,[s("Redis配置文件Redis.conf详解 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[s("redis 常用指令 "),n("a",Sn,[s("redis 常用指令 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[jn,s(),n("a",In,[s("https://gitee.com/qishibo/AnotherRedisDesktopManager/releases"),t(a)])]),Bn,n("p",null,[s("参考： "),n("a",Tn,[s("(215条消息) springboot整合redis_springboot redis_lwj_07的博客-CSDN博客"),t(a)])]),n("p",null,[s("​ "),n("a",Cn,[s("(215条消息) 如何用SpringBoot整合Redis（详细讲解~）_我是一棵卷心菜的博客-CSDN博客"),t(a)])]),n("p",null,[s("​ "),n("a",Mn,[s("SpringBoot教程(十四) | SpringBoot集成Redis(全网最全) - 掘金 (juejin.cn)"),t(a)])]),Dn,n("p",null,[s("增加RedisConfig的配置类（ "),n("a",Rn,[s(" redistemplate使用前需要配置一下connectionfactory和序列化方式_"),t(a)]),s(" ）")]),n("p",null,[n("a",En,[s("redis配置序列化_redis序列化-CSDN博客"),t(a)])]),n("p",null,[n("a",An,[s("【精选】最详细 | redis实战:JackSon/FastJson方式序列化深度解析_redis使用fastjson序列化_阿千弟的博客-CSDN博客"),t(a)])]),Pn,n("p",null,[n("a",On,[s("RedisCache redis工具类_rediscache.setcacheobject-CSDN博客"),t(a)])]),Ln,n("p",null,[n("a",Nn,[s("(230条消息) RedisTemplate常用方法（超详细）_Yan Yang的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",Jn,[s("RedisTemplate操作Redis，这一篇文章就够了（一） - 掘金 (juejin.cn)"),t(a)])]),Un,n("p",null,[n("a",Qn,[s("(230条消息) redisTemplate.opsForValue()中方法讲解_Archie_java的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",Vn,[s("(230条消息) RedisTemplate使用最详解（一）--- opsForValue()_opsforvalue().set_学习中啊哈哈的博客-CSDN博客"),t(a)])]),zn,n("p",null,[n("a",Fn,[s("(216条消息) Redis 基础 Jedis -- Jedis（Java程序操作Redis的工具）_CodeJiao的博客-CSDN博客"),t(a)])]),Hn,Xn,Kn,Wn,n("p",null,[n("a",Gn,[s("(216条消息) MongoDB数据库的常用命令_mongodb数据库命令_勤奋上进的兔子的博客-CSDN博客"),t(a)])]),Yn,n("p",null,[n("a",$n,[s("(216条消息) 《SpringBoot篇》15.SpringBoot整合MongoDB超详细教程（包括安装教程）_springboot mongodb_陈老老老板的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",Zn,[s("全面学习MongoDB，在Spring Boot项目中整合 MongoDB-腾讯云开发者社区-腾讯云 (tencent.com)"),t(a)])]),ns,n("p",null,[s("下载： "),n("a",ss,[s("Download Elasticsearch | Elastic"),t(a)])]),n("p",null,[s("文档参考： "),n("a",as,[s("(217条消息) ElasticSearch使用教程、设计到实战_ForFuture Code的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",ts,[s("一口气看完43个关于 ElasticSearch 的使用建议 (qq.com)"),t(a)])]),es,ps,os,is,cs,ls,n("p",null,[n("a",us,[s("https://elasticsearch.bookhub.tech/"),t(a)])]),n("p",null,[s("基于Docker安装Elasticsearch:"),n("a",rs,[s("https://blog.csdn.net/Acloasia/article/details/130683934"),t(a)])]),n("p",null,[s("确认可使用，版本较低，Docker安装ElasticSearch教程:"),n("a",ds,[s("https://juejin.cn/post/7074115690340286472"),t(a)])]),ks,n("p",null,[n("a",vs,[s("https://juejin.cn/post/7074115690340286472"),t(a)])]),ms,n("p",null,[s("下载地址："),n("a",bs,[s("Releases · medcl/elasticsearch-analysis-ik · GitHub"),t(a)])]),gs,n("p",null,[s("docker 启动容器报 iptables: No chain/target/match by that name:"),n("a",hs,[s("https://blog.csdn.net/JineD/article/details/113886368"),t(a)])]),ys,n("p",null,[n("a",fs,[s("(218条消息) 【SpringBoot整合缓存】-----Redis缓存篇_springboot redis缓存_潮浪之巅的博客-CSDN博客"),t(a)]),s(),n("a",xs,[s("(218条消息) 【JetCache】JetCache的使用方法与步骤_No8g攻城狮的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",ws,[s("J2Cache: Java 两级缓存框架，可以让应用支持两级缓存框架 ehcache(Caffeine) + redis 。避免完全使用独立缓存系统所带来的网络IO开销问题 (gitee.com)"),t(a)])]),_s,qs,n("p",null,[n("a",Ss,[s("Java 定时任务详解 | JavaGuide"),t(a)])]),js,Is,Bs,Ts,n("p",null,[s("[分布式任务调度平台XXL-JOB ("),n("a",Cs,[s("xuxueli.com"),t(a)]),s(")]("),n("a",Ms,[s("https://www.xuxueli.com/xxl-job/#1.5"),t(a)]),s(" 下载)")]),n("p",null,[n("a",Ds,[s("XXL-JOB的使用(详细教程)-CSDN博客"),t(a)]),s(),n("a",Rs,[s("xxl-job的配置和使用步骤（Xxl-job保姆级基础使用教程）_xxljob 配置-CSDN博客"),t(a)])]),n("p",null,[s("XXL-Job的搭建&接入Springboot项目（详细）："),n("a",Es,[s("https://blog.csdn.net/m0_52985087/article/details/135646151"),t(a)])]),As,n("table",null,[Ps,n("tbody",null,[n("tr",null,[n("td",Os,[n("a",Ls,[s("https://github.com/xuxueli/xxl-job"),t(a)])]),n("td",Ns,[n("a",Js,[s("Download"),t(a)])])]),n("tr",null,[n("td",Us,[n("a",Qs,[s("http://gitee.com/xuxueli0323/xxl-job"),t(a)])]),n("td",Vs,[n("a",zs,[s("Download"),t(a)])])])])]),Fs,n("p",null,[s("运行xxl-job-admin，在浏览器中输入 "),n("a",Hs,[s("http://localhost:9090/xxl-job-admin/"),t(a)]),s(" （我修改的端口是9090），打开管理页面（默认账户admn，密码123456）")]),n("p",null,[s("（报警邮箱配置的设置参考 ： "),n("a",Xs,[s("xxl-job报警邮箱配置_xxljob使用其他的邮件-CSDN博客"),t(a)]),s("）")]),Ks,n("p",null,[n("a",Ws,[s("(228条消息) JWT的组成_Jint001的博客-CSDN博客"),t(a)])]),Gs,n("p",null,[n("a",Ys,[s("JWT工具类（拿来直接用就完了，注释解释的很详细）_/** * jwt 工具类 * * @author json * @date 2021/11/15 -CSDN博客"),t(a)])]),$s,n("p",null,[n("a",Zs,[s("(228条消息) 使用springBoot实现token校验_springboot 校验token_秃头小陈~的博客-CSDN博客"),t(a)])]),na,n("p",null,[s("参考文档： "),n("a",sa,[s("Docker安装部署RabbitMQ - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",aa,[s("超详细的RabbitMQ入门"),t(a)])]),n("p",null,[n("a",ta,[s("RabbitMQ详解之你要的RabbitMQ这里都有_adobehu的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",ea,[s("01-今日课程介绍_哔哩哔哩_bilibili"),t(a)])]),pa,n("p",null,[n("a",oa,[s("http://127.0.0.1:15672"),t(a)]),s(" （使用服务器的 ip 地址） 打开RabbitMQ的管理页面（使用设置的用户名和密码可以登录进去）")]),ia,n("h4",ca,[la,s(" 示例（ "),n("a",ua,[s("B站视频地址"),t(a)]),s(" ）")]),ra,n("p",null,[n("a",da,[s("RabbitMQ交换机类型简述 "),t(a)])]),ka,va,ma,n("p",null,[n("a",ba,[s("Thymeleaf基本使用_thymeleaf ui-CSDN博客"),t(a)])]),n("p",null,[n("a",ga,[s("Thymeleaf 教程 | 範宗雲 (fanlychie.github.io)"),t(a)])]),ha,ya,fa,n("p",null,[n("a",xa,[s("整合thymeleaf 实现模板文件转word打印_springboot导出word纸张大小-CSDN博客"),t(a)])]),wa,n("p",null,[n("a",_a,[s("《SpringBoot2.0 实战》系列-整合FlyingSaucer + thymeleaf 实现模板文件转pdf打印-CSDN博客"),t(a)])]),qa,n("p",null,[n("a",Sa,[s("https://wwmj.lanzoue.com/iYBOx1a6cbab"),t(a)]),s(" 密码:guv2")]),ja,Ia,n("p",null,[n("a",Ba,[s("文件相关_寂寞旅行的博客-CSDN博客"),t(a)])]),Ta,Ca,n("p",null,[n("a",Ma,[s("MinIO对象存储 Linux — MinIO中文文档 | MinIO Linux中文文档"),t(a)])]),Da,n("p",null,[n("a",Ra,[s("Docker 搭建 Minio 容器 (完整详细版)_docker minio-CSDN博客"),t(a)])]),Ea,n("p",null,[n("strong",null,[s("检查当前所有"),n("a",Aa,[s("Docker"),t(a)]),s("下载的镜像")]),s(" docker images")]),Pa,n("p",null,[s("访问："),n("a",Oa,[s("http://127.0.0.1:9090/login"),t(a)]),s(" 用户名：密码 minioadmin：minioadmin （自己设置的）")]),n("p",null,[n("a",La,[s("minIO设置直接通过访问链接在浏览器中打开文件_minio直接访问文件-CSDN博客"),t(a)])]),Na,n("p",null,[s("实测可用（java使用 minio）："),n("a",Ja,[s("Docker 搭建 Minio 容器 (完整详细版) (qq.com)"),t(a)])]),Ua,Qa,n("p",null,[n("a",Va,[s("告别繁琐：SpringBoot 拦截器与统一功能处理 (qq.com)"),t(a)])]),za,n("p",null,[n("a",Fa,[s("https://juejin.cn/post/7334691453833166848"),t(a)])])])}const Ya=p(l,[["render",Ha],["__file","spring-boot.html.vue"]]);export{Ya as default};
