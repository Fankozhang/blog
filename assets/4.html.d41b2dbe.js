...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue内置组件的component标签" tabindex="-1"><a class="header-anchor" href="#vue内置组件的component标签" aria-hidden="true">#</a> Vue内置组件的component标签</h2>`,10),S={href:"https://blog.csdn.net/lwc_1234/article/details/122533764",target:"_blank",rel:"noopener noreferrer"},C=e(`<h2 id="element-ui按需导入" tabindex="-1"><a class="header-anchor" href="#element-ui按需导入" aria-hidden="true">#</a> element ui按需导入</h2><p><code>cnpm install element-ui --save-dev</code></p><p>main.js</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>import {
    Button,
    Popover,
    Cascader,
    CascaderPanel
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="vue实现登录后跳转到之前的页面" tabindex="-1"><a class="header-anchor" href="#vue实现登录后跳转到之前的页面" aria-hidden="true">#</a> vue实现登录后跳转到之前的页面</h2>`,7),V={href:"https://blog.csdn.net/longzhoufeng/article/details/106646698",target:"_blank",rel:"noopener noreferrer"},E=e(`<p>main.js</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>router.beforeEach((to, from, next) =&gt; {
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vuex的基本使用-pinia的基本使用" tabindex="-1"><a class="header-anchor" href="#vuex的基本使用-pinia的基本使用" aria-hidden="true">#</a> vuex的基本使用 pinia的基本使用</h2>`,10),R={href:"https://pinia.web3doc.top/getting-started.html",target:"_blank",rel:"noopener noreferrer"},z=n("p",null,"vuex的基本使用可以查看以下文章：",-1),N={href:"https://juejin.cn/post/6928468842377117709",target:"_blank",rel:"noopener noreferrer"},P={href:"https://juejin.cn/post/6994337441314242590#heading-15",target:"_blank",rel:"noopener noreferrer"},D={href:"https://juejin.cn/post/7087100496762109983#heading-16",target:"_blank",rel:"noopener noreferrer"},M=n("p",null,"pinia的基本使用可以查看以下文章： (pinia相比vuex简单很多)",-1),L={href:"https://juejin.cn/post/7078281612013764616#heading-0",target:"_blank",rel:"noopener noreferrer"},T=n("h2",{id:"vue实现全屏滚动",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue实现全屏滚动","aria-hidden":"true"},"#"),s(" vue实现全屏滚动")],-1),H={href:"http://www.htmleaf.com/plus/search.php",target:"_blank",rel:"noopener noreferrer"},A={href:"https://developer.aliyun.com/article/835013",target:"_blank",rel:"noopener noreferrer"},F=e(`<p>.vue文件</p><p>@mousewheel.prevent 鼠标滚动，实现页面的切换</p><p>@keyup.prevent 点击键盘实现页面滚动，此处为键盘上下键点击实现页面滚动</p><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>fullPage<span class="token punctuation">&quot;</span></span> <span class="token attr-name">ref</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>fullPage<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
...
<span class="token literal-property property">methods</span><span class="token operator">:</span><span class="token punctuation">{</span>
   <span class="token function">next</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span> <span class="token comment">// 往下切换</span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue项目跳转时如何加密路由上面query传递的参数" tabindex="-1"><a class="header-anchor" href="#vue项目跳转时如何加密路由上面query传递的参数" aria-hidden="true">#</a> vue项目跳转时如何加密路由上面query传递的参数</h2>`,9),B={href:"https://blog.csdn.net/weixin_44243061/article/details/107092308",target:"_blank",rel:"noopener noreferrer"},O={href:"https://github.com/wukang0718/vueRouterEncryption",target:"_blank",rel:"noopener noreferrer"},J=n("p",null,"(实际使用有bug,在新页面打开带参数的url时，加密的参数并不能够解析出来)",-1),I=n("h2",{id:"后端返回很大的数据量-前端如何渲染",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#后端返回很大的数据量-前端如何渲染","aria-hidden":"true"},"#"),s(" 后端返回很大的数据量，前端如何渲染")],-1),U={href:"https://mp.weixin.qq.com/s/pWsntJbJnBip5CbP7HkvFg",target:"_blank",rel:"noopener noreferrer"},X=n("h2",{id:"vite创建vue3项目",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vite创建vue3项目","aria-hidden":"true"},"#"),s(" vite创建vue3项目")],-1),W={href:"https://juejin.cn/post/7276408879365636156",target:"_blank",rel:"noopener noreferrer"},G={href:"https://juejin.cn/post/7156957907890733063",target:"_blank",rel:"noopener noreferrer"},$=e(`<p>普通创建vite项目</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm init vite@latest
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>除了前端配置代理之外，后台也要配置跨域，否则请求不到，后台跨域解决可以参考下面的文章</p>`,39),Y={href:"https://juejin.cn/post/7229139006080253989",target:"_blank",rel:"noopener noreferrer"},K={href:"https://blog.csdn.net/qq_40185480/article/details/110926273",target:"_blank",rel:"noopener noreferrer"},Q=n("h4",{id:"配置pinia",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#配置pinia","aria-hidden":"true"},"#"),s(" 配置pinia")],-1),Z={href:"https://mp.weixin.qq.com/s/vxjPAuwQjLd75nt4RPCR8A",target:"_blank",rel:"noopener noreferrer"},nn=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install pinia
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="树形结构插件-vue2-org-tree-组织结构图" tabindex="-1"><a class="header-anchor" href="#树形结构插件-vue2-org-tree-组织结构图" aria-hidden="true">#</a> 树形结构插件 vue2-org-tree(组织结构图)</h3>`,12),sn={href:"https://juejin.cn/post/7011705093665849375",target:"_blank",rel:"noopener noreferrer"},an={href:"https://zhuanlan.zhihu.com/p/117300250",target:"_blank",rel:"noopener noreferrer"},tn=e(`<h3 id="vue3-中引入wangeditor富文本编辑器" tabindex="-1"><a class="header-anchor" href="#vue3-中引入wangeditor富文本编辑器" aria-hidden="true">#</a> Vue3 中引入wangeditor富文本编辑器</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i wangeditor -S
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行 npm run build:css 打包css代码，注意文件路径报错</p><h3 id="发布" tabindex="-1"><a class="header-anchor" href="#发布" aria-hidden="true">#</a> 发布</h3>`,37),vn={href:"https://mp.weixin.qq.com/s/clyH5SFvwtPY19dagUgcDA",target:"_blank",rel:"noopener noreferrer"},mn=e(`<p>1、准备一个npm账号</p><p>2、npm login 登录npm账号</p><p>3、npm publish (推送代码，注意修改package.json的配置)</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    &quot;name&quot;: &quot;fankoui3&quot;,
    &quot;version&quot;: &quot;0.1.0&quot;,
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在vue文件中使用Card组件，如可显示正常，则组件库创建成功。</p><h2 id="如何写一个属于自己的vue3组件库" tabindex="-1"><a class="header-anchor" href="#如何写一个属于自己的vue3组件库" aria-hidden="true">#</a> 如何写一个属于自己的Vue3组件库</h2>`,12),bn={href:"https://juejin.cn/post/7207094325897297957",target:"_blank",rel:"noopener noreferrer"},gn=n("p",null,"pnpm 修改默认安装包的仓库位置 pnpm config set store-dir E:/pnpmPackage",-1),hn=n("p",null,"使用pnpm的项目最好不要有中文路径，否则下载依赖可能有报错",-1),fn={href:"https://mp.weixin.qq.com/s/jvLAFzwJPlA5J-iNJSblag",target:"_blank",rel:"noopener noreferrer"},yn={href:"https://juejin.cn/post/7255514764754894907?searchId=20231030164149D848293E31B857FECA86#heading-6",target:"_blank",rel:"noopener noreferrer"},xn={href:"https://juejin.cn/post/7285373518836826167",target:"_blank",rel:"noopener noreferrer"},wn={href:"https://juejin.cn/post/7211521650252398649",target:"_blank",rel:"noopener noreferrer"},qn={href:"https://juejin.cn/user/78820567165575/posts",target:"_blank",rel:"noopener noreferrer"},_n={href:"https://github.com/yuanwen0327/learn-create-compoents-lib",target:"_blank",rel:"noopener noreferrer"},jn={href:"https://juejin.cn/post/6987735091925483551#heading-14",target:"_blank",rel:"noopener noreferrer"},Sn={href:"https://juejin.cn/post/7241514309717639228",target:"_blank",rel:"noopener noreferrer"},Cn={href:"https://juejin.cn/post/7117897323014783013",target:"_blank",rel:"noopener noreferrer"},Vn=n("h2",{id:"vue3基本使用-用setup-语法糖",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue3基本使用-用setup-语法糖","aria-hidden":"true"},"#"),s(" vue3基本使用（用setup 语法糖）")],-1),En={href:"https://cn.vuejs.org/guide/introduction.html",target:"_blank",rel:"noopener noreferrer"},Rn={href:"https://juejin.cn/post/6897030228867022856",target:"_blank",rel:"noopener noreferrer"},zn=e(`<h3 id="计算属性" tabindex="-1"><a class="header-anchor" href="#计算属性" aria-hidden="true">#</a> 计算属性</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> ref<span class="token punctuation">,</span>reactive<span class="token punctuation">,</span> computed <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;vue&#39;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>特别是注意侦听器是如何两次使用 <code>todoId</code> 的，一次是作为源，另一次是在回调中。</p>`,8),Nn={href:"https://cn.vuejs.org/api/reactivity-core.html#watcheffect",target:"_blank",rel:"noopener noreferrer"},Pn=n("code",null,"watchEffect",-1),Dn=n("code",null,"watchEffect()",-1),Mn=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>watchEffect(async () =&gt; {
  const response = await fetch(
    \`https://jsonplaceholder.typicode.com/todos/\${todoId.value}\`
  )
  data.value = await response.json()
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="异步状态示例" tabindex="-1"><a class="header-anchor" href="#异步状态示例" aria-hidden="true">#</a> 异步状态示例</h4><p>在做异步数据请求时，我们常常需要处理不同的状态：加载中、加载成功和加载失败。</p><p><strong>接收响应式状态</strong></p><p><code>useFetch()</code> 接收一个静态 URL 字符串作为输入——因此它只会执行一次 fetch 并且就此结束。如果我们想要在 URL 改变时重新 fetch 呢？为了实现这一点，我们需要将响应式状态传入组合式函数，并让它基于传入的状态来创建执行操作的侦听器。</p><p>举例来说，<code>useFetch()</code> 应该能够接收一个 ref：或者接收一个 getter 函数：</p>`,33),Ln={href:"https://cn.vuejs.org/api/reactivity-core.html#watcheffect",target:"_blank",rel:"noopener noreferrer"},Tn=n("code",null,"watchEffect()",-1),Hn={href:"https://cn.vuejs.org/api/reactivity-utilities.html#tovalue",target:"_blank",rel:"noopener noreferrer"},An=n("code",null,"toValue()",-1),Fn=n("code",null,"toValue()",-1),Bn={href:"https://cn.vuejs.org/api/reactivity-utilities.html#unref",target:"_blank",rel:"noopener noreferrer"},On=n("code",null,"unref()",-1),Jn=e("<p>注意 <code>toValue(url)</code> 是在 <code>watchEffect</code> 回调函数的<strong>内部</strong>调用的。这确保了在 <code>toValue()</code> 规范化期间访问的任何响应式依赖项都会被侦听器跟踪。</p><p>这个版本的 <code>useFetch()</code> 现在能接收静态 URL 字符串、ref 和 getter，使其更加灵活。watch effect 会立即运行，并且会跟踪 <code>toValue(url)</code> 期间访问的任何依赖项。如果没有跟踪到依赖项（例如 url 已经是字符串），则 effect 只会运行一次；否则，它将在跟踪到的任何依赖项更改时重新运行。</p><p><strong>输入参数</strong></p>",3),In={href:"https://cn.vuejs.org/api/reactivity-utilities.html#tovalue",target:"_blank",rel:"noopener noreferrer"},Un=n("code",null,"toValue()",-1),Xn=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>import { toValue } from &#39;vue&#39;
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="getcurrentinstance" tabindex="-1"><a class="header-anchor" href="#getcurrentinstance" aria-hidden="true">#</a> getCurrentInstance</h3><p>在Vue3中，getCurrentInstance() 可以用来获取<strong>当前组件实例</strong></p>`,5),$n={href:"https://blog.csdn.net/Zaralike/article/details/125870367",target:"_blank",rel:"noopener noreferrer"},Yn=n("h2",{id:"vite-vue-配置",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vite-vue-配置","aria-hidden":"true"},"#"),s(" Vite vue 配置")],-1),Kn=n("h3",{id:"vite打包视图分析-rollup-plugin-visualizer",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vite打包视图分析-rollup-plugin-visualizer","aria-hidden":"true"},"#"),s(" vite打包视图分析(rollup-plugin-visualizer)")],-1),Qn={href:"https://juejin.cn/post/7159410085460983839",target:"_blank",rel:"noopener noreferrer"},Zn=e(`<p>分析项目中的js文件大小和引用情况，基于展示的依赖项 js 大小对前端项目做优化处理</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install --save-dev rollup-plugin-visualizer
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vite-项目优化-配置-cdn-服务" tabindex="-1"><a class="header-anchor" href="#vite-项目优化-配置-cdn-服务" aria-hidden="true">#</a> vite 项目优化 配置 CDN 服务</h3><p>配置cdn加速，减小打包体积</p>`,6),ns={href:"https://juejin.cn/post/7248118049584332856",target:"_blank",rel:"noopener noreferrer"},ss=n("h2",{id:"vue和react对比学习之路由角色权限",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue和react对比学习之路由角色权限","aria-hidden":"true"},"#"),s(" Vue和React对比学习之路由角色权限")],-1),as={href:"https://juejin.cn/post/7250386282400596029#heading-23",target:"_blank",rel:"noopener noreferrer"},ts=n("h2",{id:"如何在vue-js中创建模态框-弹出框",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#如何在vue-js中创建模态框-弹出框","aria-hidden":"true"},"#"),s(" 如何在Vue.js中创建模态框(弹出框)")],-1),es={href:"https://mp.weixin.qq.com/s/MddofJ10zYXtWAeGa5Z_Cw",target:"_blank",rel:"noopener noreferrer"},ps=e(`<h2 id="点击侧边展示导航的组件" tabindex="-1"><a class="header-anchor" href="#点击侧边展示导航的组件" aria-hidden="true">#</a> 点击侧边展示导航的组件</h2><p>用的ant-design-vue的 a-drawer</p><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue3使用jsx" tabindex="-1"><a class="header-anchor" href="#vue3使用jsx" aria-hidden="true">#</a> vue3使用jsx</h2>`,4),os={href:"https://juejin.cn/post/7213356423810924581",target:"_blank",rel:"noopener noreferrer"},cs={href:"https://juejin.cn/post/7151950058501373989?from=search-suggest",target:"_blank",rel:"noopener noreferrer"},is={href:"https://juejin.cn/post/7261604498924961829",target:"_blank",rel:"noopener noreferrer"},ls={href:"https://zhuanlan.zhihu.com/p/375527289",target:"_blank",rel:"noopener noreferrer"},us={href:"https://juejin.cn/post/7272308621710213161",target:"_blank",rel:"noopener noreferrer"},rs={href:"https://mp.weixin.qq.com/s/DOBgFqHoupBcoRLngHFNUw",target:"_blank",rel:"noopener noreferrer"},ds=e(`<p>想在项目中使用 JSX,我们需要安装一个插件<code>@vitejs/plugin-vue-jsx</code>,这个插件可以让我们在项目中使用 JSX/TSX</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i @vitejs/plugin-vue-jsx -D
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue使用tailwindcss" tabindex="-1"><a class="header-anchor" href="#vue使用tailwindcss" aria-hidden="true">#</a> vue使用Tailwindcss</h2>`,12),ks={href:"https://www.tailwindcss.cn/docs/width",target:"_blank",rel:"noopener noreferrer"},vs=n("p",null,"当有不知道的类可以直接到官网文档查看",-1),ms={href:"https://juejin.cn/post/7228488937505030199",target:"_blank",rel:"noopener noreferrer"},bs={href:"https://juejin.cn/post/7216990794942201913#heading-5",target:"_blank",rel:"noopener noreferrer"},gs=e(`<p>安装依赖</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i -D tailwindcss postcss autoprefixer
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>vue3 同时使用 element plus 和 Tailwindcss 可能会出现样式冲突（例如el-button显示异常），此时一种解决方法是先引入 Tailwindcss ，然后再引入 element plus 的样式文件</strong></p><p>vscode 安装 Tailwind CSS IntelliSense 插件 ,没有提示功能，通过如下解决：</p><p>1 vscode点击设置</p><p>2 搜索 <code>editor.quickSuggestions</code></p><p>3 strings 改为 on</p><h2 id="vueuse" tabindex="-1"><a class="header-anchor" href="#vueuse" aria-hidden="true">#</a> vueUse</h2>`,21),hs={href:"https://www.vueusejs.com/guide/",target:"_blank",rel:"noopener noreferrer"},fs=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i @vueuse/core
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4);function ys(xs,ws){const a=i("ExternalLinkIcon");return o(),c("div",null,[u,n("p",null,[s("安装："),n("a",r,[s("Download | Node.js (nodejs.org)"),t(a)])]),d,n("p",null,[n("a",k,[s("前端开发技术栈（工具篇）：详细介绍npm、pnpm和cnpm分别是什么，使用方法以及之间有哪些关系-CSDN博客"),t(a)])]),v,m,b,n("p",null,[s("具体原因可查看： "),n("a",g,[s("终极解决：Error: error:0308010C:digital envelope routines::unsupported_CSDN博客"),t(a)])]),n("p",null,[s("为了解决node版本冲突等问题，选择安装 nvm-windows 包管理工具："),n("a",h,[s("Releases · coreybutler/nvm-windows (github.com)"),t(a)])]),n("p",null,[s("node版本管理："),n("a",f,[s("nvm-下载、安装、使用（2023/07/12更新）_nvm 下载-CSDN博客"),t(a)])]),y,n("ul",null,[n("li",null,[n("a",x,[s("Vue CLI官方文档 - Babel配置"),t(a)])]),n("li",null,[n("a",w,[s("babel-plugin-transform-remove-console"),t(a)])])]),q,n("p",null,[n("a",_,[s("vue中修改props传进来的值_使用计算属性更新prop的值-CSDN博客"),t(a)])]),j,n("p",null,[n("a",S,[s("Vue内置组件的component标签-CSDN博客"),t(a)])]),C,n("p",null,[n("a",V,[s("(202条消息) vue实现登录后跳转到之前的页面_longzhoufeng的博客-CSDN博客"),t(a)])]),E,n("p",null,[s("官网： "),n("a",R,[s("安装 | Pinia 中文文档 (web3doc.top)"),t(a)])]),z,n("p",null,[n("a",N,[s("https://juejin.cn/post/6928468842377117709"),t(a)])]),n("p",null,[n("a",P,[s("https://juejin.cn/post/6994337441314242590#heading-15"),t(a)])]),n("p",null,[n("a",D,[s("https://juejin.cn/post/7087100496762109983#heading-16"),t(a)])]),M,n("p",null,[n("a",L,[s("https://juejin.cn/post/7078281612013764616#heading-0"),t(a)])]),T,n("p",null,[s("页面全屏滚动很多用于官网首页，使用的频率还挺高的，此处的代码实现的功能是 鼠标滚动，页面切换，点击键盘的上下键，页面切换。类似效果看 "),n("a",H,[s(" 全屏滚动_jQuery之家-自由分享jQuery、html5、css3的插件库 (htmleaf.com)"),t(a)]),s(" ，以下内容改自 "),n("a",A,[s("vue实现全屏滚动，非fullpage.js-阿里云开发者社区 (aliyun.com)"),t(a)]),s(" 。")]),F,n("p",null,[n("a",B,[s("vue-router路由中对query中的参数进行加密_router 参数加密_前端_小学生的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",O,[s("vue-router中传递的参数进行自动加密显示，组件中获取自动解密 (github.com)"),t(a)])]),J,I,n("p",null,[n("a",U,[s("https://mp.weixin.qq.com/s/pWsntJbJnBip5CbP7HkvFg"),t(a)])]),X,n("p",null,[n("a",W,[s("十分钟搭建 Vite+Vue3 项目模板 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",G,[s("从 0 搭建 Vite 3 + Vue 3 前端工程化项目 - 掘金 (juejin.cn)"),t(a)])]),$,n("p",null,[n("a",Y,[s("SpringBoot 项目解决跨域的几种方案 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[s("（vue3中使用消息提示 "),n("a",K,[s("vue3中使用element-plus调用message_element-plus message_"),t(a)]),s(" ）")]),Q,n("p",null,[n("a",Z,[s("Vuex 更好的替代品 Pinia，真香 (qq.com)"),t(a)])]),nn,n("p",null,[n("a",sn,[s("Vue 树形结构插件 vue2-org-tree - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",an,[s("详解树状结构图 vue-org-tree - 知乎 (zhihu.com)"),t(a)])]),tn,n("p",null,[n("a",en,[s("unplugin-vue-macros(github.com) "),t(a)])]),pn,n("p",null,[n("a",on,[s("b站参考学习视频地址"),t(a)]),s(),n("a",cn,[s("参考文章 vue组件库的基本开发步骤 "),t(a)])]),ln,un,rn,n("p",null,[n("a",dn,[s("基于element-ui构建自定义组件库，发布到npm及安装使用，以及生成组件库说明文档 - 知乎 (zhihu.com)"),t(a)])]),kn,n("p",null,[n("a",vn,[s("图文结合简单易学的 npm 包的发布流程 (qq.com)"),t(a)])]),mn,n("p",null,[n("a",bn,[s("pnpm 基本详细使用（安装、卸载、使用） - 掘金 (juejin.cn)"),t(a)])]),gn,hn,n("p",null,[n("a",fn,[s("如何写一个属于自己的Vue3组件库 (qq.com)"),t(a)])]),n("p",null,[n("a",yn,[s("【前端工程化-组件库】从0-1构建Vue3组件库（打包发布） - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",xn,[s("前端工程化😼开源项目都在用的【Monorepo】🏋🏿 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",wn,[s("如何写一个属于自己的vue3组件库 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[s("参考,可用："),n("a",qn,[s("全肝鸽鸽 的个人主页 - 文章 - 掘金 (juejin.cn)"),t(a)]),s(),n("a",_n,[s("GitHub - yuanwen0327/learn-create-compoents-lib"),t(a)])]),n("p",null,[n("a",jn,[s("一文读懂TS的(.d.ts)文件 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",Sn,[s("从0到1搭建自己的组件库，详解附源码 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",Cn,[s("Monorepo pnpm模式管理多个web项目（Vue3） - 掘金 (juejin.cn)"),t(a)])]),Vn,n("p",null,[n("a",En,[s("https://cn.vuejs.org/guide/introduction.html"),t(a)])]),n("p",null,[n("a",Rn,[s("快速使用Vue3最新的15个常用API - 掘金 (juejin.cn)"),t(a)])]),zn,n("p",null,[s("用 "),n("a",Nn,[Pn,s(" 函数"),t(a)]),s(" 来简化上面的代码。"),Dn,s(" 允许我们自动跟踪回调的响应式依赖")]),Mn,n("p",null,[s("我们可以用 "),n("a",Ln,[Tn,t(a)]),s(" 和 "),n("a",Hn,[An,t(a)]),s(" API 来重构我们现有的实现：")]),n("p",null,[Fn,s(" 是一个在 3.3 版本中新增的 API。它的设计目的是将 ref 或 getter 规范化为值。如果参数是 ref，它会返回 ref 的值；如果参数是函数，它会调用函数并返回其返回值。否则，它会原样返回参数。它的工作方式类似于 "),n("a",Bn,[On,t(a)]),s("，但对函数有特殊处理。")]),Jn,n("p",null,[s("即便不依赖于 ref 或 getter 的响应性，组合式函数也可以接收它们作为参数。如果你正在编写一个可能被其他开发者使用的组合式函数，最好处理一下输入参数是 ref 或 getter 而非原始值的情况。可以利用 "),n("a",In,[Un,t(a)]),s(" 工具函数来实现：")]),Xn,n("p",null,[n("a",Wn,[s("示例地址"),t(a)])]),Gn,n("p",null,[n("a",$n,[s("Vue3组合式API：getCurrentInstance_vue3 getcurrentinstance-CSDN博客"),t(a)])]),Yn,Kn,n("p",null,[n("a",Qn,[s("vue3+vite打包视图分析(rollup-plugin-visualizer)+gzip - 掘金 (juejin.cn)"),t(a)])]),Zn,n("p",null,[n("a",ns,[s("【vite 4.3 + vue 3.2 项目优化实战】配置 CDN 服务 - 掘金 (juejin.cn)"),t(a)])]),ss,n("p",null,[n("a",as,[s("Vue和React对比学习之路由角色权限(页面、按钮权限控制) - 掘金 (juejin.cn)"),t(a)])]),ts,n("p",null,[n("a",es,[s("如何在Vue.js中创建模态框(弹出框) (qq.com)"),t(a)])]),ps,n("p",null,[n("a",os,[s("如何在 vue3 中使用 jsx/tsx? - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",cs,[s("在 vue3 中优雅的使用 jsx/tsx - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",is,[s("在Vue3中利用JSX+函数式组件做到更好的代码复用 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",ls,[s("JSX 设置样式 - 知乎 (zhihu.com)"),t(a)])]),n("p",null,[n("a",us,[s("万字长文详解 Vue JSX，带你全面拥抱 JSX 特性！-讲述了jsx的优点 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",rs,[s("一起玩转Vue中的JSX：让你一次性掌握它的特性! 微信公众平台 (qq.com)"),t(a)])]),ds,n("p",null,[s("官方文档： "),n("a",ks,[s("Width - TailwindCSS中文文档 | TailwindCSS中文网"),t(a)])]),vs,n("p",null,[n("a",ms,[s("在vite-vue3中快速使用Tailwindcss - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",bs,[s("Vue中使用 Tailwind CSS - 掘金 (juejin.cn)"),t(a)])]),gs,n("p",null,[n("a",hs,[s("起步 | VueUse中文文档 (vueusejs.com)"),t(a)])]),fs])}const js=p(l,[["render",ys],["__file","4.html.vue"]]);export{js as default};
