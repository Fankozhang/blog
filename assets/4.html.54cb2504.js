import{_ as p}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as i,c as l,a as n,b as s,e,f as t,r as o}from"./app.fd001e99.js";const c={},u=t(`<h1 id="vue" tabindex="-1"><a class="header-anchor" href="#vue" aria-hidden="true">#</a> vue</h1><h2 id="vue2和vue3响应式-简易版" tabindex="-1"><a class="header-anchor" href="#vue2和vue3响应式-简易版" aria-hidden="true">#</a> vue2和vue3响应式（简易版）</h2><p>vue2通过遍历循环对象属性（for key in obj），在对每一个属性的值用 Object.defineProperty 进行getter和setter的改造</p><p>vue3通过Proxy（代理）和Reflect（反射）的使用完成 响应式。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">observe</span><span class="token punctuation">(</span><span class="token parameter">data</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
