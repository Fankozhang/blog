...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在不影响方法执行的情况下更新缓存时用CachePut</p><p>@CachePut(value=&quot;cacheSpace&quot;,key=&quot;#id&quot;)</p><p>不推荐将 @Cacheable 和 @CachePut 注解到同一个方法。</p><p>整合其他的缓存技术</p>`,23),fs={href:"https://blog.csdn.net/Learning_xzj/article/details/125510872",target:"_blank",rel:"noopener noreferrer"},ws={href:"https://blog.csdn.net/weixin_44299027/article/details/125559446",target:"_blank",rel:"noopener noreferrer"},qs={href:"https://gitee.com/ld/J2Cache",target:"_blank",rel:"noopener noreferrer"},_s=e(`<h2 id="任务" tabindex="-1"><a class="header-anchor" href="#任务" aria-hidden="true">#</a> 任务</h2><h3 id="定时任务" tabindex="-1"><a class="header-anchor" href="#定时任务" aria-hidden="true">#</a> 定时任务</h3><p>市面上流行的定时任务技术：Quartz ，Spring Task</p><p>springboot整合Quartz</p><p>相关概念： 工作（job):用于定义具体执行的工作 工作明细（JobDetail):用于描述定时工作相关的信息 触发器(Trigger):用于描述触发工作的规则，通常使用cron表达式定义调度规则 调度器(Scheduler):描述了工作明细与触发器的对应关系</p><h2 id="springboot-项目常用maven配置" tabindex="-1"><a class="header-anchor" href="#springboot-项目常用maven配置" aria-hidden="true">#</a> springBoot 项目常用maven配置</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;
