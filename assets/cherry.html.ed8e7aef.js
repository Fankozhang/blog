...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="nginx跨域配置" tabindex="-1"><a class="header-anchor" href="#nginx跨域配置" aria-hidden="true">#</a> nginx跨域配置</h3>`,24),$={href:"https://blog.csdn.net/qq_38011415/article/details/107095403",target:"_blank",rel:"noopener noreferrer"},H=a(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>server <span class="token punctuation">{</span>
        listen       <span class="token number">90</span><span class="token punctuation">;</span>
        server_name  localhost<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="nginx中的upstream指令参数" tabindex="-1"><a class="header-anchor" href="#nginx中的upstream指令参数" aria-hidden="true">#</a> nginx中的upstream指令参数</h3>`,6),Z={href:"https://blog.csdn.net/qq_44299529/article/details/122946397",target:"_blank",rel:"noopener noreferrer"},W=n("h3",{id:"nginx控制浏览器缓存",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#nginx控制浏览器缓存","aria-hidden":"true"},"#"),e(" nginx控制浏览器缓存")],-1),X=n("p",null,"expires用于对缓存的设置（可以在server里面配置，也可以在location里面配置）",-1),F={href:"https://cloud.tencent.com/developer/article/1918457",target:"_blank",rel:"noopener noreferrer"},J=a(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>server {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="nginx搭建高可用集群" tabindex="-1"><a class="header-anchor" href="#nginx搭建高可用集群" aria-hidden="true">#</a> nginx搭建高可用集群</h3><p>高可用：一般指2台机器启动着相同的业务系统，当有一台机器down机了，另外一台服务器能快速的接管，对于访问当用户是无感知的</p><p>nginx+keepalived</p>`,6),R={href:"https://juejin.cn/post/7025845075217219614",target:"_blank",rel:"noopener noreferrer"},Y={href:"https://developer.aliyun.com/article/885619",target:"_blank",rel:"noopener noreferrer"},Q=n("h3",{id:"使用nginx出现的问题",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#使用nginx出现的问题","aria-hidden":"true"},"#"),e(" 使用nginx出现的问题：")],-1),nn=n("h4",{id:"耗时长的数据请求-返回404",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#耗时长的数据请求-返回404","aria-hidden":"true"},"#"),e(" 耗时长的数据请求，返回404")],-1),en={href:"https://blog.csdn.net/weixin_43568226/article/details/122390109",target:"_blank",rel:"noopener noreferrer"},sn={href:"https://blog.csdn.net/HD243608836/article/details/111564684",target:"_blank",rel:"noopener noreferrer"},an=n("h2",{id:"docker",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#docker","aria-hidden":"true"},"#"),e(" docker")],-1),ln={href:"https://www.bilibili.com/video/BV1gr4y1U7CY/?spm_id_from=333.337.search-card.all.click&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},rn={href:"https://www.aliyundrive.com/s/nh9WKM1ZG6A",target:"_blank",rel:"noopener noreferrer"},tn={href:"https://www.docker.com/",target:"_blank",rel:"noopener noreferrer"},dn={href:"https://github.com/docker/docker-ce",target:"_blank",rel:"noopener noreferrer"},on={href:"https://hub.docker.com/",target:"_blank",rel:"noopener noreferrer"},cn=a('<p>docker commit 提交容器副本使之成为一个新的镜像</p><p>·docker commit -m=&quot;提交的描述信息&quot; -a=&quot;作者&quot; 容器ID 要创建的目标镜像名:[标签名]</p><p>docker commit -m=&quot;ubuntu add vim ok&quot; -a=&quot;fankozhang&quot; 50d70d915a7e fankozhang/myubuntu:1.1</p><h3 id="操作过程中遇到问题" tabindex="-1"><a class="header-anchor" href="#操作过程中遇到问题" aria-hidden="true">#</a> 操作过程中遇到问题 ：</h3><h4 id="docker下删除自己创建的镜像报错-cannot-be-forced-image-has-dependent-child-images" tabindex="-1"><a class="header-anchor" href="#docker下删除自己创建的镜像报错-cannot-be-forced-image-has-dependent-child-images" aria-hidden="true">#</a> Docker下删除自己创建的镜像报错 (cannot be forced) - image has dependent child images</h4><p>删除镜像命令 ： docker rmi 镜像Id</p><p>大概意思就是这个镜像被别的镜像所依赖，不能强制删除，需要查找child images，再逐个删除。查找被这个镜像所依赖的镜像命令如下：</p><p><code>docker image inspect --format=&#39;{{.RepoTags}} {{.Id}} {{.Parent}}&#39; $(docker image ls -q --filter since=镜像Id)</code></p><p>将所有需要依赖这个镜像的镜像都删除掉，才能删除这个镜像。</p>',9);function pn(un,vn){const s=d("ExternalLinkIcon");return r(),t("div",null,[m,n("p",null,[e("在访问github pages显示的地址就可以了，我的地址是 "),n("a",h,[e("https://fankozhang.github.io/blog/"),i(s)])]),b,n("p",null,[e("当真正想搞一个vuepree文档网站的时候，不一定从头搭建，可以使用适应的主题，使用主题可以实现快速搭建项目，主题可以自己搜索，我使用的主题是 "),n("a",g,[e("vuepress-theme-hope "),i(s)])]),_,n("p",null,[n("a",x,[e("参考视频 nginx_哔哩哔哩_bilibili"),i(s)])]),n("p",null,[n("a",k,[e("参考博客专栏"),i(s)])]),n("p",null,[n("a",f,[e("Nginx expires 页面缓存时间配置 (w3schools.cn)"),i(s)])]),w,z,n("p",null,[n("a",y,[e("Linux Nginx安装及使用 - 掘金 (juejin.cn)"),i(s)])]),n("p",null,[n("a",q,[e("Linux安装Nginx - 掘金 (juejin.cn)"),i(s)])]),C,n("p",null,[n("a",j,[e("(141条消息) 故障排查（Nginx服务启动失败）报错：still could not bind()_吃不吃西红柿的博客-CSDN博客"),i(s)])]),n("p",null,[n("a",A,[e("emerg] still could not bind()怎么解决_一枝风的博客-CSDN博客"),i(s)])]),N,n("p",null,[n("a",E,[e("(关于nginx新增对外开放端口的问题_nginx开放端口"),i(s)])]),D,I,P,T,n("p",null,[n("a",L,[e("Nginx 生产推荐配置以及日志切割清理 )"),i(s)])]),n("p",null,[e("创建定时任务 "),n("a",S,[e("(141条消息) Linux 定时执行shell 脚本_spearhead_cai的博客-CSDN博客"),i(s)])]),G,n("p",null,[n("a",U,[e("http://192.168.64.128:90/"),i(s)]),e(" 这个会访问到第一个的location的文件")]),n("p",null,[n("a",O,[e("http://192.168.64.128:90/assets/12345678.png"),i(s)]),e(" 这个会访问到第二个的location的文件（静态资源）")]),n("p",null,[n("a",B,[e("http://192.168.64.128:90/static/12345678.png)"),i(s)]),e(" 这个会访问到第三个的location的文件，路径设置别名，访问到的内容一样（静态资源）")]),V,n("p",null,[n("a",K,[e("参考文章 Nginx优化之gzip压缩提升网站速度_苦艾酒丶的博客-CSDN博客"),i(s)])]),M,n("p",null,[e("参考文章 "),n("a",$,[e("(141条消息) Nginx跨域配置_程序员小强的博客-CSDN博客_nginx 跨域"),i(s)])]),H,n("p",null,[n("a",Z,[e("nginx中的upstream指令参数__nginx upstream参数"),i(s)])]),W,X,n("p",null,[n("a",F,[e("nginx expires配置详解 - 腾讯云开发者社区-腾讯云 (tencent.com)"),i(s)])]),J,n("p",null,[n("a",R,[e("手把手教你nginx生产环境下高可用环境搭建 - 掘金 (juejin.cn)"),i(s)])]),n("p",null,[n("a",Y,[e("Nginx+keepalived实现高可用集群-阿里云开发者社区 (aliyun.com)"),i(s)])]),Q,nn,n("p",null,[e("在前台往后台发送了一个请求，实现选取字段导出的功能，返回的一个文档流，由于数据量大，耗时长，选取某些字段时能返回正常的文档流，但选取某些字段时又返回404错误，于是我测试了很多的字段，发现并不是传值字段的问题。而后发现那些返回 404 的请求的,等待服务器响应的时间都是 1min,由此判断，可能是请求响应时长方面的问题，但我查看了前端代码,没找到设置1min时长过期的代码，在1min的基础上，我搜索了网页请求1min返回404是什么问题，最终确认是nginx的配置有问题，参考如下文章 "),n("a",en,[e("Nginx报错404，由于请求处理时间过长_"),i(s)]),e(),n("a",sn,[e("nginx中的timeout超时设置，请求超时、响应等待超时等_"),i(s)]),e(" 最终解决了问题。（nginx默认的超时时长为60s,而我的请求耗时1.4min，没有对超时时长做配置，所以返回了404，增加超时时长后，请求正常返回。）")]),an,n("p",null,[n("a",ln,[e("视频地址 2022版 尚硅谷Docker实战教程_哔哩哔哩_bilibili"),i(s)])]),n("p",null,[e("资料 ："),n("a",rn,[e("https://www.aliyundrive.com/s/nh9WKM1ZG6A"),i(s)])]),n("p",null,[e("Docker 官网："),n("a",tn,[e("https://www.docker.com"),i(s)])]),n("p",null,[e("Github Docker 源码："),n("a",dn,[e("https://github.com/docker/docker-ce"),i(s)])]),n("p",null,[e("安装docker镜像的仓库： "),n("a",on,[e("Docker Hub Container Image Library | App Containerization"),i(s)])]),cn])}const bn=l(v,[["render",pn],["__file","cherry.html.vue"]]);export{bn as default};
