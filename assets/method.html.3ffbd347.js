...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="利用gitee搭建免费图床" tabindex="-1"><a class="header-anchor" href="#利用gitee搭建免费图床" aria-hidden="true">#</a> 利用Gitee搭建免费图床</h2>`,8),y={href:"https://blog.csdn.net/hannah2233/article/details/117025387",target:"_blank",rel:"noopener noreferrer"},x={href:"https://molunerfinn.com/PicGo/",target:"_blank",rel:"noopener noreferrer"},w=e('<p><img src="'+u+'" alt="vscodeTwoSearch" loading="lazy"></p><p>gitee创建仓库，生成个人 token,在picGo上配置好 gitee 仓库信息和 个人 token, typora上配置图像上传的 PicGo 安装位置</p><p><img src="'+r+`" alt="vscodeTwoSearch" loading="lazy"></p><h2 id="下载-url" tabindex="-1"><a class="header-anchor" href="#下载-url" aria-hidden="true">#</a> 下载（url）</h2><h3 id="后端返回文件流-文档流-如何下载" tabindex="-1"><a class="header-anchor" href="#后端返回文件流-文档流-如何下载" aria-hidden="true">#</a> 后端返回文件流(文档流)如何下载</h3><p>例子：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 导出指定字段Excel列表</span>
...
<span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token string">&#39;download&#39;</span> <span class="token keyword">in</span> document<span class="token punctuation">.</span><span class="token function">createElement</span><span class="token punctuation">(</span><span class="token string">&#39;a&#39;</span><span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token punctuation">{</span> <span class="token comment">// 非IE下载</span>
  ...
  <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10),_={href:"https://www.jianshu.com/p/b322c2d5d778",target:"_blank",rel:"noopener noreferrer"},j={href:"https://juejin.cn/post/6844903480704892942",target:"_blank",rel:"noopener noreferrer"},C=n("p",null,"对于其他的文件下载的内容可参考如下文章：",-1),D={href:"https://mp.weixin.qq.com/s/vZiP2ULrLRtqShDJ9u1n2A",target:"_blank",rel:"noopener noreferrer"},S=e(`<h3 id="根据url下载文件-并设置文件名" tabindex="-1"><a class="header-anchor" href="#根据url下载文件-并设置文件名" aria-hidden="true">#</a> 根据url下载文件，并设置文件名</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>            <span class="token function">downLoad</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
           ...
           <span class="token function">downloadBlob</span> <span class="token punctuation">(</span><span class="token parameter">blob<span class="token punctuation">,</span> fileName</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
            ...
            <span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>第二种</p>`,3),E={href:"https://mp.weixin.qq.com/s/W_udbGlYEhdyH1mtdtbrsQ",target:"_blank",rel:"noopener noreferrer"},L=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>ts
复制代码
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a></h2><h3 id="自定义表单-表单生成器" tabindex="-1"><a class="header-anchor" href="#自定义表单-表单生成器" aria-hidden="true">#</a> 自定义表单（表单生成器）</h3>`,6),N={href:"https://juejin.cn/post/7065863860669906952",target:"_blank",rel:"noopener noreferrer"},P={href:"http://kcz66.gitee.io/k-form-design/#/README",target:"_blank",rel:"noopener noreferrer"},I=e(`<p>k-form-create使用</p><p>main.js</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>import { useAntd } from &#39;k-form-design/packages/core/useComponents&#39;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="postcss" tabindex="-1"><a class="header-anchor" href="#postcss" aria-hidden="true">#</a> postcss</h3><p><strong>使用postcss和相关插件时一定要注意包的版本的冲突</strong></p><p>npm install postcss postcss-loader -D</p>`,8),M={href:"https://juejin.cn/post/7062717813764390948",target:"_blank",rel:"noopener noreferrer"},Y={href:"https://github.com/sexyHuang/postcss-px2vp",target:"_blank",rel:"noopener noreferrer"},G=n("h3",{id:"vue-使用postcss-pxtorem-实现自适应",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue-使用postcss-pxtorem-实现自适应","aria-hidden":"true"},"#"),s(" vue 使用postcss-pxtorem 实现自适应")],-1),H={href:"https://blog.csdn.net/Charissa2017/article/details/105420971",target:"_blank",rel:"noopener noreferrer"},K=n("h3",{id:"vue-使用postcss-pxtorem-实现自适应-1",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue-使用postcss-pxtorem-实现自适应-1","aria-hidden":"true"},"#"),s(" vue 使用postcss-pxtorem 实现自适应")],-1),J={href:"https://juejin.cn/post/7052955004683943950",target:"_blank",rel:"noopener noreferrer"},W={href:"https://juejin.cn/post/7041826704574119966",target:"_blank",rel:"noopener noreferrer"},Q=e(`<ul><li>postcss-pxtorem：将px转换为px</li><li>amfe-flexible：为html、body添加font-size，窗口调整时候重新设置font-size</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install amfe-flexible --save
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="百度地图根据地址解析坐标系-根据地址展示地图位置" tabindex="-1"><a class="header-anchor" href="#百度地图根据地址解析坐标系-根据地址展示地图位置" aria-hidden="true">#</a> 百度地图根据地址解析坐标系（根据地址展示地图位置）</h2>`,11),un={href:"https://lbs.baidu.com/index.php?title=webapi/guide/webservice-geocoding",target:"_blank",rel:"noopener noreferrer"},rn={href:"https://dafrok.github.io/vue-baidu-map/#/zh/index",target:"_blank",rel:"noopener noreferrer"},dn={href:"https://www.cnblogs.com/spaortMan/p/13932126.html",target:"_blank",rel:"noopener noreferrer"},kn=e(`<p>VUE BAIDU MAP</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install vue-baidu-map --save
...
Vue.use(VueJsonp)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;baidu-map :scroll-wheel-zoom=&quot;true&quot; class=&quot;bm-view&quot; ref=&quot;map&quot; :center=&quot;mapCenter&quot; :zoom=&quot;17&quot;&gt;
   &lt;bm-marker
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue的v-html解析富文本传来的表格不显示边线" tabindex="-1"><a class="header-anchor" href="#vue的v-html解析富文本传来的表格不显示边线" aria-hidden="true">#</a> vue的v-html解析富文本传来的表格不显示边线</h2>`,8),vn={href:"https://blog.csdn.net/xh1506101064/article/details/106675796",target:"_blank",rel:"noopener noreferrer"},mn=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;div class=&quot;content-table&quot; v-html=&quot;abc&quot;&gt;&lt;/div&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="内网穿透" tabindex="-1"><a class="header-anchor" href="#内网穿透" aria-hidden="true">#</a> 内网穿透</h2>`,22),bn={href:"https://natapp.cn/",target:"_blank",rel:"noopener noreferrer"},gn=n("p",null,"下载软件，网站上配置隧道",-1),hn=n("p",null,"启动命令：natapp.exe -authtoken=你的authtoken",-1),fn=n("p",null,"这个authtoken是在natapp里面创建免费的隧道产生的。",-1),qn=n("p",null,"注意隧道的端口要配置成你的后台端口，例如9090",-1),yn=n("p",null,"直接在上面的命令后面加上就可以启动你的natapp，设置内网穿透了。",-1),xn=n("p",null,"内网穿透就是把本机的ip和端口暴露到外网，通过指定的url可以访问你本地的服务，当然，这存在一定的安全风险，请谨慎使用！",-1),wn={href:"http://nyqre4.natappfree.cc",target:"_blank",rel:"noopener noreferrer"},_n={href:"https://blog.csdn.net/u013154103/article/details/102481846",target:"_blank",rel:"noopener noreferrer"},jn=n("p",null,"vue项目使用内网穿透要加配置",-1),Cn=n("div",{class:"language-text line-numbers-mode","data-ext":"text"},[n("pre",{class:"language-text"},[n("code",null,`disableHostCheck:true
`)]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"})])],-1),Dn={href:"https://blog.csdn.net/dakache11/article/details/83989296",target:"_blank",rel:"noopener noreferrer"},Sn={href:"https://blog.csdn.net/GTbond/article/details/124375319",target:"_blank",rel:"noopener noreferrer"};function En(Ln,Tn){const a=i("ExternalLinkIcon");return o(),l("div",null,[k,n("p",null,[n("a",v,[s("vsCode 代码片段 自动生成格式 (99cc.vip)"),t(a)])]),n("p",null,[n("a",m,[s("snippet generator (snippet-generator.app)"),t(a)])]),b,n("p",null,[n("a",g,[s("(206条消息) Vscode如何配置属于自己的ESlint_vscode eslint配置_·甘之如饴·的博客-CSDN博客"),t(a)])]),h,n("p",null,[n("a",f,[s("https://blog.csdn.net/qq_39606853/article/details/122192555"),t(a)])]),q,n("p",null,[n("a",y,[s("利用Gitee搭建免费图床（详细教程）_gitee图床-CSDN博客"),t(a)])]),n("p",null,[s("下载 picGo "),n("a",x,[s("PicGo (molunerfinn.com)"),t(a)])]),w,n("p",null,[s("对于blob可点击 "),n("a",_,[s("JS中的Blob对象 - 简书 (jianshu.com)"),t(a)])]),n("p",null,[n("a",j,[s("JavaScript 中 Blob 对象 - 掘金 (juejin.cn)"),t(a)]),s(" 文章查看")]),C,n("p",null,[n("a",D,[s("前端文件下载的正确打开方式 (qq.com)"),t(a)])]),S,n("p",null,[n("a",E,[s("你真的会用标签下载文件吗? (qq.com)"),t(a)])]),L,n("p",null,[s("验证不生效可参考文章 "),n("a",T,[s("https://www.jianshu.com/p/5ebd1bd9ecaf"),t(a)])]),F,n("p",null,[n("a",N,[s("vue拖拽表单生成器 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[s("适用ant design vue ( "),n("a",P,[s("KFormDesign (gitee.io)"),t(a)]),s(" )")]),I,n("p",null,[n("a",U,[s("(115条消息) vue-判断设备是手机端还是pc端，进行两套页面样式的编写_hh3167253066的博客-CSDN博客_vue判断手机端还是pc端"),t(a)])]),A,n("p",null,[n("a",$,[s("(115条消息) vue项目PC端移动端适配方案_coderDragon的博客-CSDN博客_vue项目pc端和移动端适配"),t(a)])]),R,n("p",null,[n("a",V,[s("(198条消息) vue项目适配屏幕分辨率与屏幕的缩放适配详细教程_vue 分辨率适配_汪小敏同学的博客-CSDN博客"),t(a)])]),B,n("p",null,[n("a",O,[s("(227条消息) PC端网站在手机模式下打开显示不全的问题_手机pc端口 显示不全面_大大大颖er的博客-CSDN博客"),t(a)])]),z,n("p",null,[n("a",M,[s("https://juejin.cn/post/7062717813764390948"),t(a)])]),n("p",null,[n("strong",null,[n("a",Y,[s("postcss-px2vp"),t(a)])])]),G,n("p",null,[n("a",H,[s("(230条消息) vue-cli中使用postcss-px-to-viewport 将px转换成vw_px to vw_蒲公英芽的博客-CSDN博客"),t(a)])]),K,n("p",null,[n("a",J,[s("https://juejin.cn/post/7052955004683943950"),t(a)])]),n("p",null,[n("a",W,[s("https://juejin.cn/post/7041826704574119966"),t(a)])]),Q,n("p",null,[s("如果报错，则需要指定postcss-pxtorem版本，如： npm install "),n("a",Z,[s("postcss-pxtorem@5.1.1"),t(a)]),s(" --save-dev")]),X,n("p",null,[n("a",nn,[s("https://blog.csdn.net/coralime/article/details/122979010"),t(a)])]),sn,n("p",null,[n("a",an,[s("Vue开发中出现Loading Chunk Failed 踩坑纪实 - 掘金 (juejin.cn)"),t(a)])]),tn,n("p",null,[s("查看以下博客 "),n("a",en,[s("(130条消息) vue全屏滚动——vue-fullpage.js教程_朝阳39的博客-CSDN博客_vue-fullpage"),t(a)])]),pn,n("p",null,[n("a",on,[s("(132条消息) Git忽略文件.gitignore详解_ThinkWon的博客-CSDN博客_gitignore"),t(a)])]),n("p",null,[n("a",ln,[s("Git入门之.gitignore - 掘金 (juejin.cn)"),t(a)])]),cn,n("p",null,[n("a",un,[s("逆地理编码 gc | 百度地图API SDK (baidu.com)"),t(a)])]),n("p",null,[n("a",rn,[s("https://dafrok.github.io/vue-baidu-map/#/zh/index"),t(a)])]),n("p",null,[n("a",dn,[s("https://www.cnblogs.com/spaortMan/p/13932126.html"),t(a)])]),kn,n("p",null,[n("a",vn,[s("(210条消息) 更改v-html的样式_v-html 样式修改_oduoke~~的博客-CSDN博客"),t(a)])]),mn,n("p",null,[s("我用的是natapp，下载地址："),n("a",bn,[s("https://natapp.cn/"),t(a)])]),gn,hn,fn,qn,yn,xn,n("p",null,[s("使用命令开启natapp后，会生成一个外网的地址指向你本地的服务地址，当你访问 "),n("a",wn,[s("http://nyqre4.natappfree.cc"),t(a)]),s("，跟你访问 127.0.0.1:9090 效果是一样的，只不过一个是对外的，一个是只能本地访问。")]),n("p",null,[n("a",_n,[s("内网穿透 vue 返回 invalid host header（304 Not Modified）-----gxy_勤读意现的博客-CSDN博客"),t(a)])]),jn,Cn,n("p",null,[n("a",Dn,[s("vue项目中无法实现内网穿透，因为localhost的限制_dakache11的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",Sn,[s("vue内网穿透_vue项目内网穿透 转圈_GG·bond的博客-CSDN博客"),t(a)])])])}const Pn=p(d,[["render",En],["__file","method.html.vue"]]);export{Pn as default};
