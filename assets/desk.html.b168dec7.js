import{_ as p}from"./_plugin-vue_export-helper.cdc0426e.js";import{o,c as i,a as n,b as s,e,f as t,r as c}from"./app.9afcc5c9.js";const l={},u=n("h1",{id:"知识拓展",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#知识拓展","aria-hidden":"true"},"#"),s(" 知识拓展")],-1),r=n("h1",{id:"electron",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#electron","aria-hidden":"true"},"#"),s(" electron")],-1),d={href:"https://www.bilibili.com/video/BV1QB4y1F722?p=1&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},k=t(`<h2 id="创建electron项目" tabindex="-1"><a class="header-anchor" href="#创建electron项目" aria-hidden="true">#</a> 创建electron项目</h2><p>1 electron/electron-quick-start 官网示例</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># Clone this repository
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行yarn make 即可打包程序（很慢，在下载东西）</p>`,5),b={href:"https://blog.csdn.net/michaelxuzhi___/article/details/106568543",target:"_blank",rel:"noopener noreferrer"},g=t(`<p>最好有github加速服务，不然很容易打包失败。</p><p>生成out目录，里面有打包出的文件</p><p>2 （我使用的这种，上面的速度实在太慢）可以下载 electron-builder 依赖，注意 electron-builder 只能放置在 devDependencies 中</p><p>package.json中加入如下命令</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&quot;scripts&quot;: {
        &quot;app:dist&quot;: &quot;electron-builder&quot;
    },
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行 npm run app:dist 执行打包命令 （依然有打包下载文件的速度慢问题，加速才能下载下来）</p><p>生成dist目录，里面有打包好的文件</p><p>3 第一次打包时下载的文件存放在C:\\Users\\张帆\\AppData\\Local\\electron\\Cache目录下</p>`,8),h={href:"https://wwmj.lanzoue.com/b02ef6w8d",target:"_blank",rel:"noopener noreferrer"},y=t(`<h2 id="index-js" tabindex="-1"><a class="header-anchor" href="#index-js" aria-hidden="true">#</a> index.js</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token punctuation">{</span> app<span class="token punctuation">,</span> BrowserWindow <span class="token punctuation">}</span> <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;electron&#39;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
一定要在ready之后执行
 let request = net.request(&#39;https://taobao.com&#39;)
    ...
    request.end()
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="electron-vue-打包报错-不推荐使用" tabindex="-1"><a class="header-anchor" href="#electron-vue-打包报错-不推荐使用" aria-hidden="true">#</a> electron-vue（打包报错，不推荐使用）</h2>`,27),w={href:"https://simulatedgreg.gitbooks.io/electron-vue/content/cn/",target:"_blank",rel:"noopener noreferrer"},f=t(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># 安装 vue-cli 和 脚手架样板代码
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="electron自定义菜单" tabindex="-1"><a class="header-anchor" href="#electron自定义菜单" aria-hidden="true">#</a> electron自定义菜单</h2>`,18),B={href:"https://juejin.cn/post/7209826725365645369#heading-1",target:"_blank",rel:"noopener noreferrer"},D=n("h3",{id:"顶部菜单栏",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#顶部菜单栏","aria-hidden":"true"},"#"),s(" 顶部菜单栏")],-1),T={href:"https://www.misterma.com/archives/896/",target:"_blank",rel:"noopener noreferrer"},R=t(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>const win = new BrowserWindow({
        width: 800,
        height: 600,
        frame: true
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>重启electron项目，可以看到菜单栏已变成自定义的了。</p><h3 id="侧边菜单栏" tabindex="-1"><a class="header-anchor" href="#侧边菜单栏" aria-hidden="true">#</a> 侧边菜单栏</h3>`,4),C={href:"https://xie.infoq.cn/article/ba9f61c8506c9b67f6b34de06",target:"_blank",rel:"noopener noreferrer"},V={href:"https://www.electronjs.org/zh/docs/latest/api/menu",target:"_blank",rel:"noopener noreferrer"},L=t(`<p>主进程中background.js/main.js</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,23);function N(P,U){const a=c("ExternalLinkIcon");return o(),i("div",null,[u,r,n("p",null,[s("学习视频地址："),n("a",d,[s("https://www.bilibili.com/video/BV1QB4y1F722?p=1&vd_source=f25f5a8d75a3a60d5a288f726803ec11"),e(a)])]),k,n("p",null,[s("官网 api "),n("a",v,[s("app | Electron (electronjs.org)"),e(a)])]),m,n("p",null,[s("打包超时可以看这个 "),n("a",b,[s("(195条消息) 解决electron打包时，下载超时导致失败_michaelxuzhi___的博客-CSDN博客"),e(a)])]),g,n("p",null,[s("下载文件为 "),n("a",h,[s("https://wwmj.lanzoue.com/b02ef6w8d"),e(a)]),s(" 密码:7ylu")]),y,n("p",null,[n("a",w,[s("简介 · electron-vue (gitbooks.io)"),e(a)])]),f,n("p",null,[s("解决： "),n("a",q,[s("(196条消息) Object.fromEntries is not a function electron-vue报错_24k唇动的博客-CSDN博客"),e(a)])]),x,n("p",null,[n("a",_,[s("electron-vue build的坑 - 简书 (jianshu.com)"),e(a)])]),n("p",null,[n("a",j,[s("基于Electron搭建跨平台应用程序 - leestar54 - 博客园 (cnblogs.com)"),e(a)])]),W,E,I,n("p",null,[s("解决： "),n("a",M,[s("(196条消息) Uncaught TypeError: (0 , vue__WEBPACK_IMPORTED_MODULE_3__.createVNode) is not a function_潮汐未见潮落的博客-CSDN博客"),e(a)])]),S,n("p",null,[n("a",B,[s("Electron 中的原生菜单 - 掘金 (juejin.cn)"),e(a)])]),D,n("p",null,[s("菜单栏部分配置可查看 "),n("a",T,[s("Electron 编写菜单栏 - Mr. Ma's Blog (misterma.com)"),e(a)])]),R,n("p",null,[s("借鉴 "),n("a",C,[s("vue + electronの文件读写_Electron_空城机_InfoQ写作社区"),e(a)]),s(),n("a",V,[s("Menu | Electron (electronjs.org)"),e(a)])]),L])}const A=p(l,[["render",N],["__file","desk.html.vue"]]);export{A as default};
