import{_ as p}from"./_plugin-vue_export-helper.cdc0426e.js";import{o,c,a as n,b as s,e as t,f as e,r as l}from"./app.a6537d53.js";const i={},u=e(`<h1 id="vue" tabindex="-1"><a class="header-anchor" href="#vue" aria-hidden="true">#</a> vue</h1><h2 id="vue项目打包一键去掉所有console-log" tabindex="-1"><a class="header-anchor" href="#vue项目打包一键去掉所有console-log" aria-hidden="true">#</a> vue项目打包一键去掉所有console.log</h2><p>在Vue项目中，可以通过使用babel插件来去除所有的console.log语句。以下是一种常用的方法：</p><ol><li>安装babel插件：babel-plugin-transform-remove-console</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install babel-plugin-transform-remove-console --save-dev
...
<span class="token literal-property property">methods</span><span class="token operator">:</span><span class="token punctuation">{</span>
   <span class="token function">next</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span> <span class="token comment">// 往下切换</span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue项目跳转时如何加密路由上面query传递的参数" tabindex="-1"><a class="header-anchor" href="#vue项目跳转时如何加密路由上面query传递的参数" aria-hidden="true">#</a> vue项目跳转时如何加密路由上面query传递的参数</h2>`,9),C={href:"https://blog.csdn.net/weixin_44243061/article/details/107092308",target:"_blank",rel:"noopener noreferrer"},V={href:"https://github.com/wukang0718/vueRouterEncryption",target:"_blank",rel:"noopener noreferrer"},E=n("p",null,"(实际使用有bug,在新页面打开带参数的url时，加密的参数并不能够解析出来)",-1),R=n("h2",{id:"后端返回很大的数据量-前端如何渲染",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#后端返回很大的数据量-前端如何渲染","aria-hidden":"true"},"#"),s(" 后端返回很大的数据量，前端如何渲染")],-1),M={href:"https://mp.weixin.qq.com/s/pWsntJbJnBip5CbP7HkvFg",target:"_blank",rel:"noopener noreferrer"},P=n("h2",{id:"vite创建vue3项目",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vite创建vue3项目","aria-hidden":"true"},"#"),s(" vite创建vue3项目")],-1),z={href:"https://juejin.cn/post/7276408879365636156",target:"_blank",rel:"noopener noreferrer"},D=e(`<p>普通创建vite项目</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm init vite@latest
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>除了前端配置代理之外，后台也要配置跨域，否则请求不到，后台跨域解决可以参考下面的文章</p>`,39),L={href:"https://juejin.cn/post/7229139006080253989",target:"_blank",rel:"noopener noreferrer"},T={href:"https://blog.csdn.net/qq_40185480/article/details/110926273",target:"_blank",rel:"noopener noreferrer"},N=e(`<h4 id="配置pinia" tabindex="-1"><a class="header-anchor" href="#配置pinia" aria-hidden="true">#</a> 配置pinia</h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install pinia
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="树形结构插件-vue2-org-tree-组织结构图" tabindex="-1"><a class="header-anchor" href="#树形结构插件-vue2-org-tree-组织结构图" aria-hidden="true">#</a> 树形结构插件 vue2-org-tree(组织结构图)</h3>`,13),H={href:"https://juejin.cn/post/7011705093665849375",target:"_blank",rel:"noopener noreferrer"},A={href:"https://zhuanlan.zhihu.com/p/117300250",target:"_blank",rel:"noopener noreferrer"},B=e(`<h3 id="vue3-中引入wangeditor富文本编辑器" tabindex="-1"><a class="header-anchor" href="#vue3-中引入wangeditor富文本编辑器" aria-hidden="true">#</a> Vue3 中引入wangeditor富文本编辑器</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i wangeditor -S
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行 npm run build:css 打包css代码，注意文件路径报错</p><h3 id="发布" tabindex="-1"><a class="header-anchor" href="#发布" aria-hidden="true">#</a> 发布</h3>`,40),W={href:"https://mp.weixin.qq.com/s/clyH5SFvwtPY19dagUgcDA",target:"_blank",rel:"noopener noreferrer"},X=e(`<p>1、准备一个npm账号</p><p>2、npm login 登录npm账号</p><p>3、npm publish (推送代码，注意修改package.json的配置)</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    &quot;name&quot;: &quot;fankoui3&quot;,
    &quot;version&quot;: &quot;0.1.0&quot;,
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在vue文件中使用Card组件，如可显示正常，则组件库创建成功。</p><h3 id="如何写一个属于自己的vue3组件库" tabindex="-1"><a class="header-anchor" href="#如何写一个属于自己的vue3组件库" aria-hidden="true">#</a> 如何写一个属于自己的Vue3组件库</h3>`,12),G={href:"https://mp.weixin.qq.com/s/jvLAFzwJPlA5J-iNJSblag",target:"_blank",rel:"noopener noreferrer"},Y={href:"https://juejin.cn/post/7255514764754894907?searchId=20231030164149D848293E31B857FECA86#heading-6",target:"_blank",rel:"noopener noreferrer"},$={href:"https://juejin.cn/post/7285373518836826167",target:"_blank",rel:"noopener noreferrer"},K=n("h2",{id:"vue3基本使用-用setup-语法糖",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue3基本使用-用setup-语法糖","aria-hidden":"true"},"#"),s(" vue3基本使用（用setup 语法糖）")],-1),Q={href:"https://cn.vuejs.org/guide/introduction.html",target:"_blank",rel:"noopener noreferrer"},Z=e(`<h3 id="计算属性" tabindex="-1"><a class="header-anchor" href="#计算属性" aria-hidden="true">#</a> 计算属性</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> ref<span class="token punctuation">,</span>reactive<span class="token punctuation">,</span> computed <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;vue&#39;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>特别是注意侦听器是如何两次使用 <code>todoId</code> 的，一次是作为源，另一次是在回调中。</p>`,8),nn={href:"https://cn.vuejs.org/api/reactivity-core.html#watcheffect",target:"_blank",rel:"noopener noreferrer"},sn=n("code",null,"watchEffect",-1),an=n("code",null,"watchEffect()",-1),tn=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>watchEffect(async () =&gt; {
  const response = await fetch(
    \`https://jsonplaceholder.typicode.com/todos/\${todoId.value}\`
  )
  data.value = await response.json()
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="异步状态示例" tabindex="-1"><a class="header-anchor" href="#异步状态示例" aria-hidden="true">#</a> 异步状态示例</h4><p>在做异步数据请求时，我们常常需要处理不同的状态：加载中、加载成功和加载失败。</p><p><strong>接收响应式状态</strong></p><p><code>useFetch()</code> 接收一个静态 URL 字符串作为输入——因此它只会执行一次 fetch 并且就此结束。如果我们想要在 URL 改变时重新 fetch 呢？为了实现这一点，我们需要将响应式状态传入组合式函数，并让它基于传入的状态来创建执行操作的侦听器。</p><p>举例来说，<code>useFetch()</code> 应该能够接收一个 ref：或者接收一个 getter 函数：</p>`,33),en={href:"https://cn.vuejs.org/api/reactivity-core.html#watcheffect",target:"_blank",rel:"noopener noreferrer"},pn=n("code",null,"watchEffect()",-1),on={href:"https://cn.vuejs.org/api/reactivity-utilities.html#tovalue",target:"_blank",rel:"noopener noreferrer"},cn=n("code",null,"toValue()",-1),ln=n("code",null,"toValue()",-1),un={href:"https://cn.vuejs.org/api/reactivity-utilities.html#unref",target:"_blank",rel:"noopener noreferrer"},rn=n("code",null,"unref()",-1),dn=e("<p>注意 <code>toValue(url)</code> 是在 <code>watchEffect</code> 回调函数的<strong>内部</strong>调用的。这确保了在 <code>toValue()</code> 规范化期间访问的任何响应式依赖项都会被侦听器跟踪。</p><p>这个版本的 <code>useFetch()</code> 现在能接收静态 URL 字符串、ref 和 getter，使其更加灵活。watch effect 会立即运行，并且会跟踪 <code>toValue(url)</code> 期间访问的任何依赖项。如果没有跟踪到依赖项（例如 url 已经是字符串），则 effect 只会运行一次；否则，它将在跟踪到的任何依赖项更改时重新运行。</p><p><strong>输入参数</strong></p>",3),kn={href:"https://cn.vuejs.org/api/reactivity-utilities.html#tovalue",target:"_blank",rel:"noopener noreferrer"},vn=n("code",null,"toValue()",-1),mn=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>import { toValue } from &#39;vue&#39;
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="如何在vue-js中创建模态框-弹出框" tabindex="-1"><a class="header-anchor" href="#如何在vue-js中创建模态框-弹出框" aria-hidden="true">#</a> 如何在Vue.js中创建模态框(弹出框)</h2>`,4),hn={href:"https://mp.weixin.qq.com/s/MddofJ10zYXtWAeGa5Z_Cw",target:"_blank",rel:"noopener noreferrer"},fn=e(`<h2 id="点击侧边展示导航的组件" tabindex="-1"><a class="header-anchor" href="#点击侧边展示导航的组件" aria-hidden="true">#</a> 点击侧边展示导航的组件</h2><p>用的ant-design-vue的 a-drawer</p><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue3使用jsx" tabindex="-1"><a class="header-anchor" href="#vue3使用jsx" aria-hidden="true">#</a> vue3使用jsx</h2>`,4),yn={href:"https://juejin.cn/post/7213356423810924581",target:"_blank",rel:"noopener noreferrer"},qn={href:"https://juejin.cn/post/7151950058501373989?from=search-suggest",target:"_blank",rel:"noopener noreferrer"},wn={href:"https://juejin.cn/post/7261604498924961829",target:"_blank",rel:"noopener noreferrer"},xn={href:"https://zhuanlan.zhihu.com/p/375527289",target:"_blank",rel:"noopener noreferrer"},jn={href:"https://juejin.cn/post/7272308621710213161",target:"_blank",rel:"noopener noreferrer"},_n=e(`<p>想在项目中使用 JSX,我们需要安装一个插件<code>@vitejs/plugin-vue-jsx</code>,这个插件可以让我们在项目中使用 JSX/TSX</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i @vitejs/plugin-vue-jsx -D
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue使用tailwindcss" tabindex="-1"><a class="header-anchor" href="#vue使用tailwindcss" aria-hidden="true">#</a> vue使用Tailwindcss</h2>`,12),Sn={href:"https://www.tailwindcss.cn/docs/width",target:"_blank",rel:"noopener noreferrer"},Cn=n("p",null,"当有不知道的类可以直接到官网文档查看",-1),Vn={href:"https://juejin.cn/post/7228488937505030199",target:"_blank",rel:"noopener noreferrer"},En={href:"https://juejin.cn/post/7216990794942201913#heading-5",target:"_blank",rel:"noopener noreferrer"},Rn=e(`<p>安装依赖</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i -D tailwindcss postcss autoprefixer
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>vue3 同时使用 element plus 和 Tailwindcss 可能会出现样式冲突（例如el-button显示异常），此时一种解决方法是先引入 Tailwindcss ，然后再引入 element plus 的样式文件</strong></p><p>vscode 安装 Tailwind CSS IntelliSense 插件 ,没有提示功能，通过如下解决：</p><p>1 vscode点击设置</p><p>2 搜索 <code>editor.quickSuggestions</code></p><p>3 strings 改为 on</p><h2 id="vueuse" tabindex="-1"><a class="header-anchor" href="#vueuse" aria-hidden="true">#</a> vueUse</h2>`,21),Mn={href:"https://www.vueusejs.com/guide/",target:"_blank",rel:"noopener noreferrer"},Pn=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i @vueuse/core
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4);function zn(Dn,Ln){const a=l("ExternalLinkIcon");return o(),c("div",null,[u,n("ul",null,[n("li",null,[n("a",r,[s("Vue CLI官方文档 - Babel配置"),t(a)])]),n("li",null,[n("a",d,[s("babel-plugin-transform-remove-console"),t(a)])])]),k,n("p",null,[n("a",v,[s("(202条消息) vue实现登录后跳转到之前的页面_longzhoufeng的博客-CSDN博客"),t(a)])]),m,n("p",null,[s("官网： "),n("a",b,[s("安装 | Pinia 中文文档 (web3doc.top)"),t(a)])]),g,n("p",null,[n("a",h,[s("https://juejin.cn/post/6928468842377117709"),t(a)])]),n("p",null,[n("a",f,[s("https://juejin.cn/post/6994337441314242590#heading-15"),t(a)])]),n("p",null,[n("a",y,[s("https://juejin.cn/post/7087100496762109983#heading-16"),t(a)])]),q,n("p",null,[n("a",w,[s("https://juejin.cn/post/7078281612013764616#heading-0"),t(a)])]),x,n("p",null,[s("页面全屏滚动很多用于官网首页，使用的频率还挺高的，此处的代码实现的功能是 鼠标滚动，页面切换，点击键盘的上下键，页面切换。类似效果看 "),n("a",j,[s(" 全屏滚动_jQuery之家-自由分享jQuery、html5、css3的插件库 (htmleaf.com)"),t(a)]),s(" ，以下内容改自 "),n("a",_,[s("vue实现全屏滚动，非fullpage.js-阿里云开发者社区 (aliyun.com)"),t(a)]),s(" 。")]),S,n("p",null,[n("a",C,[s("vue-router路由中对query中的参数进行加密_router 参数加密_前端_小学生的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",V,[s("vue-router中传递的参数进行自动加密显示，组件中获取自动解密 (github.com)"),t(a)])]),E,R,n("p",null,[n("a",M,[s("https://mp.weixin.qq.com/s/pWsntJbJnBip5CbP7HkvFg"),t(a)])]),P,n("p",null,[n("a",z,[s("十分钟搭建 Vite+Vue3 项目模板 - 掘金 (juejin.cn)"),t(a)])]),D,n("p",null,[n("a",L,[s("SpringBoot 项目解决跨域的几种方案 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[s("（vue3中使用消息提示 "),n("a",T,[s("vue3中使用element-plus调用message_element-plus message_"),t(a)]),s(" ）")]),N,n("p",null,[n("a",H,[s("Vue 树形结构插件 vue2-org-tree - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",A,[s("详解树状结构图 vue-org-tree - 知乎 (zhihu.com)"),t(a)])]),B,n("p",null,[n("a",F,[s("unplugin-vue-macros(github.com) "),t(a)])]),J,n("p",null,[n("a",O,[s("b站参考学习视频地址"),t(a)]),s(),n("a",I,[s("参考文章 vue组件库的基本开发步骤 "),t(a)])]),U,n("p",null,[n("a",W,[s("图文结合简单易学的 npm 包的发布流程 (qq.com)"),t(a)])]),X,n("p",null,[n("a",G,[s("如何写一个属于自己的Vue3组件库 (qq.com)"),t(a)])]),n("p",null,[n("a",Y,[s("【前端工程化-组件库】从0-1构建Vue3组件库（打包发布） - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",$,[s("前端工程化😼开源项目都在用的【Monorepo】🏋🏿 - 掘金 (juejin.cn)"),t(a)])]),K,n("p",null,[n("a",Q,[s("https://cn.vuejs.org/guide/introduction.html"),t(a)])]),Z,n("p",null,[s("用 "),n("a",nn,[sn,s(" 函数"),t(a)]),s(" 来简化上面的代码。"),an,s(" 允许我们自动跟踪回调的响应式依赖")]),tn,n("p",null,[s("我们可以用 "),n("a",en,[pn,t(a)]),s(" 和 "),n("a",on,[cn,t(a)]),s(" API 来重构我们现有的实现：")]),n("p",null,[ln,s(" 是一个在 3.3 版本中新增的 API。它的设计目的是将 ref 或 getter 规范化为值。如果参数是 ref，它会返回 ref 的值；如果参数是函数，它会调用函数并返回其返回值。否则，它会原样返回参数。它的工作方式类似于 "),n("a",un,[rn,t(a)]),s("，但对函数有特殊处理。")]),dn,n("p",null,[s("即便不依赖于 ref 或 getter 的响应性，组合式函数也可以接收它们作为参数。如果你正在编写一个可能被其他开发者使用的组合式函数，最好处理一下输入参数是 ref 或 getter 而非原始值的情况。可以利用 "),n("a",kn,[vn,t(a)]),s(" 工具函数来实现：")]),mn,n("p",null,[n("a",bn,[s("示例地址"),t(a)])]),gn,n("p",null,[n("a",hn,[s("如何在Vue.js中创建模态框(弹出框) (qq.com)"),t(a)])]),fn,n("p",null,[n("a",yn,[s("如何在 vue3 中使用 jsx/tsx? - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",qn,[s("在 vue3 中优雅的使用 jsx/tsx - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",wn,[s("在Vue3中利用JSX+函数式组件做到更好的代码复用 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",xn,[s("JSX 设置样式 - 知乎 (zhihu.com)"),t(a)])]),n("p",null,[n("a",jn,[s("万字长文详解 Vue JSX，带你全面拥抱 JSX 特性！-讲述了jsx的优点 - 掘金 (juejin.cn)"),t(a)])]),_n,n("p",null,[s("官方文档： "),n("a",Sn,[s("Width - TailwindCSS中文文档 | TailwindCSS中文网"),t(a)])]),Cn,n("p",null,[n("a",Vn,[s("在vite-vue3中快速使用Tailwindcss - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",En,[s("Vue中使用 Tailwind CSS - 掘金 (juejin.cn)"),t(a)])]),Rn,n("p",null,[n("a",Mn,[s("起步 | VueUse中文文档 (vueusejs.com)"),t(a)])]),Pn])}const Hn=p(i,[["render",zn],["__file","4.html.vue"]]);export{Hn as default};
