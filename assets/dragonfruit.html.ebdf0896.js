...
&lt;/style&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上就是对uniapp小程序的分包操作，那么如何查看自己分包是否成功了呢，在微信开发者工具打开，点击详情，在基本信息页面可以看到本地代码，点开后就能查看自己的主包和分包信息了，如果包的大小还是大于2M的话，就需要继续优化了。</p><p><img src="`+r+'" alt="PackageAuniWechat" loading="lazy"></p>',36),C={href:"https://juejin.cn/post/7296025902911897627",target:"_blank",rel:"noopener noreferrer"},S=n("h2",{id:"pages-json",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#pages-json","aria-hidden":"true"},"#"),s(" pages.json")],-1),B={href:"https://uniapp.dcloud.net.cn/collocation/pages.html#",target:"_blank",rel:"noopener noreferrer"},P=e(`<div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="uniapp使用echarts图" tabindex="-1"><a class="header-anchor" href="#uniapp使用echarts图" aria-hidden="true">#</a> uniapp使用echarts图</h2>`,2),I={href:"https://ext.dcloud.net.cn/plugin?id=8017",target:"_blank",rel:"noopener noreferrer"},L=e(`<p>注意：使用HBuilderX导入插件echarts， 使用页面需要将 组件 引入进来使用， 要为引入的 echarts 设置宽高，否则可能不显示。</p><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="uni-cloud云开发" tabindex="-1"><a class="header-anchor" href="#uni-cloud云开发" aria-hidden="true">#</a> uni-cloud云开发</h2>`,5),D={href:"https://www.bilibili.com/video/BV1PP411E7qG/?spm_id_from=333.337.search-card.all.click&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},W={href:"https://uniapp.dcloud.net.cn/uniCloud/#",target:"_blank",rel:"noopener noreferrer"},N=n("p",null,"（uni-cloud-project）",-1),F={href:"https://unicloud.dcloud.net.cn/",target:"_blank",rel:"noopener noreferrer"},U=n("p",null,"uniCloud项目显示关联到的服务空间，则绑定成功",-1),$=n("h3",{id:"客户端和云函数的通信",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#客户端和云函数的通信","aria-hidden":"true"},"#"),s(" 客户端和云函数的通信")],-1),z=n("p",null,[s("uni-app客户端和传统服务器通信时，使用"),n("code",null,"uni.request"),s("的ajax请求方式。uniCloud下不再使用它，有更好的云端一体的通信方式。")],-1),O=n("p",null,"uniCloud体系里，客户端和服务端的云函数通信，有4种方式：",-1),V=n("thead",null,[n("tr",null,[n("th",{style:{"text-align":"center"}}),n("th",{style:{"text-align":"center"}},"传统的restful方式"),n("th",{style:{"text-align":"center"}},"callfunction方式"),n("th",{style:{"text-align":"center"}},"云对象方式"),n("th",{style:{"text-align":"center"}},"clientDB方式")])],-1),E=n("td",{style:{"text-align":"center"}},"简述",-1),R={style:{"text-align":"center"}},M={href:"https://uniapp.dcloud.net.cn/uniCloud/http",target:"_blank",rel:"noopener noreferrer"},H=n("td",{style:{"text-align":"center"}},"云函数默认并不自带http链接",-1),G=n("td",{style:{"text-align":"center"}},"把callfunction的函数式调用，升级为模块化的对象调用",-1),X=n("td",{style:{"text-align":"center"}},"客户端直接操作云数据库",-1),J=n("tr",null,[n("td",{style:{"text-align":"center"}},"前端调用方式"),n("td",{style:{"text-align":"center"}},"传统ajax"),n("td",{style:{"text-align":"center"}},[s("uni-app客户端通过"),n("code",null,"uniCloud.callFunction(functionname)"),s("来调用云函数")]),n("td",{style:{"text-align":"center"}},[s("uni-app客户端通过"),n("code",null,"uniCloud.importObject(objectname)"),s("导入一个云对象，直接使用这个对象的方法")]),n("td",{style:{"text-align":"center"}},[s("uni-app客户端通过``组件或"),n("code",null,"uniCloud.database()"),s(" API来访问uniCloud数据库。也支持搭配action云函数追加服务器逻辑")])],-1),Q=n("tr",null,[n("td",{style:{"text-align":"center"}},"适用场景"),n("td",{style:{"text-align":"center"}},"http链接需要自己注册域名。如果前端是uni-app，则不推荐使用URL化。如果是非uni-app的系统需要访问云函数，只能使用URL化"),n("td",{style:{"text-align":"center"}},"相比云函数URL，callfunction更加安全、更serverless，不暴露域名和ip，不怕攻击，也无需注册域名"),n("td",{style:{"text-align":"center"}},"uni-app 3.4起支持。相比callfunction方式。代码更加精简、逻辑更加清晰、开发更加高效"),n("td",{style:{"text-align":"center"}},"如果uni-app前端发起的服务器请求目的主要是查询或操作数据库，则推荐使用clientDB方式")],-1),K=e(`<p>云函数是uniCloud的基础，本质上 clientDB 和 云对象 都是建立在云函数上针对特定场景的优化。</p><ul><li>clientDB针对的场景是数据库操作，它优化了可以不写或少写服务器代码</li><li>云对象针对的场景是非数据库操作或不宜前端暴露的数据库操作时，和uni-app客户端的通信方式。它优化了代码结构，更精简、简单</li></ul><h3 id="clientdb方式" tabindex="-1"><a class="header-anchor" href="#clientdb方式" aria-hidden="true">#</a> clientDB方式</h3><p>clientDB分API方式和组件方式，此处使用API方式来演示 (必须要配合DB Schema 使用)</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 客户端js直接操作云数据库，查询list表的数据。无需服务器代码</span>
...
<span class="token punctuation">}</span>
				...
				db<span class="token punctuation">.</span><span class="token function">collection</span><span class="token punctuation">(</span><span class="token string">&#39;users&#39;</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
				  ...
				  <span class="token punctuation">}</span><span class="token punctuation">)</span>
			<span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="uni-id用户体系" tabindex="-1"><a class="header-anchor" href="#uni-id用户体系" aria-hidden="true">#</a> uni-id用户体系</h3>`,49),Y={href:"https://ext.dcloud.net.cn/plugin?name=uni-id-pages",target:"_blank",rel:"noopener noreferrer"},Z=n("code",null,"uniCloud/cloudfunctions/common/uni-config-center/uni-id/config.json",-1),nn={href:"https://uniapp.dcloud.net.cn/uniCloud/uni-id-summary.html#config",target:"_blank",rel:"noopener noreferrer"},sn=n("h3",{id:"注意",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#注意","aria-hidden":"true"},"#"),s(" 注意")],-1),an=n("p",null,"项目体验在微信小程序上，要发送到体验版的时候，应该在hbuiler里面点击发布，并在微信小程序后台配置域名。",-1);function tn(en,pn){const a=i("ExternalLinkIcon");return o(),l("div",null,[c(`
 ...
 * @param: 
 * @return: 
`),k,v,m,b,g,y,n("p",null,[n("a",h,[s("uni-app快速上手 | uni-app官网 (dcloud.net.cn)"),t(a)])]),n("p",null,[n("a",q,[s("DCloud 插件市场"),t(a)])]),x,n("p",null,[n("a",f,[s("( 对于封装微信小程序uni.request请求，支持自动携带token,可查看这篇文章"),t(a)])]),w,n("p",null,[n("a",_,[s("@escook/request-miniprogram - npm (npmjs.com)"),t(a)])]),j,n("p",null,[n("a",C,[s("【已解决】uniapp小程序体积过大、隐私协议的问题 - 掘金 (juejin.cn)"),t(a)])]),S,n("p",null,[n("a",B,[s("uni-app官网 (dcloud.net.cn)"),t(a)])]),P,n("p",null,[s("插件地址 ： "),n("a",I,[s("echarts for uniapp - DCloud 插件市场"),t(a)])]),L,n("p",null,[n("a",T,[s("https://juejin.cn/post/7087789961490989070"),t(a)])]),A,n("p",null,[n("a",D,[s("uniCloud云开发视频教程-从基础入门到项目开发实战-uniapp进阶课文章管理系统（云函数/云数据库/云存储"),t(a)])]),n("p",null,[n("a",W,[s("uni-app官网 (dcloud.net.cn)"),t(a)])]),N,n("p",null,[s("创建空的uni-app项目，右键关联阿里云服务器 "),n("a",F,[s("服务空间 - uniCloud (dcloud.net.cn)"),t(a)])]),U,$,z,O,n("table",null,[V,n("tbody",null,[n("tr",null,[E,n("td",R,[s("通过配置"),n("a",M,[s("云函数URL化"),t(a)]),s("，把云函数转为传统的http链接")]),H,G,X]),J,Q])]),K,n("p",null,[s("下载插件：下载地址："),n("a",Y,[s("https://ext.dcloud.net.cn/plugin?name=uni-id-pages"),t(a)])]),n("p",null,[s("uni-id的云端配置文件在 "),Z,s(" 中（没有这个目录的自己创建，配置文件在 "),n("a",nn,[s("uni-app官网 (dcloud.net.cn)"),t(a)]),s(" 找到复制进来 注意复制后要符合json格式，去除所有注释【 passwordSecret 和 tokenSecret 自己设置，不能为空】）。")]),sn,an])}const cn=p(d,[["render",tn],["__file","dragonfruit.html.vue"]]);export{cn as default};
