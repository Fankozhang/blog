...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>1,测试类如果存在于引导类所在包或子包中无需指定引导类 2.测试类如果不存在于引导类所在的包或子包中需要通过@SpringBootTest(c1asses= ***.class)属性指定引导类</p><h2 id="整合mybatis-数据库配置" tabindex="-1"><a class="header-anchor" href="#整合mybatis-数据库配置" aria-hidden="true">#</a> 整合myBatis （数据库配置）</h2><p>该心配置：数据库连接相关信息（连什么？连谁？什么权限) 映射配置：SQL映射（ML/注解)</p><p>建模块时可勾选 SQL-&gt;MyBatis Framework,MySQL Driver ,不勾选则自己导入坐标</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>        &lt;!--1.导入对应的starter--&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="redistemplate自定义配置及序列化" tabindex="-1"><a class="header-anchor" href="#redistemplate自定义配置及序列化" aria-hidden="true">#</a> RedisTemplate自定义配置及序列化</h5>`,11),Mn={href:"https://blog.csdn.net/Good_omen/article/details/123993468",target:"_blank",rel:"noopener noreferrer"},Rn=e(`<div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@Configuration</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="redistemplate常用方法" tabindex="-1"><a class="header-anchor" href="#redistemplate常用方法" aria-hidden="true">#</a> RedisTemplate常用方法</h5>`,4),Cn={href:"https://blog.csdn.net/zzvar/article/details/118388897",target:"_blank",rel:"noopener noreferrer"},Dn={href:"https://juejin.cn/post/7175756564752990267#heading-48",target:"_blank",rel:"noopener noreferrer"},Pn=n("h5",{id:"redistemplate-opsforvalue-方法",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#redistemplate-opsforvalue-方法","aria-hidden":"true"},"#"),s(" redisTemplate.opsForValue()方法")],-1),An={href:"https://blog.csdn.net/qq_43842093/article/details/121527498",target:"_blank",rel:"noopener noreferrer"},Nn={href:"https://blog.csdn.net/weixin_43658899/article/details/121062760",target:"_blank",rel:"noopener noreferrer"},Ln=e(`<h5 id="redis使用-手机号获取验证码" tabindex="-1"><a class="header-anchor" href="#redis使用-手机号获取验证码" aria-hidden="true">#</a> redis使用（手机号获取验证码）</h5><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token comment">// redis测试</span>
...
<span class="token punctuation">}</span>
	...
	<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testProductQueue</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
		...
		<span class="token punctuation">}</span>
	<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="jedis" tabindex="-1"><a class="header-anchor" href="#jedis" aria-hidden="true">#</a> jedis</h5>`,13),En={href:"https://blog.csdn.net/I_r_o_n_M_a_n/article/details/122685882",target:"_blank",rel:"noopener noreferrer"},On=n("p",null,"lettcus与jedis区别 jedis连接Redis.服务器是直连模式，当多线程模式下使用jedis会存在线程安全问题，解决方案可以通过配置连接池使每个连接专用，这样整体性能就大受影响。 lettcus基于Netty框架进行与Redis服务器连接，底层设计中采用StatefulRedisConnection。StatefulRedisConnection自身是线程安全的，可以保障并发访问安全问题，所以一个连接可以被多线程复用。当然lettcus也支持多连接实例一起工作。",-1),Qn=n("h4",{id:"mongodb",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#mongodb","aria-hidden":"true"},"#"),s(" MongoDB")],-1),Un=n("p",null,"MongoDB是一个开源、高性能、无模式的文档型数据库。NoSQL数据库产品中的一种，是最像关系型数据库的非 关系型数据库",-1),Jn=n("p",null,"MongoDB数据库的常用命令",-1),zn={href:"https://blog.csdn.net/qq_55648724/article/details/128171457",target:"_blank",rel:"noopener noreferrer"},Vn=n("p",null,"springBoot整合 mongoDB",-1),Fn={href:"https://blog.csdn.net/weixin_47343544/article/details/127175205",target:"_blank",rel:"noopener noreferrer"},Wn={href:"https://cloud.tencent.com/developer/article/2245018",target:"_blank",rel:"noopener noreferrer"},Hn=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;!-- 引入mongodb--&gt;
        &lt;dependency&gt;
            &lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;
...
reggie:
  #  指定上传文件暂存的位置
  path: D:\\img\\
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="jwt" tabindex="-1"><a class="header-anchor" href="#jwt" aria-hidden="true">#</a> JWT</h2><p>什么是JWT? JSON Web Token,通过数字签名的方式，以JSQN对象为载体，在不同的服务终端之间安全的传输信息。 JWT有什么用？ JW工最常见的场景就是授权认证，一旦用户登录，后续每个请求都将包含JWT，系统在每次处理用户请求的之前，都要先进行JWT安全校验，通过之后再进行处理。 JWT的组成 JWT由3部分组成，用拼接</p>`,11),ss={href:"https://blog.csdn.net/qq_44972847/article/details/109249604",target:"_blank",rel:"noopener noreferrer"},as=e(`<ul><li>头部(header)</li><li>载荷(payload)</li><li>签证(signature)</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> &lt;dependency&gt;
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="登录" tabindex="-1"><a class="header-anchor" href="#登录" aria-hidden="true">#</a> 登录</h2><p><strong>工具类</strong></p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token comment">//  工具类</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9),ts={href:"https://blog.csdn.net/qq_41450736/article/details/113523308",target:"_blank",rel:"noopener noreferrer"},es=n("h2",{id:"rabbitmq",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#rabbitmq","aria-hidden":"true"},"#"),s(" RabbitMQ")],-1),ps={href:"https://juejin.cn/post/7198430801850105916",target:"_blank",rel:"noopener noreferrer"},is={href:"https://developer.aliyun.com/article/769883",target:"_blank",rel:"noopener noreferrer"},os={href:"https://blog.csdn.net/huzecom/article/details/103499692",target:"_blank",rel:"noopener noreferrer"},cs={href:"https://www.bilibili.com/video/BV1Xm4y1i7HP?p=1&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},ls=e(`<h3 id="docker安装rabbitmq" tabindex="-1"><a class="header-anchor" href="#docker安装rabbitmq" aria-hidden="true">#</a> docker安装RabbitMQ</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker pull rabbitmq:management
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li><code>15672</code>端口：RabbitMQ的<strong>管理页面</strong>端口</li><li><code>5672</code>端口：RabbitMQ的<strong>消息接收</strong>端口</li><li><code>RABBITMQ_DEFAULT_USER</code>环境变量：指定RabbitMQ的<strong>用户名</strong>，这里我指定为<code>fankozhang</code>，大家部署时替换成自己定义的</li><li><code>RABBITMQ_DEFAULT_PASS</code>环境变量：指定RabbitMQ的<strong>密码</strong>，这里我指定为<code>123456</code>，大家部署时替换成自己定义的</li></ul><p>这样容器就部署完成了！在浏览器访问你的<code>服务器地址:15672</code>即可访问到RabbitMQ的管理界面，用户名和密码即为刚刚指定的环境变量的配置值。</p>`,6),us={href:"http://127.0.0.1:15672",target:"_blank",rel:"noopener noreferrer"},rs=e("<p>RabbitMQ的组成，它是有这几部分：</p><ul><li>Broker：消息队列服务进程。此进程包括两个部分：Exchange和Queue。</li><li>Exchange：消息队列交换机。<strong>按一定的规则将消息路由转发到某个队列</strong>。</li><li>Queue：消息队列，存储消息的队列。</li><li>Producer：消息生产者。生产方客户端将消息同交换机路由发送到队列中。</li><li>Consumer：消息消费者。消费队列中存储的消息。</li></ul><p>这些组成部分是如何协同工作的呢，大概的流程如下</p><ul><li>消息生产者连接到RabbitMQ Broker，创建connection，开启channel。</li><li>生产者声明交换机类型、名称、是否持久化等。</li><li>生产者发送消息，并指定消息是否持久化等属性和routing key。</li><li>exchange收到消息之后，<strong>根据routing key路由到跟当前交换机绑定的相匹配的队列</strong>里面。</li><li>消费者监听接收到消息之后开始业务处理。</li></ul>",4),ds={id:"示例-b站视频地址",tabindex:"-1"},ks=n("a",{class:"header-anchor",href:"#示例-b站视频地址","aria-hidden":"true"},"#",-1),vs={href:"https://www.bilibili.com/video/BV1Am4y1z7Tu?p=1&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},ms=e(`<p>创建生产者</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@SpringBootApplication</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="rabbitmq交换机类型" tabindex="-1"><a class="header-anchor" href="#rabbitmq交换机类型" aria-hidden="true">#</a> RabbitMQ交换机类型</h3>`,5),bs={href:"https://www.cnblogs.com/hsiang/p/14747030.html",target:"_blank",rel:"noopener noreferrer"},gs=n("p",null,"RabbitMQ一共四种交换机，如下所示：",-1),hs=n("ol",null,[n("li",null,"Direct Exchange：直连交换机，根据Routing Key(路由键)进行投递到不同队列。"),n("li",null,"Fanout Exchange：扇形交换机，采用广播模式，根据绑定的交换机，路由到与之对应的所有队列。"),n("li",null,"Topic Exchange：主题交换机，对路由键进行模式匹配后进行投递，符号#表示一个或多个词，*表示一个词。"),n("li",null,"Header Exchange：头交换机，不处理路由键。而是根据发送的消息内容中的headers属性进行匹配。")],-1),ys=n("h2",{id:"模板引擎-thymeleaf",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#模板引擎-thymeleaf","aria-hidden":"true"},"#"),s(" 模板引擎（thymeleaf）")],-1),fs={href:"https://blog.csdn.net/Lzy410992/article/details/115371017",target:"_blank",rel:"noopener noreferrer"},ws={href:"https://fanlychie.github.io/post/thymeleaf.html",target:"_blank",rel:"noopener noreferrer"},qs=e(`<p>依赖</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
			&lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;
			&lt;artifactId&gt;spring-boot-starter-thymeleaf&lt;/artifactId&gt;
		&lt;/dependency&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="实践" tabindex="-1"><a class="header-anchor" href="#实践" aria-hidden="true">#</a> 实践：</h3>`,3),Ss=n("p",null,[s('resources/template/index.html (资源里面新建 index.html 文件) th:text="'),n("span",{class:"katex"},[n("span",{class:"katex-mathml"},[n("math",{xmlns:"http://www.w3.org/1998/Math/MathML"},[n("semantics",null,[n("mrow",null,[n("mrow",null,[n("mi",null,"m"),n("mi",null,"s"),n("mi",null,"g")]),n("mi",{mathvariant:"normal"},'"'),n("mtext",null,"的")]),n("annotation",{encoding:"application/x-tex"},'{msg}"的')])])]),n("span",{class:"katex-html","aria-hidden":"true"},[n("span",{class:"base"},[n("span",{class:"strut",style:{height:"0.8889em","vertical-align":"-0.1944em"}}),n("span",{class:"mord"},[n("span",{class:"mord mathnormal"},"m"),n("span",{class:"mord mathnormal"},"s"),n("span",{class:"mord mathnormal",style:{"margin-right":"0.03588em"}},"g")]),n("span",{class:"mord"},'"'),n("span",{class:"mord cjk_fallback"},"的")])])]),s("msg 是thymeleaf占位符语法")],-1),xs=e(`<div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">&gt;</span></span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> thymeController <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>输入网页地址，可以看到 msg 为 欢迎使用 thymeleaf 展示在 html 中</p><h3 id="整合thymeleaf-实现模板文件转word打印" tabindex="-1"><a class="header-anchor" href="#整合thymeleaf-实现模板文件转word打印" aria-hidden="true">#</a> 整合thymeleaf 实现模板文件转word打印</h3>`,5),_s={href:"https://blog.csdn.net/HXNLYW/article/details/106330927",target:"_blank",rel:"noopener noreferrer"},Is=n("h3",{id:"整合flyingsaucer-thymeleaf-实现模板文件转pdf打印",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#整合flyingsaucer-thymeleaf-实现模板文件转pdf打印","aria-hidden":"true"},"#"),s(" 整合FlyingSaucer + thymeleaf 实现模板文件转pdf打印")],-1),Bs={href:"https://blog.csdn.net/HXNLYW/article/details/104478142",target:"_blank",rel:"noopener noreferrer"},js=n("p",null,"字体文件放在 resources/static/font/simsun.ttf 位置 ，不加入字体文件导出pdf时会格式错误",-1),Ts={href:"https://wwmj.lanzoue.com/iYBOx1a6cbab",target:"_blank",rel:"noopener noreferrer"},Ms=n("h2",{id:"文章收藏",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#文章收藏","aria-hidden":"true"},"#"),s(" 文章收藏")],-1),Rs={href:"https://mp.weixin.qq.com/s/evA1d1vY9Nqt72zFNQvgeA",target:"_blank",rel:"noopener noreferrer"};function Cs(Ds,Ps){const a=c("ExternalLinkIcon");return i(),o("div",null,[u,n("h3",r,[d,s(" 学前拓展：mybatis "),n("a",k,[s("B站视频资料"),t(a)])]),v,n("p",null,[n("a",m,[s("IDEA最右侧栏的Maven窗口不见了怎么调出来-百度经验 (baidu.com)"),t(a)]),s(),b]),g,n("p",null,[n("a",h,[s("https://blog.csdn.net/weixin_43785284/article/details/122015400"),t(a)])]),y,n("p",null,[n("a",f,[s("https://blog.csdn.net/m0_67391121/article/details/126020133"),t(a)])]),w,n("p",null,[n("a",q,[s("(228条消息) Controller层接收前端页面传参种类及实现_前端传值到controller_爱学习的小健的博客-CSDN博客"),t(a)])]),S,n("p",null,[n("a",x,[s("(210条消息) MAVEN:打包报错 Failed to execute goal org.apache.maven.plugins:maven-compiler-plugin:3.1:compile_Int_Xu的博客-CSDN博客"),t(a)])]),_,n("p",null,[n("a",I,[s("(227条消息) jar包在linux上持续运行及终止运行的命令_linux 停止持久运行_羊糕的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",B,[s("(227条消息) Linux 解决nohup: 忽略输入并把输出追加到“nohup.out“和nohup: 忽略输入重定向错误到标准输出端_千与千与千的博客-CSDN博客"),t(a)])]),j,n("p",null,[s("VIM中常用命令 "),n("a",T,[s("https://blog.csdn.net/feosun/article/details/73196299"),t(a)])]),M,R,C,n("p",null,[n("a",D,[s("(210条消息) linux 安装mysql8.0 超详细图文教程__亮亮同學的博客-CSDN博客"),t(a)])]),n("p",null,[s("安装mysql，进行初始化时失败报错 ： "),n("a",P,[s(" 初始化Mysql报错：初始化数据库显示libaio.so.1_兔飞小朋友的博客-CSDN博客"),t(a)])]),n("p",null,[s("报错：log-error set to '/var/log/mariadb/mariadb.log', however file don't exists. Create writable for user 'mysql'. "),n("a",A,[s("(219条消息) Linux安装MySQL时候出现log-error set to '/var/log/mariadb/mariadb.log', however file don't exists._BertonYip的博客-CSDN博客"),t(a)])]),N,n("p",null,[n("a",L,[s("(219条消息) Mysql 启动报错解析：Starting MySQL.. ERROR! The server quit without updating PID file (/usr/local/mysql/dat_清风的BLOG的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",E,[s("Linux 安装 MySQL 8.0.26 超详细图文步骤 - yoodb - 博客园 (cnblogs.com)"),t(a)]),s(" (实测有效)")]),n("p",null,[n("a",O,[s("(210条消息) Linux怎样到切换到超级用户_linux超级用户权限怎么打开_bo_无问西东的博客-CSDN博客"),t(a)])]),Q,n("p",null,[n("a",U,[s("(210条消息) 05.navicat连接不上虚拟机内的mysql_navicat连不上虚拟机中的mysql_weixin_49015210的博客-CSDN博客"),t(a)])]),J,z,V,F,W,H,n("p",null,[s("Redis下载与安装"),K,s(" 在Linux系统安装Redis步骤： 1.将Redis安装包上传到Linux 下载地址("),n("a",G,[s("https://download.redis.io/releases/"),t(a)]),s(")")]),Y,X,$,Z,nn,sn,n("p",null,[n("a",an,[s("(227条消息) linux 安装jdk 两种方法：手动安装 和yum安装：_阿尔卑斯狼__的博客-CSDN博客"),t(a)])]),n("p",null,[s("yum install -y java-1.8.0-"),n("a",tn,[s("openjdk"),t(a)]),s(".x86_64")]),n("p",null,[s("查看 java -"),n("a",en,[s("version"),t(a)])]),pn,n("p",null,[n("a",on,[s("(227条消息) linux下打开对外开放端口号_linux开通端口_laidanlove250的博客-CSDN博客"),t(a)])]),cn,n("p",null,[n("a",ln,[s("(214条消息) springboot与maven的多环境兼容解决方案_springboot兼容pom_沐雪架构师的博客-CSDN博客"),t(a)])]),un,n("p",null,[n("a",rn,[s("(214条消息) SpringBoot的日志_springboot 日志_威少总冠军的博客-CSDN博客"),t(a)])]),dn,n("p",null,[n("a",kn,[s("(214条消息) springboot实现热部署_springboot热部署_lwj_07的博客-CSDN博客"),t(a)])]),vn,n("p",null,[n("a",mn,[s("(215条消息) SpringBoot测试用例设置随机数据_springboot生成随机id_梨轻巧的博客-CSDN博客"),t(a)])]),bn,n("p",null,[n("a",gn,[s("SpringBoot使用JdbcTemplate_慕课手记 (imooc.com)"),t(a)])]),hn,n("p",null,[n("a",yn,[s("参考B站redis视频"),t(a)])]),n("p",null,[s("redis配置文件： "),n("a",fn,[s("Redis配置文件详解 - 掘金 (juejin.cn)"),t(a)]),s(),n("a",wn,[s("Redis配置文件Redis.conf详解 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[s("redis 常用指令 "),n("a",qn,[s("redis 常用指令 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[Sn,s(),n("a",xn,[s("https://gitee.com/qishibo/AnotherRedisDesktopManager/releases"),t(a)])]),_n,n("p",null,[s("参考： "),n("a",In,[s("(215条消息) springboot整合redis_springboot redis_lwj_07的博客-CSDN博客"),t(a)])]),n("p",null,[s("​ "),n("a",Bn,[s("(215条消息) 如何用SpringBoot整合Redis（详细讲解~）_我是一棵卷心菜的博客-CSDN博客"),t(a)])]),n("p",null,[s("​ "),n("a",jn,[s("SpringBoot教程(十四) | SpringBoot集成Redis(全网最全) - 掘金 (juejin.cn)"),t(a)])]),Tn,n("p",null,[s("增加RedisConfig的配置类（ "),n("a",Mn,[s(" redistemplate使用前需要配置一下connectionfactory和序列化方式_"),t(a)]),s(" ）")]),Rn,n("p",null,[n("a",Cn,[s("(230条消息) RedisTemplate常用方法（超详细）_Yan Yang的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",Dn,[s("RedisTemplate操作Redis，这一篇文章就够了（一） - 掘金 (juejin.cn)"),t(a)])]),Pn,n("p",null,[n("a",An,[s("(230条消息) redisTemplate.opsForValue()中方法讲解_Archie_java的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",Nn,[s("(230条消息) RedisTemplate使用最详解（一）--- opsForValue()_opsforvalue().set_学习中啊哈哈的博客-CSDN博客"),t(a)])]),Ln,n("p",null,[n("a",En,[s("(216条消息) Redis 基础 Jedis -- Jedis（Java程序操作Redis的工具）_CodeJiao的博客-CSDN博客"),t(a)])]),On,Qn,Un,Jn,n("p",null,[n("a",zn,[s("(216条消息) MongoDB数据库的常用命令_mongodb数据库命令_勤奋上进的兔子的博客-CSDN博客"),t(a)])]),Vn,n("p",null,[n("a",Fn,[s("(216条消息) 《SpringBoot篇》15.SpringBoot整合MongoDB超详细教程（包括安装教程）_springboot mongodb_陈老老老板的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",Wn,[s("全面学习MongoDB，在Spring Boot项目中整合 MongoDB-腾讯云开发者社区-腾讯云 (tencent.com)"),t(a)])]),Hn,n("p",null,[s("下载： "),n("a",Kn,[s("Download Elasticsearch | Elastic"),t(a)])]),n("p",null,[s("文档参考： "),n("a",Gn,[s("(217条消息) ElasticSearch使用教程、设计到实战_ForFuture Code的博客-CSDN博客"),t(a)])]),Yn,n("p",null,[n("a",Xn,[s("(218条消息) 【SpringBoot整合缓存】-----Redis缓存篇_springboot redis缓存_潮浪之巅的博客-CSDN博客"),t(a)]),s(),n("a",$n,[s("(218条消息) 【JetCache】JetCache的使用方法与步骤_No8g攻城狮的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",Zn,[s("J2Cache: Java 两级缓存框架，可以让应用支持两级缓存框架 ehcache(Caffeine) + redis 。避免完全使用独立缓存系统所带来的网络IO开销问题 (gitee.com)"),t(a)])]),ns,n("p",null,[n("a",ss,[s("(228条消息) JWT的组成_Jint001的博客-CSDN博客"),t(a)])]),as,n("p",null,[n("a",ts,[s("(228条消息) 使用springBoot实现token校验_springboot 校验token_秃头小陈~的博客-CSDN博客"),t(a)])]),es,n("p",null,[s("参考文档： "),n("a",ps,[s("Docker安装部署RabbitMQ - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",is,[s("超详细的RabbitMQ入门"),t(a)])]),n("p",null,[n("a",os,[s("RabbitMQ详解之你要的RabbitMQ这里都有_adobehu的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",cs,[s("01-今日课程介绍_哔哩哔哩_bilibili"),t(a)])]),ls,n("p",null,[n("a",us,[s("http://127.0.0.1:15672"),t(a)]),s(" （使用服务器的 ip 地址） 打开RabbitMQ的管理页面（使用设置的用户名和密码可以登录进去）")]),rs,n("h4",ds,[ks,s(" 示例（ "),n("a",vs,[s("B站视频地址"),t(a)]),s(" ）")]),ms,n("p",null,[n("a",bs,[s("RabbitMQ交换机类型简述 "),t(a)])]),gs,hs,ys,n("p",null,[n("a",fs,[s("Thymeleaf基本使用_thymeleaf ui-CSDN博客"),t(a)])]),n("p",null,[n("a",ws,[s("Thymeleaf 教程 | 範宗雲 (fanlychie.github.io)"),t(a)])]),qs,Ss,xs,n("p",null,[n("a",_s,[s("整合thymeleaf 实现模板文件转word打印_springboot导出word纸张大小-CSDN博客"),t(a)])]),Is,n("p",null,[n("a",Bs,[s("《SpringBoot2.0 实战》系列-整合FlyingSaucer + thymeleaf 实现模板文件转pdf打印-CSDN博客"),t(a)])]),js,n("p",null,[n("a",Ts,[s("https://wwmj.lanzoue.com/iYBOx1a6cbab"),t(a)]),s(" 密码:guv2")]),Ms,n("p",null,[n("a",Rs,[s("告别繁琐：SpringBoot 拦截器与统一功能处理 (qq.com)"),t(a)])])])}const Ls=p(l,[["render",Cs],["__file","spring-boot.html.vue"]]);export{Ls as default};
