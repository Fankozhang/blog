...
<span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token string">&#39;download&#39;</span> <span class="token keyword">in</span> document<span class="token punctuation">.</span><span class="token function">createElement</span><span class="token punctuation">(</span><span class="token string">&#39;a&#39;</span><span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token punctuation">{</span> <span class="token comment">// 非IE下载</span>
  ...
  <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),h={href:"https://www.jianshu.com/p/b322c2d5d778",target:"_blank",rel:"noopener noreferrer"},f={href:"https://juejin.cn/post/6844903480704892942",target:"_blank",rel:"noopener noreferrer"},q=n("p",null,"对于其他的文件下载的内容可参考如下文章：",-1),x={href:"https://mp.weixin.qq.com/s/vZiP2ULrLRtqShDJ9u1n2A",target:"_blank",rel:"noopener noreferrer"},y=e(`<h3 id="根据url下载文件-并设置文件名" tabindex="-1"><a class="header-anchor" href="#根据url下载文件-并设置文件名" aria-hidden="true">#</a> 根据url下载文件，并设置文件名</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>            <span class="token function">downLoad</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a></h2><h3 id="自定义表单-表单生成器" tabindex="-1"><a class="header-anchor" href="#自定义表单-表单生成器" aria-hidden="true">#</a> 自定义表单（表单生成器）</h3>`,6),S={href:"https://juejin.cn/post/7065863860669906952",target:"_blank",rel:"noopener noreferrer"},E={href:"http://kcz66.gitee.io/k-form-design/#/README",target:"_blank",rel:"noopener noreferrer"},D=e(`<p>k-form-create使用</p><p>main.js</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>import { useAntd } from &#39;k-form-design/packages/core/useComponents&#39;
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>style</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>less<span class="token punctuation">&quot;</span></span> <span class="token attr-name">scoped</span><span class="token punctuation">&gt;</span></span><span class="token style"></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>style</span><span class="token punctuation">&gt;</span></span>
          ...
          &gt;
            ...
            &lt;/a-select-option&gt;
          &lt;/a-select&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="适配" tabindex="-1"><a class="header-anchor" href="#适配" aria-hidden="true">#</a> 适配</h2><h3 id="vue项目-两套路由-适配-pc端-移动端" tabindex="-1"><a class="header-anchor" href="#vue项目-两套路由-适配-pc端-移动端" aria-hidden="true">#</a> vue项目（两套路由）适配 pc端 移动端</h3><p>vue项目开发中，我们已经开发实现了pc端的网站开发，当想要实现移动端适配时，当时有两种适配的方法作为参考。</p><p>一种是通过媒体查询适配不同的分辨率显示不同的样式。</p><p>第二种是写两套路由，一套pc端路由，一套移动端路由，移动端页面适当移植pc端页面代码，修改部分样式，以达到手机端显示正常的样式和结构。通过js判断使用设备是pc端还是移动端，来匹配不同的路由，显示不同的页面。</p><p>最终采用的是第二种实现方案，。 因为使用第二种方法对PC端和移动端进行了区分。对于PC端和移动端的特殊样式可以做到更加适配。以下是对于判断设备是手机端还是pc端参考的文章。</p><p><strong>vue-判断设备是手机端还是pc端，进行两套页面样式的编写</strong></p>`,16),N={href:"https://blog.csdn.net/hh3167253066/article/details/120290307",target:"_blank",rel:"noopener noreferrer"},V=n("p",null,[n("strong",null,"vue项目PC端移动端适配方案")],-1),L={href:"https://blog.csdn.net/weixin_53876218/article/details/125225893",target:"_blank",rel:"noopener noreferrer"},R=e(`<h3 id="vue项目适配屏幕分辨率与屏幕的缩放适配" tabindex="-1"><a class="header-anchor" href="#vue项目适配屏幕分辨率与屏幕的缩放适配" aria-hidden="true">#</a> vue项目适配屏幕分辨率与屏幕的缩放适配</h3><p>修改initial-scale的数值，原值为1.0，根据屏幕显示调整。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;meta name=&quot;viewport&quot;
          content=&quot;width=device-width, user-scalable=no, initial-scale=0.28, maximum-scale=0.28, minimum-scale=0.28&quot;&gt;
    &lt;meta http-equiv=&quot;X-UA-Compatible&quot; content=&quot;ie=edge&quot;&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),F={href:"https://blog.csdn.net/weixin_44692055/article/details/127843876",target:"_blank",rel:"noopener noreferrer"},T=n("h3",{id:"pc端网站在手机模式下打开显示不全的问题",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#pc端网站在手机模式下打开显示不全的问题","aria-hidden":"true"},"#"),s(" PC端网站在手机模式下打开显示不全的问题")],-1),A={href:"https://blog.csdn.net/ddyy2695734664/article/details/113248509",target:"_blank",rel:"noopener noreferrer"},P=e(`<h3 id="屏幕适配分辨率-不随屏幕缩放比变化" tabindex="-1"><a class="header-anchor" href="#屏幕适配分辨率-不随屏幕缩放比变化" aria-hidden="true">#</a> 屏幕适配分辨率，不随屏幕缩放比变化</h3><p>utils/devicePixelRatio.js (复制后在app.vue的created生命周期调用)</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">DevicePixelRatio</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="postcss" tabindex="-1"><a class="header-anchor" href="#postcss" aria-hidden="true">#</a> postcss</h3><p><strong>使用postcss和相关插件时一定要注意包的版本的冲突</strong></p><p>npm install postcss postcss-loader -D</p>`,8),B={href:"https://juejin.cn/post/7062717813764390948",target:"_blank",rel:"noopener noreferrer"},O={href:"https://github.com/sexyHuang/postcss-px2vp",target:"_blank",rel:"noopener noreferrer"},$=n("h3",{id:"vue-使用postcss-pxtorem-实现自适应",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue-使用postcss-pxtorem-实现自适应","aria-hidden":"true"},"#"),s(" vue 使用postcss-pxtorem 实现自适应")],-1),U={href:"https://blog.csdn.net/Charissa2017/article/details/105420971",target:"_blank",rel:"noopener noreferrer"},Y=n("h3",{id:"vue-使用postcss-pxtorem-实现自适应-1",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue-使用postcss-pxtorem-实现自适应-1","aria-hidden":"true"},"#"),s(" vue 使用postcss-pxtorem 实现自适应")],-1),z={href:"https://juejin.cn/post/7052955004683943950",target:"_blank",rel:"noopener noreferrer"},I={href:"https://juejin.cn/post/7041826704574119966",target:"_blank",rel:"noopener noreferrer"},H=e(`<ul><li>postcss-pxtorem：将px转换为px</li><li>amfe-flexible：为html、body添加font-size，窗口调整时候重新设置font-size</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install amfe-flexible --save
npm install postcss-pxtorem --save-dev
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,2),K={href:"https://link.juejin.cn/?target=mailto%3Apostcss-pxtorem%405.1.1",target:"_blank",rel:"noopener noreferrer"},G=e(`<p>main.js引入</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>import &#39;amfe-flexible&#39;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="vue开发中出现loading-chunk-failed-踩坑纪实" tabindex="-1"><a class="header-anchor" href="#vue开发中出现loading-chunk-failed-踩坑纪实" aria-hidden="true">#</a> Vue开发中出现Loading Chunk Failed 踩坑纪实</h2><p>（出现这个错误会页面空白）</p>`,13),J={href:"https://juejin.cn/post/7080189425975558181",target:"_blank",rel:"noopener noreferrer"},M=n("h2",{id:"vue实现全屏滚动效果",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue实现全屏滚动效果","aria-hidden":"true"},"#"),s(" vue实现全屏滚动效果")],-1),W={href:"https://blog.csdn.net/weixin_41192489/article/details/111104443",target:"_blank",rel:"noopener noreferrer"},Q=e(`<h2 id="vue页面中的锚点跳转" tabindex="-1"><a class="header-anchor" href="#vue页面中的锚点跳转" aria-hidden="true">#</a> vue页面中的锚点跳转</h2><p>在vue项目中，页面中设置锚点，并在某一位置跳转到锚点位置</p><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>p</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>info-title<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>基本信息<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>p</span><span class="token punctuation">&gt;</span></span>        跳转到的地方 根据id跳转
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="git中上传时忽略文件-gitignore-配置" tabindex="-1"><a class="header-anchor" href="#git中上传时忽略文件-gitignore-配置" aria-hidden="true">#</a> git中上传时忽略文件 .gitignore 配置</h2><p>对于.gitignore的配置可参考如下的文章</p>`,8),Z={href:"https://blog.csdn.net/ThinkWon/article/details/101447866",target:"_blank",rel:"noopener noreferrer"},X={href:"https://juejin.cn/post/6998911250323390501",target:"_blank",rel:"noopener noreferrer"},nn=e(`<p>普通的vue文件的可参考如下配置：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>.DS_Store
node_modules/
dist/
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="百度地图根据地址解析坐标系" tabindex="-1"><a class="header-anchor" href="#百度地图根据地址解析坐标系" aria-hidden="true">#</a> 百度地图根据地址解析坐标系</h2>`,18),sn={href:"https://lbs.baidu.com/index.php?title=webapi/guide/webservice-geocoding",target:"_blank",rel:"noopener noreferrer"},an=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install --save vue-jsonp
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue的v-html解析富文本传来的表格不显示边线" tabindex="-1"><a class="header-anchor" href="#vue的v-html解析富文本传来的表格不显示边线" aria-hidden="true">#</a> vue的v-html解析富文本传来的表格不显示边线</h2>`,6),tn={href:"https://blog.csdn.net/xh1506101064/article/details/106675796",target:"_blank",rel:"noopener noreferrer"},en=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;div class=&quot;content-table&quot; v-html=&quot;abc&quot;&gt;&lt;/div&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,11);function pn(on,ln){const a=l("ExternalLinkIcon");return o(),i("div",null,[r,n("p",null,[n("a",d,[s("vsCode 代码片段 自动生成格式 (99cc.vip)"),t(a)])]),v,n("p",null,[n("a",k,[s("(206条消息) Vscode如何配置属于自己的ESlint_vscode eslint配置_·甘之如饴·的博客-CSDN博客"),t(a)])]),m,n("p",null,[n("a",b,[s("https://blog.csdn.net/qq_39606853/article/details/122192555"),t(a)])]),g,n("p",null,[s("对于blob可点击 "),n("a",h,[s("JS中的Blob对象 - 简书 (jianshu.com)"),t(a)])]),n("p",null,[n("a",f,[s("JavaScript 中 Blob 对象 - 掘金 (juejin.cn)"),t(a)]),s(" 文章查看")]),q,n("p",null,[n("a",x,[s("前端文件下载的正确打开方式 (qq.com)"),t(a)])]),y,n("p",null,[n("a",w,[s("你真的会用标签下载文件吗? (qq.com)"),t(a)])]),_,n("p",null,[s("验证不生效可参考文章 "),n("a",j,[s("https://www.jianshu.com/p/5ebd1bd9ecaf"),t(a)])]),C,n("p",null,[n("a",S,[s("vue拖拽表单生成器 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[s("适用ant design vue ( "),n("a",E,[s("KFormDesign (gitee.io)"),t(a)]),s(" )")]),D,n("p",null,[n("a",N,[s("(115条消息) vue-判断设备是手机端还是pc端，进行两套页面样式的编写_hh3167253066的博客-CSDN博客_vue判断手机端还是pc端"),t(a)])]),V,n("p",null,[n("a",L,[s("(115条消息) vue项目PC端移动端适配方案_coderDragon的博客-CSDN博客_vue项目pc端和移动端适配"),t(a)])]),R,n("p",null,[n("a",F,[s("(198条消息) vue项目适配屏幕分辨率与屏幕的缩放适配详细教程_vue 分辨率适配_汪小敏同学的博客-CSDN博客"),t(a)])]),T,n("p",null,[n("a",A,[s("(227条消息) PC端网站在手机模式下打开显示不全的问题_手机pc端口 显示不全面_大大大颖er的博客-CSDN博客"),t(a)])]),P,n("p",null,[n("a",B,[s("https://juejin.cn/post/7062717813764390948"),t(a)])]),n("p",null,[n("strong",null,[n("a",O,[s("postcss-px2vp"),t(a)])])]),$,n("p",null,[n("a",U,[s("(230条消息) vue-cli中使用postcss-px-to-viewport 将px转换成vw_px to vw_蒲公英芽的博客-CSDN博客"),t(a)])]),Y,n("p",null,[n("a",z,[s("https://juejin.cn/post/7052955004683943950"),t(a)])]),n("p",null,[n("a",I,[s("https://juejin.cn/post/7041826704574119966"),t(a)])]),H,n("p",null,[s("如果报错，则需要指定postcss-pxtorem版本，如： npm install "),n("a",K,[s("postcss-pxtorem@5.1.1"),t(a)]),s(" --save-dev")]),G,n("p",null,[n("a",J,[s("Vue开发中出现Loading Chunk Failed 踩坑纪实 - 掘金 (juejin.cn)"),t(a)])]),M,n("p",null,[s("查看以下博客 "),n("a",W,[s("(130条消息) vue全屏滚动——vue-fullpage.js教程_朝阳39的博客-CSDN博客_vue-fullpage"),t(a)])]),Q,n("p",null,[n("a",Z,[s("(132条消息) Git忽略文件.gitignore详解_ThinkWon的博客-CSDN博客_gitignore"),t(a)])]),n("p",null,[n("a",X,[s("Git入门之.gitignore - 掘金 (juejin.cn)"),t(a)])]),nn,n("p",null,[n("a",sn,[s("逆地理编码 gc | 百度地图API SDK (baidu.com)"),t(a)])]),an,n("p",null,[n("a",tn,[s("(210条消息) 更改v-html的样式_v-html 样式修改_oduoke~~的博客-CSDN博客"),t(a)])]),en])}const rn=p(u,[["render",pn],["__file","method.html.vue"]]);export{rn as default};
