...
restaurant.dataset.num = newNum;         //  设置自定义属性的值
    ...
    &lt;/style&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="ul-li-去除前面的黑点" tabindex="-1"><a class="header-anchor" href="#ul-li-去除前面的黑点" aria-hidden="true">#</a> ul li 去除前面的黑点</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>ul {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="相关技术文章" tabindex="-1"><a class="header-anchor" href="#相关技术文章" aria-hidden="true">#</a> 相关技术文章</h2>`,13),g={href:"https://mp.weixin.qq.com/s/xE1hz1DV961eMD0AvfwlgQ",target:"_blank",rel:"noopener noreferrer"};function k(b,h){const a=o("ExternalLinkIcon");return i(),p("div",null,[d,n("p",null,[n("a",u,[s("https://developer.mozilla.org/zh-CN/docs/Web/HTML/Element/audio"),t(a)])]),r,n("p",null,[n("a",v,[s("https://developer.mozilla.org/zh-CN/docs/Web/HTML/Element/video"),t(a)])]),m,n("p",null,[n("a",g,[s("分享24个强大的HTML属性，建议每位前端工程师都应该掌握！ (qq.com)"),t(a)])])])}const f=l(c,[["render",k],["__file","1.html.vue"]]);export{f as default};
