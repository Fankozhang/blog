...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="ant-design-vue-版本部署时-nginx-配置" tabindex="-1"><a class="header-anchor" href="#ant-design-vue-版本部署时-nginx-配置" aria-hidden="true">#</a> ant design vue 版本部署时 nginx 配置</h3>`,2),w={href:"https://docs.geekera.cn/RuoYi-Antdv/use.html#%E5%BC%80%E5%A7%8B%E4%BD%BF%E7%94%A8",target:"_blank",rel:"noopener noreferrer"},j=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>server {
	# 你的域名
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="ubuntu服务器部署nginx-静态页面" tabindex="-1"><a class="header-anchor" href="#ubuntu服务器部署nginx-静态页面" aria-hidden="true">#</a> ubuntu服务器部署nginx，静态页面</h2><h3 id="ubuntu安装nginx" tabindex="-1"><a class="header-anchor" href="#ubuntu安装nginx" aria-hidden="true">#</a> ubuntu安装nginx</h3>`,3),E={href:"https://developer.aliyun.com/article/759280",target:"_blank",rel:"noopener noreferrer"},q=i(`<h3 id="安装-nginx" tabindex="-1"><a class="header-anchor" href="#安装-nginx" aria-hidden="true">#</a> 安装 Nginx</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>sudo apt update
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="mysql安装" tabindex="-1"><a class="header-anchor" href="#mysql安装" aria-hidden="true">#</a> mysql安装</h3>`,2),M={href:"https://blog.csdn.net/cruiserblog/article/details/106934570",target:"_blank",rel:"noopener noreferrer"},N=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>sudo apt-get update  #更新源
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>navicat链接mysql 报错 2003，具体可能的问题如下：</p>`,16),T={href:"https://blog.csdn.net/weixin_49015210/article/details/117748687",target:"_blank",rel:"noopener noreferrer"},R=n("p",null,"如果还是链接不上navicat，按如下的文章再进行配置：主要关注 第 5 步 - 修改MySql远程连接配置，和第 6 步 - 打开防火墙",-1),L={href:"https://blog.csdn.net/u014378628/article/details/118406005",target:"_blank",rel:"noopener noreferrer"},F=n("p",null,'MySQL 错误2003 10060 "Unknown error" （以下方法顺利解决）',-1),P={href:"https://zhuanlan.zhihu.com/p/150861731#:~:text=%E5%9C%A8%E6%9C%AC%E6%9C%BA%E7%94%A8Na",target:"_blank",rel:"noopener noreferrer"},z=i(`<p>首先执行以下命令允许root用户远程连接,表示从任何主机连接到mysql服务器</p><p>请替换yourpasssword为你的数据库密码</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>GRANT ALL PRIVILEGES ON *.* TO &#39;root&#39;@&#39;%&#39; IDENTIFIED BY &#39;yourpassword&#39; WITH GRANT OPTION;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>刷新权限使操作生效</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>FLUSH PRIVILEGES;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>执行quit;退出数据库,执行以下命令打开防火墙端口3306</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>firewall-cmd --zone=public --add-port=3306/tcp --permanent
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>重启防火墙并查看是否生效</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>firewall-cmd --reload		#重启firewall
firewall-cmd --list-ports	#查看已经开放的端口
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>至此，我的navicat已经可以正常连上服务器的 mysql，正常导入数据，</p>`,10),O={href:"http://bing.com",target:"_blank",rel:"noopener noreferrer"},U={href:"https://cn.bing.com/search?pc=&q=centos%E5%AE%89%E8%A3%85",target:"_blank",rel:"noopener noreferrer"},H=n("h3",{id:"redis安装",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#redis安装","aria-hidden":"true"},"#"),e(" redis安装")],-1),J={href:"https://gblfy.blog.csdn.net/article/details/114371657",target:"_blank",rel:"noopener noreferrer"},$=i(`<h3 id="springboot打包成jar包" tabindex="-1"><a class="header-anchor" href="#springboot打包成jar包" aria-hidden="true">#</a> springBoot打包成jar包</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>打包之前修改 application 相关的配置
  ...
  编译打包
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 /usr/local/ruoyi 目录创建一个文件夹，将jar包放入 （文件夹位置可自定义）</p><p>nohup java -jar ruoyi-admin.jar</p><p><strong>nohup java -jar jar包名 &amp;</strong></p><p>Web server failed to start. Port 8080 was already in use.</p>`,6),W={href:"https://blog.csdn.net/AttleeTao/article/details/104149794",target:"_blank",rel:"noopener noreferrer"},V={href:"https://blog.csdn.net/u012995500/article/details/104494808",target:"_blank",rel:"noopener noreferrer"},Y={href:"https://blog.csdn.net/w_xiao_wang/article/details/106576231",target:"_blank",rel:"noopener noreferrer"},G=n("p",null,"查看jar包进程 ps aux|grep xxx.jar ps -ef | grep java 将会看到此jar的进程信息： root 2373 0.9 15.8 2575356 296448 pts/0 Sl+ 16:28 1:18 java -jar erp-0.5.1.2.jar 或 root 2373 2004 0 16:28 pts/0 00:01:18 java -jar erp-0.5.1.2.jar",-1),Q=n("p",null,"停止jar包 也就是杀死进程 找到jar的pid，杀掉命令为：",-1),K=n("p",null,"kill -9 pid pkill 进程名",-1),X=n("p",null,"部署后jar包运行MySQL连接报错，参照如下解决",-1),Z={href:"https://blog.csdn.net/g310773517/article/details/139472349",target:"_blank",rel:"noopener noreferrer"},nn={href:"https://blog.csdn.net/pcw89126/article/details/118662195",target:"_blank",rel:"noopener noreferrer"},en=n("h2",{id:"docker部署",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#docker部署","aria-hidden":"true"},"#"),e(" Docker部署")],-1),sn={href:"https://blog.csdn.net/weixin_46594796/article/details/133962200",target:"_blank",rel:"noopener noreferrer"},an=n("h3",{id:"docker-安装-nginx",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#docker-安装-nginx","aria-hidden":"true"},"#"),e(" docker 安装 nginx")],-1),tn={href:"https://blog.csdn.net/BThinker/article/details/123507820",target:"_blank",rel:"noopener noreferrer"},ln=i(`<h2 id="vue项目跨域配置" tabindex="-1"><a class="header-anchor" href="#vue项目跨域配置" aria-hidden="true">#</a> vue项目跨域配置</h2><p>我部署的一个springBoot+vue的项目，用nginx部署后，一直请求不到，困扰了很长时间，最后发现是vue项目配置跨域不对的问题。</p><p>vue.config.js 跨域配置参考如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 可用
  server: {
    port: 80,
    host: true,
    open: true,
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="minio" tabindex="-1"><a class="header-anchor" href="#minio" aria-hidden="true">#</a> Minio</h2><h3 id="linux-安装minio" tabindex="-1"><a class="header-anchor" href="#linux-安装minio" aria-hidden="true">#</a> linux 安装Minio</h3>`,15),rn={href:"https://www.minio.org.cn/docs/minio/linux/index.html",target:"_blank",rel:"noopener noreferrer"},dn=n("h3",{id:"docker-安装-实测可用",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#docker-安装-实测可用","aria-hidden":"true"},"#"),e(" docker 安装（实测可用）")],-1),on={href:"https://blog.csdn.net/BThinker/article/details/125412751",target:"_blank",rel:"noopener noreferrer"},cn=i('<p><strong>下载Minio镜像</strong></p><table><thead><tr><th style="text-align:left;">命令</th><th style="text-align:left;">描述</th></tr></thead><tbody><tr><td style="text-align:left;">docker pull minio/minio</td><td style="text-align:left;">下载最新版Minio镜像 (其实此命令就等同于 : docker pull minio/minio:latest )</td></tr><tr><td style="text-align:left;">docker pull minio/minio:RELEASE.2022-06-20T23-13-45Z.fips</td><td style="text-align:left;">下载指定版本的Minio镜像 (xxx指具体版本号)</td></tr></tbody></table>',2),pn={href:"https://so.csdn.net/so/search?q=Docker&spm=1001.2101.3001.7020",target:"_blank",rel:"noopener noreferrer"},un=i(`<p><strong>创建目录</strong></p><blockquote><p>一个用来存放配置，一个用来存储上传文件的目录</p><p>启动前需要先创建Minio外部挂载的配置文件（ /home/minio/config）,和存储上传文件的目录（ /home/minio/data）</p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mkdir -p /home/minio/config
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>9090端口指的是minio的客户端端口</p><p>MINIO_ACCESS_KEY ：账号</p><p>MINIO_SECRET_KEY ：密码（账号长度必须大于等于5，密码长度必须大于等于8位）</p><p><strong>访问</strong></p>`,12),vn={href:"http://127.0.0.1:9090/login",target:"_blank",rel:"noopener noreferrer"},mn={href:"https://blog.csdn.net/destin223/article/details/134110194#:~:text=%E8%AE%BF%E9%97%AE%E6%96%87%E4%BB%B6%E7%BD%91%E5%9D%80%E4%B8%BA%EF%BC%9Aip%3Aaddress%2Fbucket%E7%9A%84%E5%90%8D%E5%AD%97%2F%E6%96%87%E4%BB%B6%E7%9A%84%E5%90%8D%E5%AD%97%E3%80%82,2%E3%80%81%E8%BF%9B%E5%85%A5%E9%A1%B5%E9%9D%A2%E5%90%8E%EF%BC%8C%E9%85%8D%E7%BD%AE%E5%8F%AA%E8%AF%BB%E8%AE%BF%E9%97%AE%E6%9D%83%E9%99%90%EF%BC%8Cprefix%E6%8C%89%E7%85%A7%E6%8F%90%E7%A4%BA%E8%BE%93%E5%85%A5%E5%B0%B1%E5%A5%BD%E3%80%82",target:"_blank",rel:"noopener noreferrer"},bn=n("p",null,"bucket 的 Access Policy 设置为public可以直接浏览器访问",-1),hn=n("p",null,"在minio上传的文件以 ip:address/bucket的名字/文件的名字 路径来访问",-1),gn={href:"http://1.14.16.145:9000/test/MyLogo.jpg",target:"_blank",rel:"noopener noreferrer"},kn={href:"https://mp.weixin.qq.com/s/Ejz4RMt9m0nBgFFPGFtjrg",target:"_blank",rel:"noopener noreferrer"},_n=n("h2",{id:"自动化部署",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#自动化部署","aria-hidden":"true"},"#"),e(" 自动化部署")],-1),xn={href:"https://blog.csdn.net/weixin_43976226/article/details/133039035",target:"_blank",rel:"noopener noreferrer"},fn={href:"https://www.bilibili.com/video/BV1ds4y1k7QM/?spm_id_from=333.337.search-card.all.click&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},yn=n("h3",{id:"jenkens-docker安装",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#jenkens-docker安装","aria-hidden":"true"},"#"),e(" jenkens（docker安装）")],-1),wn={href:"https://developer.aliyun.com/article/892646",target:"_blank",rel:"noopener noreferrer"},jn={href:"https://blog.csdn.net/BThinker/article/details/124178670",target:"_blank",rel:"noopener noreferrer"},En={href:"https://www.bilibili.com/video/BV1Da411G7s4?p=1&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},qn=i(`<li><p>拉取镜像</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#查询镜像
...
网址访问 ip+端口号+&#39;/restart&#39;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>nginx 登录地址</p><p>服务器ip地址:8099</p><p>输入密码，安装插件（有些下载不了可以先不安装），创建账户，按照流程进行下一步的操作</p><p>重启后，进入操作界面</p></li>`,9),Sn=n("p",null,"中文插件配置",-1),An=n("p",null,[n("strong",null,"操作步骤：")],-1),Bn=n("li",null,"安装插件：Manage Jenkins -> Manage Plugins -> Available -> Filter 中输入 Locale -> 勾选后点击 Install without restart",-1),Dn=n("li",null,[e("设置中文：Manage Jenkins -> Configure System -> Default Language 中输入 "),n("code",null,"zh_CN"),e(" -> 勾选 Ignore browser preference and force this language to all users -> 点击 Save")],-1),Cn={href:"https://plugins.jenkins.io/maven-plugin",target:"_blank",rel:"noopener noreferrer"},In={href:"https://plugins.jenkins.io/publish-over-ssh",target:"_blank",rel:"noopener noreferrer"},Mn=n("h3",{id:"jenkins的基本配置与基本使用",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#jenkins的基本配置与基本使用","aria-hidden":"true"},"#"),e(" Jenkins的基本配置与基本使用")],-1),Nn={href:"https://juejin.cn/post/7101851443073646623#heading-28",target:"_blank",rel:"noopener noreferrer"},Tn=i(`<h4 id="docker安装maven" tabindex="-1"><a class="header-anchor" href="#docker安装maven" aria-hidden="true">#</a> docker安装maven</h4><p>选择安装maven的路径</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>cd /opt/software
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,3),Rn={href:"https://archive.apache.org/dist/maven/maven-3/3.6.3/binaries/",target:"_blank",rel:"noopener noreferrer"},Ln=i(`<p>下载完成后，解压Maven到 安装Maven的目录。 tar -zxvf apache-maven-3.6.3-bin.tar.gz</p><p>添加到全局环境变量：服务器输入命令 export PATH=/path/to/apache-maven-3.6.3/bin:$PATH</p><p><strong>配置settings.xml（可选）</strong> 此处使用了阿里云的Maven仓库</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token generics"><span class="token punctuation">&lt;</span>mirror<span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>使用maven需要有java的环境</strong></p><p>yum安装如下：</p><p>查询要安装jdk的版本</p>`,7),Fn=n("p",null,"命令：yum -y list java*",-1),Pn=n("h4",{id:"_1-2-安装jdk1-8",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1-2-安装jdk1-8","aria-hidden":"true"},"#"),e(" 1.2 安装jdk1.8")],-1),zn={href:"https://so.csdn.net/so/search?q=openjdk&spm=1001.2101.3001.7020",target:"_blank",rel:"noopener noreferrer"},On=n("h4",{id:"_1-3-查询jdk版本",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1-3-查询jdk版本","aria-hidden":"true"},"#"),e(" 1.3 查询jdk版本")],-1),Un={href:"https://so.csdn.net/so/search?q=version&spm=1001.2101.3001.7020",target:"_blank",rel:"noopener noreferrer"},Hn=n("p",null,"这样就安装成功了。 默认给安装到 usr/lib/jvm/",-1),Jn=n("p",null,[n("strong",null,"测试安装"),e(" mvn -version 正确输出")],-1),$n=n("h4",{id:"docker-安装-git",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#docker-安装-git","aria-hidden":"true"},"#"),e(" docker 安装 git")],-1),Wn={href:"https://blog.csdn.net/qq_38628046/article/details/123591295",target:"_blank",rel:"noopener noreferrer"},Vn=i('<p>yum install -y git</p><h2 id="线上文件路径" tabindex="-1"><a class="header-anchor" href="#线上文件路径" aria-hidden="true">#</a> 线上文件路径</h2><p>/home/mysql nginx minio</p><p>jar包 /usr/local/app</p><h2 id="宝塔" tabindex="-1"><a class="header-anchor" href="#宝塔" aria-hidden="true">#</a> 宝塔</h2><h3 id="linux安装" tabindex="-1"><a class="header-anchor" href="#linux安装" aria-hidden="true">#</a> linux安装</h3>',6),Yn={href:"https://www.bt.cn/new/download.html",target:"_blank",rel:"noopener noreferrer"},Gn=i(`<p>出现如下的提示，下载完成，下载完成后会生成账号密码，可以用于登录宝塔面板</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>=============注意：首次打开面板浏览器将提示不安全=================
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="安装问题" tabindex="-1"><a class="header-anchor" href="#安装问题" aria-hidden="true">#</a> 安装问题</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>检查面板是否运行正常，尝试执行命令重启宝塔：bt restart 如无返回报错说明宝塔正常
...
执行  bt 5   重置宝塔面板密码
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4);function Qn(Kn,Xn){const s=d("ExternalLinkIcon");return l(),r("div",null,[c,p,n("p",null,[e("1Panel : "),n("a",u,[e("在线安装 - 1Panel 文档"),a(s)])]),v,n("p",null,[n("a",m,[e("https://blog.csdn.net/daocaokafei/article/details/115364111"),a(s)])]),b,n("p",null,[n("a",h,[e("Springboot+Vue在开发和部署相关问题解决 (qq.com)"),a(s)])]),g,n("p",null,[n("a",k,[e("RuoYi-Vue 部署 Linux环境 若依前后端分离项目（jar包+nginx 单机版本）_ruoyi-vue 部署 linux环境 若依前后端分离项目(jar包+nginx 单机版本) 原创-CSDN博客"),a(s)])]),_,x,n("p",null,[n("a",f,[e("环境部署 | RuoYi"),a(s)])]),y,n("p",null,[n("a",w,[e("快速开始 | 极客文档 (geekera.cn)"),a(s)])]),j,n("p",null,[n("a",E,[e("如何在 Ubuntu 20.04 上安装 Nginx-阿里云开发者社区 (aliyun.com)"),a(s)])]),q,n("p",null,[n("a",S,[e("如何在 Ubuntu 20.04 上使用 UFW 来设置防火墙 - 知乎 (zhihu.com)"),a(s)])]),A,n("p",null,[n("a",B,[e("Ubuntu上使用nginx完成一个简单web网站_ubuntu在nginx搭建简单网页-CSDN博客"),a(s)])]),D,n("p",null,[e("安装的 "),n("a",C,[e("jdk"),a(s)]),e("1.8")]),I,n("p",null,[e("[在Ubuntu20.04上安装MySQL8.0及正确配置"),n("a",M,[e("已验证]_ubuntu 编译安装 mysql8.0.30-CSDN博客"),a(s)])]),N,n("p",null,[n("a",T,[e("05.navicat连接不上虚拟机内的mysql_navicat连接不上虚拟机的数据库-CSDN博客"),a(s)])]),R,n("p",null,[n("a",L,[e("【精选】Ubuntu 20.04 安装 MySQL 8.0 并且远程连接数据库(包括后续遇到的新坑)_synchronizing state of mysql.service with sysv ser_Nymph2333的博客-CSDN博客"),a(s)])]),F,n("p",null,[n("a",P,[e("https://zhuanlan.zhihu.com/p/150861731#:~:text=在本机用Na"),a(s)])]),z,n("p",null,[e("centos: [centos安装 mysql8.0 - 搜索 ("),n("a",O,[e("bing.com"),a(s)]),e(")]("),n("a",U,[e("https://cn.bing.com/search?pc=&q=centos安装"),a(s)]),e(" mysql8.0)")]),H,n("p",null,[n("a",J,[e("Redis-6.2.5 安装 Linux环境(单机)_redis6.2需要gcc什么般般-CSDN博客"),a(s)])]),$,n("p",null,[n("a",W,[e("Linux环境下运行jar包的几种方式（附详细案例）_linux执行jar包中的类-CSDN博客"),a(s)])]),n("p",null,[n("a",V,[e("Linux 和 windows 下解决端口占用问题（ Port was already in use）_port 10802was alread inuse-CSDN博客"),a(s)])]),n("p",null,[n("a",Y,[e("linux如何运行jar包、查看jar包进程、停止jar包_本地运行jar包,并查看线程-CSDN博客"),a(s)])]),G,Q,K,X,n("p",null,[n("a",Z,[e("https://blog.csdn.net/g310773517/article/details/139472349"),a(s)]),e(),n("a",nn,[e("https://blog.csdn.net/pcw89126/article/details/118662195"),a(s)])]),en,n("p",null,[n("a",sn,[e("Docker部署SpringBoot +Vue项目流程详解（含域名 + HTTPS）_docker部署vue的前端项目-CSDN博客"),a(s)])]),an,n("p",null,[e("实测可用："),n("a",tn,[e("https://blog.csdn.net/BThinker/article/details/123507820"),a(s)])]),ln,n("p",null,[n("a",rn,[e("MinIO对象存储 Linux — MinIO中文文档 | MinIO Linux中文文档"),a(s)])]),dn,n("p",null,[n("a",on,[e("Docker 搭建 Minio 容器 (完整详细版)_docker minio-CSDN博客"),a(s)])]),cn,n("p",null,[n("strong",null,[e("检查当前所有"),n("a",pn,[e("Docker"),a(s)]),e("下载的镜像")]),e(" docker images")]),un,n("p",null,[e("访问："),n("a",vn,[e("http://127.0.0.1:9090/login"),a(s)]),e(" 用户名：密码 minioadmin：minioadmin （自己设置的）")]),n("p",null,[n("a",mn,[e("minIO设置直接通过访问链接在浏览器中打开文件_minio直接访问文件-CSDN博客"),a(s)])]),bn,hn,n("p",null,[e("例子："),n("a",gn,[e("http://1.14.16.145:9000/test/MyLogo.jpg"),a(s)])]),n("p",null,[e("实测可用（java使用 minio）："),n("a",kn,[e("Docker 搭建 Minio 容器 (完整详细版) (qq.com)"),a(s)])]),_n,n("p",null,[n("a",xn,[e("Jenkins+Gitee+Docker+Ruoyi项目前后端分离部署-CSDN博客"),a(s)])]),n("p",null,[n("a",fn,[e("使用Docker版Jenkins搭建流水线_ 这个视频演示和我下载的jenkins版本差不多"),a(s)])]),yn,n("p",null,[n("a",wn,[e("使用 Docker 安装 Jenkins 并实现项目自动化部署-阿里云开发者社区 (aliyun.com)"),a(s)])]),n("p",null,[n("a",jn,[e("Docker 搭建 Jenkins 容器 (完整详细版)_docker jenkins-CSDN博客"),a(s)])]),n("p",null,[n("a",En,[e("自动化部署基础架构_哔哩哔哩_bilibili"),a(s)])]),n("ul",null,[qn,n("li",null,[Sn,An,n("ul",null,[Bn,Dn,n("li",null,[e("插件 "),n("a",Cn,[e("Maven Integration"),a(s)]),e(" maven构建工具 "),n("a",In,[e("Publish Over SSH"),a(s)]),e(" 上传工具")])])])]),Mn,n("p",null,[n("a",Nn,[e("Jenkins的四种安装部署方式以及Jenkins的基本配置与基本使用 - 掘金 (juejin.cn)"),a(s)])]),Tn,n("p",null,[e("下载想要版本的maven（.tar.gz），上传到服务器 "),n("a",Rn,[e("Index of /dist/maven/maven-3/3.6.3/binaries (apache.org)"),a(s)])]),Ln,n("blockquote",null,[Fn,Pn,n("blockquote",null,[n("p",null,[e("命令：yum install -y java-1.8.0-"),n("a",zn,[e("openjdk"),a(s)]),e(".x86_64")])]),On,n("blockquote",null,[n("p",null,[e("命令：java -"),n("a",Un,[e("version"),a(s)])])]),Hn]),Jn,$n,n("p",null,[n("a",Wn,[e("Java开发者在Linux环境安装各类开发工具汇总_java linux安装常用软件-CSDN博客"),a(s)])]),Vn,n("p",null,[n("a",Yn,[e("宝塔面板下载，免费全能的服务器运维软件 (bt.cn)"),a(s)])]),Gn])}const ee=t(o,[["render",Qn],["__file","bushu.html.vue"]]);export{ee as default};
