...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),v={href:"https://blog.csdn.net/Hi_Eleven/article/details/115858307",target:"_blank",rel:"noopener noreferrer"},k=n("h3",{id:"escook-request-miniprogram",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#escook-request-miniprogram","aria-hidden":"true"},"#"),s(),n("strong",null,"@escook/request-miniprogram")],-1),m={href:"https://www.npmjs.com/package/@escook/request-miniprogram?activeTab=readme",target:"_blank",rel:"noopener noreferrer"},b=e(`<p>因为小程序中无法使用axios，而原生的uni.request功能过于简单，所以下载加强版网络请求包：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i @escook/request-miniprogram -S    下载网络请求包
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上就是对uniapp小程序的分包操作，那么如何查看自己分包是否成功了呢，在微信开发者工具打开，点击详情，在基本信息页面可以看到本地代码，点开后就能查看自己的主包和分包信息了，如果包的大小还是大于2M的话，就需要继续优化了。</p><p><img src="`+u+'" alt="PackageAuniWechat" loading="lazy"></p>',29);function g(h,q){const a=l("ExternalLinkIcon");return i(),o("div",null,[d,n("p",null,[n("a",v,[s("( 对于封装微信小程序uni.request请求，支持自动携带token,可查看这篇文章"),t(a)])]),k,n("p",null,[n("a",m,[s("@escook/request-miniprogram - npm (npmjs.com)"),t(a)])]),b])}const y=p(r,[["render",g],["__file","dragonfruit.html.vue"]]);export{y as default};
