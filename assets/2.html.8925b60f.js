...
&lt;/style&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="文字溢出省略号" tabindex="-1"><a class="header-anchor" href="#文字溢出省略号" aria-hidden="true">#</a> <strong>文字溢出省略号</strong></h2><p>文字单行溢出:</p><p>overflow: hidden; // 溢出隐藏<br> text-overflow: ellipsis; // 溢出用省略号显示<br> white-space: nowrap; // 规定段落中的文本不进行换行</p><p>多行文字溢出:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>overflow: hidden;      // 溢出隐藏  
text-overflow: ellipsis;   // 溢出用省略号显示    
display:-webkit-box;     // 作为弹性伸缩盒子模型显示。    
-webkit-box-orient:vertical; // 设置伸缩盒子的子元素排列方式：从上到下垂直排列   
-webkit-line-clamp:3;    // 显示的行数   
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),S={href:"https://mp.weixin.qq.com/s/kt3gCLrXcVmiaVoHsvEvNg",target:"_blank",rel:"noopener noreferrer"},C={href:"https://hai.li/2017/03/08/css-multiline-overflow-ellipsis.html",target:"_blank",rel:"noopener noreferrer"},E=n("h2",{id:"文字竖着排列",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#文字竖着排列","aria-hidden":"true"},"#"),s(" 文字竖着排列")],-1),j={href:"https://blog.csdn.net/weixin_29731589/article/details/117890453#:~:text=css%E8%AE%BE%E7%BD%AE%E6%96%87%E5%AD%97%E7%AB%96%E7%9D%80%E6%8E%92%E5%88%97%E7%9A%84%E6%96%B9%E6%B3%95%EF%BC%9A1%E3%80%81writing-mode",target:"_blank",rel:"noopener noreferrer"},z=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>div { writing-mode: tb-rl; }
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="html文本自动换行" tabindex="-1"><a class="header-anchor" href="#html文本自动换行" aria-hidden="true">#</a> <strong>html文本自动换行</strong></h2><ul><li>word-wrap: break-word; ：当单词太长超出容器宽度时，强制换行，将单词拆分成多行显示。</li><li>white-space: pre-wrap; ：保留空白符，自动换行。</li></ul><p>div 文字自动换行</p><p>white-space:normal; word-break:break-word</p><h2 id="页面平滑滚动" tabindex="-1"><a class="header-anchor" href="#页面平滑滚动" aria-hidden="true">#</a> 页面平滑滚动</h2><p><code>scroll-behavior： smooth</code></p><h2 id="css变量" tabindex="-1"><a class="header-anchor" href="#css变量" aria-hidden="true">#</a> <strong>css变量</strong></h2><p><strong>CSS变量</strong>又称<strong>CSS自定义属性</strong>，通过在<code>css</code>中自定义属性<code>--var</code>与函数<code>var()</code>组成，<code>var()</code>用于引用自定义属性。谈到为何会在<code>CSS</code>中使用变量，以下使用一个示例讲述。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token operator">:</span>root <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,15),T={href:"https://www.jiangweishan.com/tool/clippy/",target:"_blank",rel:"noopener noreferrer"},B=n("h2",{id:"边框样式",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#边框样式","aria-hidden":"true"},"#"),s(" 边框样式")],-1),F={href:"https://blog.csdn.net/blbyu/article/details/128710565",target:"_blank",rel:"noopener noreferrer"},D=e(`<h2 id="css阴影" tabindex="-1"><a class="header-anchor" href="#css阴影" aria-hidden="true">#</a> css阴影</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>box-shadow: 10px 10px 5px #888888;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="css实现渐变色边框" tabindex="-1"><a class="header-anchor" href="#css实现渐变色边框" aria-hidden="true">#</a> css实现渐变色边框</h2>`,6),G={href:"https://juejin.cn/post/7017701121619656711",target:"_blank",rel:"noopener noreferrer"},Y=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> border-top: 3px solid #55BEFB;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),H={href:"https://mp.weixin.qq.com/s/sqCc5ERhFdE7rmdcwJcFEQ",target:"_blank",rel:"noopener noreferrer"},N=e(`<h3 id="渐变字体被text-shadow遮挡问题" tabindex="-1"><a class="header-anchor" href="#渐变字体被text-shadow遮挡问题" aria-hidden="true">#</a> <strong>渐变字体被text-shadow遮挡问题:</strong></h3><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code> <span class="token selector">.top-title</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul><h2 id="组件库样式修改的方式" tabindex="-1"><a class="header-anchor" href="#组件库样式修改的方式" aria-hidden="true">#</a> <strong>组件库样式修改的方式:</strong></h2><h4 id="样式穿透" tabindex="-1"><a class="header-anchor" href="#样式穿透" aria-hidden="true">#</a> 样式穿透</h4><p><code>vue</code>项目中，在修改<code>elementui</code>的样式时通常使用样式穿透，<code>style</code>使用<code>css</code>的预处理器(<code>less</code>, <code>sass</code>, <code>scss</code>)等， 即</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;style lang=&quot;less&quot; scoped&gt;
&lt;/style&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>主要的样式穿透如下：</p>`,9),ks={href:"https://juejin.cn/post/7413669480624357386#heading-3",target:"_blank",rel:"noopener noreferrer"},ms=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1. &gt;&gt;&gt;
...
5  Vue3的 :deep()伪类
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1),bs={href:"https://blog.csdn.net/Yukinoshita_kino/article/details/117259198",target:"_blank",rel:"noopener noreferrer"},gs=e(`<h4 id="使用样式穿透还是无效" tabindex="-1"><a class="header-anchor" href="#使用样式穿透还是无效" aria-hidden="true">#</a> 使用样式穿透还是无效</h4><p>有时会发现使用了以上方法修改 element 组件样式还是会不生效，对于这种情况可以重写一个style标签，在style标签里对需要穿透的样式进行修改</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;a-input class=&quot;search-out&quot; allow-clear /&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),hs={href:"https://blog.csdn.net/qq_42611074/article/details/120674761",target:"_blank",rel:"noopener noreferrer"},fs=e(`<p>不显示滚动条</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>::-webkit-scrollbar {
        width: 0px;
    }
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),xs={href:"https://www.php.cn/faq/477233.html",target:"_blank",rel:"noopener noreferrer"},ys=n("div",{class:"language-text line-numbers-mode","data-ext":"text"},[n("pre",{class:"language-text"},[n("code",null,`::-webkit-scrollbar {display:none}
`)]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"})])],-1),_s={href:"https://mp.weixin.qq.com/s/qiPO46N-wrYCfO9nHMdACw",target:"_blank",rel:"noopener noreferrer"},ws=e(`<h3 id="js实现滚动条不显示-vue2" tabindex="-1"><a class="header-anchor" href="#js实现滚动条不显示-vue2" aria-hidden="true">#</a> js实现滚动条不显示（vue2）</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>
有滚动条的div
<span class="token operator">&lt;</span>div   <span class="token keyword">class</span><span class="token operator">=</span><span class="token string">&quot;scroll-style-change&quot;</span>  ref<span class="token operator">=</span><span class="token string">&quot;scrollStyleChangeRef&quot;</span><span class="token operator">&gt;</span><span class="token operator">&lt;</span><span class="token operator">/</span>div<span class="token operator">&gt;</span>
...
<span class="token function">mounted</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">this</span><span class="token punctuation">.</span>$refs<span class="token punctuation">.</span>scrollStyleChangeRef<span class="token punctuation">.</span><span class="token function">appendChild</span><span class="token punctuation">(</span>style<span class="token punctuation">)</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
  <span class="token function">beforeDestroy</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token comment">// 清理动态添加的样式</span>
    <span class="token keyword">const</span> styleElements <span class="token operator">=</span> <span class="token keyword">this</span><span class="token punctuation">.</span>$refs<span class="token punctuation">.</span>scrollStyleChangeRef<span class="token punctuation">.</span><span class="token function">querySelectorAll</span><span class="token punctuation">(</span><span class="token string">&#39;style&#39;</span><span class="token punctuation">)</span>
    styleElements<span class="token punctuation">.</span><span class="token function">forEach</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">el</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> el<span class="token punctuation">.</span><span class="token function">remove</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue-项目引入animate-css" tabindex="-1"><a class="header-anchor" href="#vue-项目引入animate-css" aria-hidden="true">#</a> vue 项目引入animate.css</h2>`,3),qs={href:"https://animate.style/",target:"_blank",rel:"noopener noreferrer"},Ss=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install animate.css --save
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>编辑器格式报红：Unexpected missing generic font family</p>`,16),Cs={href:"https://blog.csdn.net/a1056244734/article/details/125783641",target:"_blank",rel:"noopener noreferrer"},Es=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>/* 一个字体族名和一个通用字体族名 */
font-family: &quot;Gill Sans Extrabold&quot;, sans-serif;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="阿里巴巴图标库" tabindex="-1"><a class="header-anchor" href="#阿里巴巴图标库" aria-hidden="true">#</a> 阿里巴巴图标库</h2>`,2),js={href:"https://www.iconfont.cn/?spm=a313x.7781069.1998910419.d4d0a486a",target:"_blank",rel:"noopener noreferrer"},zs=e(`<p>**推荐使用svg引入，能够保全图标的颜色，但svg兼容性不如另外的引入方式。**使用另两种可能图标颜色失效。（Unicode 引用和font class 引入的 iconfont 基础样式一定要有，否则不生效）每次增加或删除图标时，记得及时更新css代码</p><h3 id="unicode-引用" tabindex="-1"><a class="header-anchor" href="#unicode-引用" aria-hidden="true">#</a> Unicode 引用</h3><p>复制代码到 iconfont.css 文件，加入icontfont 类样式，否则图标显示不出来 index页面引入</p><p>css代码内要补齐路径的协议名，否则可能不生效，类似</p><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token atrule"><span class="token rule">@font-face</span></span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="实现页脚始终在页面底部" tabindex="-1"><a class="header-anchor" href="#实现页脚始终在页面底部" aria-hidden="true">#</a> 实现页脚始终在页面底部</h2>`,39),Ts={href:"https://www.jb51.net/css/838364.html",target:"_blank",rel:"noopener noreferrer"},Bs=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;div class=&quot;all-container&quot;&gt;
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">&gt;</span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,14);function Ps(As,Vs){const a=c("ExternalLinkIcon");return l(),o("div",null,[p(`
 ...
 * @param: 
 * @return: 
`),r,p(" icon: edit "),d,n("p",null,[n("a",v,[s("Grid网格布局实例 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",k,[s("CSS Grid 网格布局教程 - 阮一峰的网络日志 (ruanyifeng.com)"),t(a)])]),n("p",null,[s("grid布局调试：["),n("a",m,[s("CSS Grid Generator (cssgrid-generator.netlify.app)"),t(a)])]),n("p",null,[n("a",b,[s("grid - CSS：层叠样式表 | MDN (mozilla.org)"),t(a)])]),n("p",null,[n("a",g,[s("CSS 网格布局 | 菜鸟教程 (runoob.com)"),t(a)])]),h,n("p",null,[s("毛玻璃生成网站"),n("a",f,[s("Glassmorphism CSS Generator | SquarePlanet | SquarePlanet (hype4.academy)"),t(a)])]),x,n("p",null,[n("a",y,[s("Clippy — CSS clip-path 生成器 (jiangweishan.com)"),t(a)])]),_,n("p",null,[n("a",w,[s("https://wweb.dev/resources/animated-css-background-generator"),t(a)])]),q,n("p",null,[n("a",S,[s("JS如何判断文字被ellipsis了？ 微信公众平台 (qq.com)"),t(a)])]),n("p",null,[s("CSS定制多行省略:"),n("a",C,[s("https://hai.li/2017/03/08/css-multiline-overflow-ellipsis.html"),t(a)])]),E,n("p",null,[s("[html div文字竖向显示,css怎么让文字竖着？-CSDN博客]("),n("a",j,[s("https://blog.csdn.net/weixin_29731589/article/details/117890453#:~:text=css设置文字竖着排列的方法：1、writing-mode"),t(a)]),s(" (设置对象书写方向)语法：writing-mode,%3A lr-tb、tb-rl参数：lr-tb：从左向右，从上往下 　tb-rl：从上往下，从右向左示例：css代码：di..._div文字竖排)")]),z,n("p",null,[s("CSS clip-path 生成器(多边形) "),n("a",T,[s("Clippy — CSS clip-path 生成器 (jiangweishan.com)"),t(a)])]),B,n("p",null,[n("a",F,[s("CSS给元素添加边框（样式、颜色、宽度）_css加边框-CSDN博客"),t(a)])]),D,n("p",null,[n("a",G,[s("https://juejin.cn/post/7017701121619656711"),t(a)])]),Y,n("p",null,[n("a",H,[s("CSS 两行文字两端对齐与字符间距的处理 (qq.com)"),t(a)])]),N,n("table",null,[n("thead",null,[n("tr",null,[n("th",null,[n("a",P,[s("transition"),t(a)])]),A,V])]),n("tbody",null,[n("tr",null,[n("td",null,[n("a",X,[s("transition-property"),t(a)])]),U,L]),n("tr",null,[n("td",null,[n("a",O,[s("transition-duration"),t(a)])]),I,R]),n("tr",null,[n("td",null,[n("a",$,[s("transition-timing-function"),t(a)])]),M,W]),n("tr",null,[n("td",null,[n("a",J,[s("transition-delay"),t(a)])]),Q,Z])])]),K,n("table",null,[nn,n("tbody",null,[n("tr",null,[n("td",sn,[n("a",an,[s("@keyframes"),t(a)])]),tn,en]),n("tr",null,[n("td",pn,[n("a",ln,[s("animation"),t(a)])]),on,cn]),n("tr",null,[n("td",un,[n("a",rn,[s("animation-name"),t(a)])]),dn,vn]),n("tr",null,[n("td",kn,[n("a",mn,[s("animation-duration"),t(a)])]),bn,gn]),n("tr",null,[n("td",hn,[n("a",fn,[s("animation-timing-function"),t(a)])]),xn,yn]),n("tr",null,[n("td",_n,[n("a",wn,[s("animation-fill-mode"),t(a)])]),qn,Sn]),n("tr",null,[n("td",Cn,[n("a",En,[s("animation-delay"),t(a)])]),jn,zn]),n("tr",null,[n("td",Tn,[n("a",Bn,[s("animation-iteration-count"),t(a)])]),Fn,Dn]),n("tr",null,[n("td",Gn,[n("a",Yn,[s("animation-direction"),t(a)])]),Hn,Nn]),n("tr",null,[n("td",Pn,[n("a",An,[s("animation-play-state"),t(a)])]),Vn,Xn])])]),Un,n("table",null,[Ln,n("tbody",null,[On,n("tr",null,[In,Rn,n("td",$n,[n("a",Mn,[s("测试"),t(a)])])]),n("tr",null,[Wn,Jn,n("td",Qn,[n("a",Zn,[s("测试"),t(a)])])]),n("tr",null,[Kn,ns,n("td",ss,[n("a",as,[s("测试"),t(a)])])]),n("tr",null,[ts,es,n("td",ps,[n("a",is,[s("测试"),t(a)])])]),n("tr",null,[ls,os,n("td",cs,[n("a",us,[s("测试"),t(a)])])]),rs,ds])]),vs,n("p",null,[s("参考："),n("a",ks,[s("【大前端】搞懂＞＞＞、/deep/、::v-deep、::v-deep()和:deep()的区别与用法在Vue项目中，尤 - 掘金 (juejin.cn)"),t(a)])]),ms,n("p",null,[n("a",bs,[s("the ＞＞＞ and /deep/ combinators have been deprecated. Use :deep() instead终端报该警告的解决办法_霜雪遥的博客-CSDN博客"),t(a)]),s(" (警告不影响正常运行)")]),gs,n("p",null,[n("a",hs,[s("css-滚动但不显示滚动条的两种写法_css不显示滚动条但可以滚动_永远不会太晚的博客-CSDN博客"),t(a)])]),fs,n("p",null,[n("a",xs,[s("https://www.php.cn/faq/477233.html"),t(a)])]),ys,n("p",null,[n("a",_s,[s("裁剪的3种方式，CSS 如何隐藏移动端的滚动条？ (qq.com)"),t(a)])]),ws,n("p",null,[n("a",qs,[s("Animate.css | A cross-browser library of CSS animations."),t(a)])]),Ss,n("p",null,[s("解决： "),n("a",Cs,[s("stylelint检查报错：Unexpected missing generic font family font-family-no-missing-generic-family-keyword-CSDN博客"),t(a)])]),Es,n("p",null,[n("a",js,[s("iconfont-阿里巴巴矢量图标库"),t(a)])]),zs,n("p",null,[n("a",Ts,[s("css让页脚保持在底部位置的四种方案_CSS教程_CSS_网页制作_脚本之家 (jb51.net)"),t(a)])]),Bs,n("p",null,[n("a",Fs,[s("css实现聊天对话框 - 掘金 (juejin.cn)"),t(a)])]),Ds,n("p",null,[n("a",Gs,[s("Vue3 实现最近很火的酷炫功能：卡片悬浮发光 (qq.com) 实测可用，若没有使用ts，需要删除类型相关代码"),t(a)])]),Ys,n("p",null,[n("a",Hs,[s("为什么ChatGPT采用SSE协议而不是Websocket？ (qq.com)"),t(a)])]),Ns])}const Ls=i(u,[["render",Ps],["__file","2.html.vue"]]);export{Ls as default};
