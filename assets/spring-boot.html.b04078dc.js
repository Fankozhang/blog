...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="表现层开发" tabindex="-1"><a class="header-anchor" href="#表现层开发" aria-hidden="true">#</a> 表现层开发</h3><p>​ 基于Restful进行表现层接口开发 ​ 使用Postman测试表现层接口功能</p><p>1.基于Restfu1制作表现层接口 新增：POST 删除：DELETE 修改：PUT 查询：GET 2.接收参数 实体数据：@RequestBody 路径变量：@PathVariable</p>`,92),S={href:"https://blog.csdn.net/CJPSR/article/details/131094717",target:"_blank",rel:"noopener noreferrer"},x=e(`<p>controller/BookController restful接口</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@RestController</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ProjectExceptionAdvice</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="打包" tabindex="-1"><a class="header-anchor" href="#打包" aria-hidden="true">#</a> 打包</h2><p>打开maven面板， 先clean,在点击package打包（点击 Toggle &#39;Skip Tests&#39;Mode 跳过测试过程，提示不安全）</p><p>（MAVEN:打包报错 Failed to execute goal org.apache.maven.plugins:maven-compiler-plugin:3.1:compile）</p>`,16),_={href:"https://blog.csdn.net/Int_Xu/article/details/108184768",target:"_blank",rel:"noopener noreferrer"},I=e(`<p>修改pom.xml （配置和版本如下）</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;build&gt;
		&lt;plugins&gt;
			&lt;plugin&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="内置持久化解决方案一一jdbctemplate" tabindex="-1"><a class="header-anchor" href="#内置持久化解决方案一一jdbctemplate" aria-hidden="true">#</a> 内置持久化解决方案一一JdbcTemplate</h3>`,7),hn={href:"https://www.imooc.com/article/46879",target:"_blank",rel:"noopener noreferrer"},yn=e('<h3 id="内嵌数据库" tabindex="-1"><a class="header-anchor" href="#内嵌数据库" aria-hidden="true">#</a> 内嵌数据库</h3><p>SpringBoot提供了3种内嵌数据库供开发者选择，提高开发测试效率 H2，HSQL，Derby</p><h3 id="nosql-redis-mongo" tabindex="-1"><a class="header-anchor" href="#nosql-redis-mongo" aria-hidden="true">#</a> NoSQL（redis,mongo）</h3><p>市面上常见的NoSQL解决方案 Redis，Mongo，ES</p><h3 id="redis" tabindex="-1"><a class="header-anchor" href="#redis" aria-hidden="true">#</a> Redis</h3><p>Redis是一款key-value存储结构的内存级NoSQL数据库 支持多种数据存储格式 支持持久化 支持集群</p>',6),fn={href:"https://www.bilibili.com/video/BV1CL411778r?p=1&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},wn={href:"https://juejin.cn/post/7103413121108148231?searchId=2023072217271551246D108BFEAC7A75B5",target:"_blank",rel:"noopener noreferrer"},qn={href:"https://juejin.cn/post/7225596319447187515?searchId=2023072217271551246D108BFEAC7A75B5#heading-18",target:"_blank",rel:"noopener noreferrer"},Sn={href:"https://juejin.cn/post/7083793185142505503?searchId=20230722175214B26171A4359A33735BBA",target:"_blank",rel:"noopener noreferrer"},xn=n("em",null,"redis可视化工具",-1),_n={href:"https://gitee.com/qishibo/AnotherRedisDesktopManager/releases",target:"_blank",rel:"noopener noreferrer"},In=n("h5",{id:"springboot整合redis客户端",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#springboot整合redis客户端","aria-hidden":"true"},"#"),s(),n("strong",null,"springBoot整合redis"),s("客户端")],-1),Bn={href:"https://blog.csdn.net/lwj_07/article/details/126265935",target:"_blank",rel:"noopener noreferrer"},Tn={href:"https://blog.csdn.net/weixin_59654772/article/details/125692784",target:"_blank",rel:"noopener noreferrer"},jn={href:"https://juejin.cn/post/7076244567569203208#heading-7",target:"_blank",rel:"noopener noreferrer"},Mn=e(`<p>依赖：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>        &lt;dependency&gt;
            &lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="redistemplate自定义配置及序列化" tabindex="-1"><a class="header-anchor" href="#redistemplate自定义配置及序列化" aria-hidden="true">#</a> RedisTemplate自定义配置及序列化</h5>`,11),Cn={href:"https://blog.csdn.net/Good_omen/article/details/123993468",target:"_blank",rel:"noopener noreferrer"},Rn={href:"https://blog.csdn.net/qq_58772217/article/details/128799831",target:"_blank",rel:"noopener noreferrer"},Dn={href:"https://blog.csdn.net/qq_51033936/article/details/127022985",target:"_blank",rel:"noopener noreferrer"},Pn=e(`<div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@Configuration</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="redistemplate常用方法" tabindex="-1"><a class="header-anchor" href="#redistemplate常用方法" aria-hidden="true">#</a> RedisTemplate常用方法</h5>`,2),On={href:"https://blog.csdn.net/zzvar/article/details/118388897",target:"_blank",rel:"noopener noreferrer"},Nn={href:"https://juejin.cn/post/7175756564752990267#heading-48",target:"_blank",rel:"noopener noreferrer"},Ln=n("h5",{id:"redistemplate-opsforvalue-方法",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#redistemplate-opsforvalue-方法","aria-hidden":"true"},"#"),s(" redisTemplate.opsForValue()方法")],-1),Qn={href:"https://blog.csdn.net/qq_43842093/article/details/121527498",target:"_blank",rel:"noopener noreferrer"},Un={href:"https://blog.csdn.net/weixin_43658899/article/details/121062760",target:"_blank",rel:"noopener noreferrer"},zn=e(`<h5 id="redis使用-手机号获取验证码" tabindex="-1"><a class="header-anchor" href="#redis使用-手机号获取验证码" aria-hidden="true">#</a> redis使用（手机号获取验证码）</h5><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token comment">// redis测试</span>
...
<span class="token punctuation">}</span>
	...
	<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testProductQueue</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
		...
		<span class="token punctuation">}</span>
	<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="jedis" tabindex="-1"><a class="header-anchor" href="#jedis" aria-hidden="true">#</a> jedis</h5>`,13),Fn={href:"https://blog.csdn.net/I_r_o_n_M_a_n/article/details/122685882",target:"_blank",rel:"noopener noreferrer"},Jn=n("p",null,"lettcus与jedis区别 jedis连接Redis.服务器是直连模式，当多线程模式下使用jedis会存在线程安全问题，解决方案可以通过配置连接池使每个连接专用，这样整体性能就大受影响。 lettcus基于Netty框架进行与Redis服务器连接，底层设计中采用StatefulRedisConnection。StatefulRedisConnection自身是线程安全的，可以保障并发访问安全问题，所以一个连接可以被多线程复用。当然lettcus也支持多连接实例一起工作。",-1),Vn=n("h4",{id:"mongodb",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#mongodb","aria-hidden":"true"},"#"),s(" MongoDB")],-1),Wn=n("p",null,"MongoDB是一个开源、高性能、无模式的文档型数据库。NoSQL数据库产品中的一种，是最像关系型数据库的非 关系型数据库",-1),Hn=n("p",null,"MongoDB数据库的常用命令",-1),Kn={href:"https://blog.csdn.net/qq_55648724/article/details/128171457",target:"_blank",rel:"noopener noreferrer"},Gn=n("p",null,"springBoot整合 mongoDB",-1),Yn={href:"https://blog.csdn.net/weixin_47343544/article/details/127175205",target:"_blank",rel:"noopener noreferrer"},Xn={href:"https://cloud.tencent.com/developer/article/2245018",target:"_blank",rel:"noopener noreferrer"},$n=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;!-- 引入mongodb--&gt;
        &lt;dependency&gt;
            &lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在不影响方法执行的情况下更新缓存时用CachePut</p><p>@CachePut(value=&quot;cacheSpace&quot;,key=&quot;#id&quot;)</p><p>不推荐将 @Cacheable 和 @CachePut 注解到同一个方法。</p><p>整合其他的缓存技术</p>`,28),as={href:"https://blog.csdn.net/Learning_xzj/article/details/125510872",target:"_blank",rel:"noopener noreferrer"},ts={href:"https://blog.csdn.net/weixin_44299027/article/details/125559446",target:"_blank",rel:"noopener noreferrer"},es={href:"https://gitee.com/ld/J2Cache",target:"_blank",rel:"noopener noreferrer"},ps=e(`<h2 id="任务" tabindex="-1"><a class="header-anchor" href="#任务" aria-hidden="true">#</a> 任务</h2><h3 id="定时任务" tabindex="-1"><a class="header-anchor" href="#定时任务" aria-hidden="true">#</a> 定时任务</h3><p>市面上流行的定时任务技术：Quartz ，Spring Task</p><p>springboot整合Quartz</p><p>相关概念： 工作（job):用于定义具体执行的工作 工作明细（JobDetail):用于描述定时工作相关的信息 触发器(Trigger):用于描述触发工作的规则，通常使用cron表达式定义调度规则 调度器(Scheduler):描述了工作明细与触发器的对应关系</p><h2 id="springboot-项目常用maven配置" tabindex="-1"><a class="header-anchor" href="#springboot-项目常用maven配置" aria-hidden="true">#</a> springBoot 项目常用maven配置</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;
...
reggie:
  #  指定上传文件暂存的位置
  path: D:\\img\\
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="jwt" tabindex="-1"><a class="header-anchor" href="#jwt" aria-hidden="true">#</a> JWT</h2><p>什么是JWT? JSON Web Token,通过数字签名的方式，以JSQN对象为载体，在不同的服务终端之间安全的传输信息。 JWT有什么用？ JW工最常见的场景就是授权认证，一旦用户登录，后续每个请求都将包含JWT，系统在每次处理用户请求的之前，都要先进行JWT安全校验，通过之后再进行处理。 JWT的组成 JWT由3部分组成，用拼接</p>`,11),is={href:"https://blog.csdn.net/qq_44972847/article/details/109249604",target:"_blank",rel:"noopener noreferrer"},os=e(`<ul><li>头部(header)</li><li>载荷(payload)</li><li>签证(signature)</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> &lt;dependency&gt;
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="登录" tabindex="-1"><a class="header-anchor" href="#登录" aria-hidden="true">#</a> 登录</h2><h3 id="工具类-jwtutil" tabindex="-1"><a class="header-anchor" href="#工具类-jwtutil" aria-hidden="true">#</a> <strong>工具类</strong> JwtUtil</h3>`,6),cs={href:"https://blog.csdn.net/qq_51553982/article/details/122778454",target:"_blank",rel:"noopener noreferrer"},ls=e(`<div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token comment">//  工具类</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),us={href:"https://blog.csdn.net/qq_41450736/article/details/113523308",target:"_blank",rel:"noopener noreferrer"},rs=n("h2",{id:"rabbitmq",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#rabbitmq","aria-hidden":"true"},"#"),s(" RabbitMQ")],-1),ds={href:"https://juejin.cn/post/7198430801850105916",target:"_blank",rel:"noopener noreferrer"},ks={href:"https://developer.aliyun.com/article/769883",target:"_blank",rel:"noopener noreferrer"},vs={href:"https://blog.csdn.net/huzecom/article/details/103499692",target:"_blank",rel:"noopener noreferrer"},ms={href:"https://www.bilibili.com/video/BV1Xm4y1i7HP?p=1&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},bs=e(`<h3 id="docker安装rabbitmq" tabindex="-1"><a class="header-anchor" href="#docker安装rabbitmq" aria-hidden="true">#</a> docker安装RabbitMQ</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker pull rabbitmq:management
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li><code>15672</code>端口：RabbitMQ的<strong>管理页面</strong>端口</li><li><code>5672</code>端口：RabbitMQ的<strong>消息接收</strong>端口</li><li><code>RABBITMQ_DEFAULT_USER</code>环境变量：指定RabbitMQ的<strong>用户名</strong>，这里我指定为<code>fankozhang</code>，大家部署时替换成自己定义的</li><li><code>RABBITMQ_DEFAULT_PASS</code>环境变量：指定RabbitMQ的<strong>密码</strong>，这里我指定为<code>123456</code>，大家部署时替换成自己定义的</li></ul><p>这样容器就部署完成了！在浏览器访问你的<code>服务器地址:15672</code>即可访问到RabbitMQ的管理界面，用户名和密码即为刚刚指定的环境变量的配置值。</p>`,6),gs={href:"http://127.0.0.1:15672",target:"_blank",rel:"noopener noreferrer"},hs=e("<p>RabbitMQ的组成，它是有这几部分：</p><ul><li>Broker：消息队列服务进程。此进程包括两个部分：Exchange和Queue。</li><li>Exchange：消息队列交换机。<strong>按一定的规则将消息路由转发到某个队列</strong>。</li><li>Queue：消息队列，存储消息的队列。</li><li>Producer：消息生产者。生产方客户端将消息同交换机路由发送到队列中。</li><li>Consumer：消息消费者。消费队列中存储的消息。</li></ul><p>这些组成部分是如何协同工作的呢，大概的流程如下</p><ul><li>消息生产者连接到RabbitMQ Broker，创建connection，开启channel。</li><li>生产者声明交换机类型、名称、是否持久化等。</li><li>生产者发送消息，并指定消息是否持久化等属性和routing key。</li><li>exchange收到消息之后，<strong>根据routing key路由到跟当前交换机绑定的相匹配的队列</strong>里面。</li><li>消费者监听接收到消息之后开始业务处理。</li></ul>",4),ys={id:"示例-b站视频地址",tabindex:"-1"},fs=n("a",{class:"header-anchor",href:"#示例-b站视频地址","aria-hidden":"true"},"#",-1),ws={href:"https://www.bilibili.com/video/BV1Am4y1z7Tu?p=1&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},qs=e(`<p>创建生产者</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@SpringBootApplication</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="rabbitmq交换机类型" tabindex="-1"><a class="header-anchor" href="#rabbitmq交换机类型" aria-hidden="true">#</a> RabbitMQ交换机类型</h3>`,5),Ss={href:"https://www.cnblogs.com/hsiang/p/14747030.html",target:"_blank",rel:"noopener noreferrer"},xs=n("p",null,"RabbitMQ一共四种交换机，如下所示：",-1),_s=n("ol",null,[n("li",null,"Direct Exchange：直连交换机，根据Routing Key(路由键)进行投递到不同队列。"),n("li",null,"Fanout Exchange：扇形交换机，采用广播模式，根据绑定的交换机，路由到与之对应的所有队列。"),n("li",null,"Topic Exchange：主题交换机，对路由键进行模式匹配后进行投递，符号#表示一个或多个词，*表示一个词。"),n("li",null,"Header Exchange：头交换机，不处理路由键。而是根据发送的消息内容中的headers属性进行匹配。")],-1),Is=n("h2",{id:"模板引擎-thymeleaf",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#模板引擎-thymeleaf","aria-hidden":"true"},"#"),s(" 模板引擎（thymeleaf）")],-1),Bs={href:"https://blog.csdn.net/Lzy410992/article/details/115371017",target:"_blank",rel:"noopener noreferrer"},Ts={href:"https://fanlychie.github.io/post/thymeleaf.html",target:"_blank",rel:"noopener noreferrer"},js=e(`<p>依赖</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
			&lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;
			&lt;artifactId&gt;spring-boot-starter-thymeleaf&lt;/artifactId&gt;
		&lt;/dependency&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="实践" tabindex="-1"><a class="header-anchor" href="#实践" aria-hidden="true">#</a> 实践：</h3>`,3),Ms=n("p",null,[s('resources/template/index.html (资源里面新建 index.html 文件) th:text="'),n("span",{class:"katex"},[n("span",{class:"katex-mathml"},[n("math",{xmlns:"http://www.w3.org/1998/Math/MathML"},[n("semantics",null,[n("mrow",null,[n("mrow",null,[n("mi",null,"m"),n("mi",null,"s"),n("mi",null,"g")]),n("mi",{mathvariant:"normal"},'"'),n("mtext",null,"的")]),n("annotation",{encoding:"application/x-tex"},'{msg}"的')])])]),n("span",{class:"katex-html","aria-hidden":"true"},[n("span",{class:"base"},[n("span",{class:"strut",style:{height:"0.8889em","vertical-align":"-0.1944em"}}),n("span",{class:"mord"},[n("span",{class:"mord mathnormal"},"m"),n("span",{class:"mord mathnormal"},"s"),n("span",{class:"mord mathnormal",style:{"margin-right":"0.03588em"}},"g")]),n("span",{class:"mord"},'"'),n("span",{class:"mord cjk_fallback"},"的")])])]),s("msg 是thymeleaf占位符语法")],-1),Cs=e(`<div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">&gt;</span></span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> thymeController <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>输入网页地址，可以看到 msg 为 欢迎使用 thymeleaf 展示在 html 中</p><h3 id="整合thymeleaf-实现模板文件转word打印" tabindex="-1"><a class="header-anchor" href="#整合thymeleaf-实现模板文件转word打印" aria-hidden="true">#</a> 整合thymeleaf 实现模板文件转word打印</h3>`,5),Rs={href:"https://blog.csdn.net/HXNLYW/article/details/106330927",target:"_blank",rel:"noopener noreferrer"},Ds=n("h3",{id:"整合flyingsaucer-thymeleaf-实现模板文件转pdf打印",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#整合flyingsaucer-thymeleaf-实现模板文件转pdf打印","aria-hidden":"true"},"#"),s(" 整合FlyingSaucer + thymeleaf 实现模板文件转pdf打印")],-1),Ps={href:"https://blog.csdn.net/HXNLYW/article/details/104478142",target:"_blank",rel:"noopener noreferrer"},Es=n("p",null,"字体文件放在 resources/static/font/simsun.ttf 位置 ，不加入字体文件导出pdf时会格式错误",-1),As={href:"https://wwmj.lanzoue.com/iYBOx1a6cbab",target:"_blank",rel:"noopener noreferrer"},Os=n("h2",{id:"文件相关",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#文件相关","aria-hidden":"true"},"#"),s(" 文件相关")],-1),Ns={href:"https://blog.csdn.net/qq_32419139/category_12269593.html",target:"_blank",rel:"noopener noreferrer"},Ls=n("h3",{id:"minio",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#minio","aria-hidden":"true"},"#"),s(" Minio")],-1),Qs=n("h4",{id:"linux-安装",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#linux-安装","aria-hidden":"true"},"#"),s(" linux 安装")],-1),Us={href:"https://www.minio.org.cn/docs/minio/linux/index.html",target:"_blank",rel:"noopener noreferrer"},zs=n("h4",{id:"docker-安装-实测可用",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#docker-安装-实测可用","aria-hidden":"true"},"#"),s(" docker 安装（实测可用）")],-1),Fs={href:"https://blog.csdn.net/BThinker/article/details/125412751",target:"_blank",rel:"noopener noreferrer"},Js=e('<p><strong>下载Minio镜像</strong></p><table><thead><tr><th style="text-align:left;">命令</th><th style="text-align:left;">描述</th></tr></thead><tbody><tr><td style="text-align:left;">docker pull minio/minio</td><td style="text-align:left;">下载最新版Minio镜像 (其实此命令就等同于 : docker pull minio/minio:latest )</td></tr><tr><td style="text-align:left;">docker pull minio/minio:RELEASE.2022-06-20T23-13-45Z.fips</td><td style="text-align:left;">下载指定版本的Minio镜像 (xxx指具体版本号)</td></tr></tbody></table>',2),Vs={href:"https://so.csdn.net/so/search?q=Docker&spm=1001.2101.3001.7020",target:"_blank",rel:"noopener noreferrer"},Ws=e(`<p><strong>创建目录</strong></p><blockquote><p>一个用来存放配置，一个用来存储上传文件的目录</p><p>启动前需要先创建Minio外部挂载的配置文件（ /home/minio/config）,和存储上传文件的目录（ /home/minio/data）</p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mkdir -p /home/minio/config
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>9090端口指的是minio的客户端端口</p><p>MINIO_ACCESS_KEY ：账号</p><p>MINIO_SECRET_KEY ：密码（账号长度必须大于等于5，密码长度必须大于等于8位）</p><p><strong>访问</strong></p>`,12),Hs={href:"http://127.0.0.1:9090/login",target:"_blank",rel:"noopener noreferrer"},Ks={href:"https://blog.csdn.net/destin223/article/details/134110194#:~:text=%E8%AE%BF%E9%97%AE%E6%96%87%E4%BB%B6%E7%BD%91%E5%9D%80%E4%B8%BA%EF%BC%9Aip%3Aaddress%2Fbucket%E7%9A%84%E5%90%8D%E5%AD%97%2F%E6%96%87%E4%BB%B6%E7%9A%84%E5%90%8D%E5%AD%97%E3%80%82,2%E3%80%81%E8%BF%9B%E5%85%A5%E9%A1%B5%E9%9D%A2%E5%90%8E%EF%BC%8C%E9%85%8D%E7%BD%AE%E5%8F%AA%E8%AF%BB%E8%AE%BF%E9%97%AE%E6%9D%83%E9%99%90%EF%BC%8Cprefix%E6%8C%89%E7%85%A7%E6%8F%90%E7%A4%BA%E8%BE%93%E5%85%A5%E5%B0%B1%E5%A5%BD%E3%80%82",target:"_blank",rel:"noopener noreferrer"},Gs=n("p",null,"在minio上传的文件以 ip:address/bucket的名字/文件的名字 路径来访问",-1),Ys={href:"https://mp.weixin.qq.com/s/Ejz4RMt9m0nBgFFPGFtjrg",target:"_blank",rel:"noopener noreferrer"},Xs=n("h2",{id:"文章收藏",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#文章收藏","aria-hidden":"true"},"#"),s(" 文章收藏")],-1),$s={href:"https://mp.weixin.qq.com/s/evA1d1vY9Nqt72zFNQvgeA",target:"_blank",rel:"noopener noreferrer"};function Zs(na,sa){const a=c("ExternalLinkIcon");return i(),o("div",null,[u,n("p",null,[s("纯净的springBoot示例项目："),n("a",r,[s("刘潇/springboot-pure - 码云 - 开源中国 (gitee.com)"),t(a)])]),n("h3",d,[k,s(" 学前拓展：mybatis "),n("a",v,[s("B站视频资料"),t(a)])]),m,n("p",null,[n("a",b,[s("IDEA最右侧栏的Maven窗口不见了怎么调出来-百度经验 (baidu.com)"),t(a)]),s(),g]),h,n("p",null,[n("a",y,[s("https://blog.csdn.net/weixin_43785284/article/details/122015400"),t(a)])]),f,n("p",null,[n("a",w,[s("https://blog.csdn.net/m0_67391121/article/details/126020133"),t(a)])]),q,n("p",null,[n("a",S,[s("(228条消息) Controller层接收前端页面传参种类及实现_前端传值到controller_爱学习的小健的博客-CSDN博客"),t(a)])]),x,n("p",null,[n("a",_,[s("(210条消息) MAVEN:打包报错 Failed to execute goal org.apache.maven.plugins:maven-compiler-plugin:3.1:compile_Int_Xu的博客-CSDN博客"),t(a)])]),I,n("p",null,[n("a",B,[s("(227条消息) jar包在linux上持续运行及终止运行的命令_linux 停止持久运行_羊糕的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",T,[s("(227条消息) Linux 解决nohup: 忽略输入并把输出追加到“nohup.out“和nohup: 忽略输入重定向错误到标准输出端_千与千与千的博客-CSDN博客"),t(a)])]),j,n("p",null,[s("VIM中常用命令 "),n("a",M,[s("https://blog.csdn.net/feosun/article/details/73196299"),t(a)])]),C,R,D,n("p",null,[n("a",P,[s("(210条消息) linux 安装mysql8.0 超详细图文教程__亮亮同學的博客-CSDN博客"),t(a)])]),n("p",null,[s("安装mysql，进行初始化时失败报错 ： "),n("a",E,[s(" 初始化Mysql报错：初始化数据库显示libaio.so.1_兔飞小朋友的博客-CSDN博客"),t(a)])]),n("p",null,[s("报错：log-error set to '/var/log/mariadb/mariadb.log', however file don't exists. Create writable for user 'mysql'. "),n("a",A,[s("(219条消息) Linux安装MySQL时候出现log-error set to '/var/log/mariadb/mariadb.log', however file don't exists._BertonYip的博客-CSDN博客"),t(a)])]),O,n("p",null,[n("a",N,[s("(219条消息) Mysql 启动报错解析：Starting MySQL.. ERROR! The server quit without updating PID file (/usr/local/mysql/dat_清风的BLOG的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",L,[s("Linux 安装 MySQL 8.0.26 超详细图文步骤 - yoodb - 博客园 (cnblogs.com)"),t(a)]),s(" (实测有效)")]),n("p",null,[n("a",Q,[s("(210条消息) Linux怎样到切换到超级用户_linux超级用户权限怎么打开_bo_无问西东的博客-CSDN博客"),t(a)])]),U,n("p",null,[n("a",z,[s("(210条消息) 05.navicat连接不上虚拟机内的mysql_navicat连不上虚拟机中的mysql_weixin_49015210的博客-CSDN博客"),t(a)])]),F,J,V,W,H,K,n("p",null,[s("Redis下载与安装"),G,s(" 在Linux系统安装Redis步骤： 1.将Redis安装包上传到Linux 下载地址("),n("a",Y,[s("https://download.redis.io/releases/"),t(a)]),s(")")]),X,$,Z,nn,sn,an,n("p",null,[n("a",tn,[s("(227条消息) linux 安装jdk 两种方法：手动安装 和yum安装：_阿尔卑斯狼__的博客-CSDN博客"),t(a)])]),n("p",null,[s("yum install -y java-1.8.0-"),n("a",en,[s("openjdk"),t(a)]),s(".x86_64")]),n("p",null,[s("查看 java -"),n("a",pn,[s("version"),t(a)])]),on,n("p",null,[n("a",cn,[s("(227条消息) linux下打开对外开放端口号_linux开通端口_laidanlove250的博客-CSDN博客"),t(a)])]),ln,n("p",null,[n("a",un,[s("(214条消息) springboot与maven的多环境兼容解决方案_springboot兼容pom_沐雪架构师的博客-CSDN博客"),t(a)])]),rn,n("p",null,[n("a",dn,[s("(214条消息) SpringBoot的日志_springboot 日志_威少总冠军的博客-CSDN博客"),t(a)])]),kn,n("p",null,[n("a",vn,[s("(214条消息) springboot实现热部署_springboot热部署_lwj_07的博客-CSDN博客"),t(a)])]),mn,n("p",null,[n("a",bn,[s("(215条消息) SpringBoot测试用例设置随机数据_springboot生成随机id_梨轻巧的博客-CSDN博客"),t(a)])]),gn,n("p",null,[n("a",hn,[s("SpringBoot使用JdbcTemplate_慕课手记 (imooc.com)"),t(a)])]),yn,n("p",null,[n("a",fn,[s("参考B站redis视频"),t(a)])]),n("p",null,[s("redis配置文件： "),n("a",wn,[s("Redis配置文件详解 - 掘金 (juejin.cn)"),t(a)]),s(),n("a",qn,[s("Redis配置文件Redis.conf详解 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[s("redis 常用指令 "),n("a",Sn,[s("redis 常用指令 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[xn,s(),n("a",_n,[s("https://gitee.com/qishibo/AnotherRedisDesktopManager/releases"),t(a)])]),In,n("p",null,[s("参考： "),n("a",Bn,[s("(215条消息) springboot整合redis_springboot redis_lwj_07的博客-CSDN博客"),t(a)])]),n("p",null,[s("​ "),n("a",Tn,[s("(215条消息) 如何用SpringBoot整合Redis（详细讲解~）_我是一棵卷心菜的博客-CSDN博客"),t(a)])]),n("p",null,[s("​ "),n("a",jn,[s("SpringBoot教程(十四) | SpringBoot集成Redis(全网最全) - 掘金 (juejin.cn)"),t(a)])]),Mn,n("p",null,[s("增加RedisConfig的配置类（ "),n("a",Cn,[s(" redistemplate使用前需要配置一下connectionfactory和序列化方式_"),t(a)]),s(" ）")]),n("p",null,[n("a",Rn,[s("redis配置序列化_redis序列化-CSDN博客"),t(a)])]),n("p",null,[n("a",Dn,[s("【精选】最详细 | redis实战:JackSon/FastJson方式序列化深度解析_redis使用fastjson序列化_阿千弟的博客-CSDN博客"),t(a)])]),Pn,n("p",null,[n("a",En,[s("RedisCache redis工具类_rediscache.setcacheobject-CSDN博客"),t(a)])]),An,n("p",null,[n("a",On,[s("(230条消息) RedisTemplate常用方法（超详细）_Yan Yang的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",Nn,[s("RedisTemplate操作Redis，这一篇文章就够了（一） - 掘金 (juejin.cn)"),t(a)])]),Ln,n("p",null,[n("a",Qn,[s("(230条消息) redisTemplate.opsForValue()中方法讲解_Archie_java的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",Un,[s("(230条消息) RedisTemplate使用最详解（一）--- opsForValue()_opsforvalue().set_学习中啊哈哈的博客-CSDN博客"),t(a)])]),zn,n("p",null,[n("a",Fn,[s("(216条消息) Redis 基础 Jedis -- Jedis（Java程序操作Redis的工具）_CodeJiao的博客-CSDN博客"),t(a)])]),Jn,Vn,Wn,Hn,n("p",null,[n("a",Kn,[s("(216条消息) MongoDB数据库的常用命令_mongodb数据库命令_勤奋上进的兔子的博客-CSDN博客"),t(a)])]),Gn,n("p",null,[n("a",Yn,[s("(216条消息) 《SpringBoot篇》15.SpringBoot整合MongoDB超详细教程（包括安装教程）_springboot mongodb_陈老老老板的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",Xn,[s("全面学习MongoDB，在Spring Boot项目中整合 MongoDB-腾讯云开发者社区-腾讯云 (tencent.com)"),t(a)])]),$n,n("p",null,[s("下载： "),n("a",Zn,[s("Download Elasticsearch | Elastic"),t(a)])]),n("p",null,[s("文档参考： "),n("a",ns,[s("(217条消息) ElasticSearch使用教程、设计到实战_ForFuture Code的博客-CSDN博客"),t(a)])]),ss,n("p",null,[n("a",as,[s("(218条消息) 【SpringBoot整合缓存】-----Redis缓存篇_springboot redis缓存_潮浪之巅的博客-CSDN博客"),t(a)]),s(),n("a",ts,[s("(218条消息) 【JetCache】JetCache的使用方法与步骤_No8g攻城狮的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",es,[s("J2Cache: Java 两级缓存框架，可以让应用支持两级缓存框架 ehcache(Caffeine) + redis 。避免完全使用独立缓存系统所带来的网络IO开销问题 (gitee.com)"),t(a)])]),ps,n("p",null,[n("a",is,[s("(228条消息) JWT的组成_Jint001的博客-CSDN博客"),t(a)])]),os,n("p",null,[n("a",cs,[s("JWT工具类（拿来直接用就完了，注释解释的很详细）_/** * jwt 工具类 * * @author json * @date 2021/11/15 -CSDN博客"),t(a)])]),ls,n("p",null,[n("a",us,[s("(228条消息) 使用springBoot实现token校验_springboot 校验token_秃头小陈~的博客-CSDN博客"),t(a)])]),rs,n("p",null,[s("参考文档： "),n("a",ds,[s("Docker安装部署RabbitMQ - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",ks,[s("超详细的RabbitMQ入门"),t(a)])]),n("p",null,[n("a",vs,[s("RabbitMQ详解之你要的RabbitMQ这里都有_adobehu的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",ms,[s("01-今日课程介绍_哔哩哔哩_bilibili"),t(a)])]),bs,n("p",null,[n("a",gs,[s("http://127.0.0.1:15672"),t(a)]),s(" （使用服务器的 ip 地址） 打开RabbitMQ的管理页面（使用设置的用户名和密码可以登录进去）")]),hs,n("h4",ys,[fs,s(" 示例（ "),n("a",ws,[s("B站视频地址"),t(a)]),s(" ）")]),qs,n("p",null,[n("a",Ss,[s("RabbitMQ交换机类型简述 "),t(a)])]),xs,_s,Is,n("p",null,[n("a",Bs,[s("Thymeleaf基本使用_thymeleaf ui-CSDN博客"),t(a)])]),n("p",null,[n("a",Ts,[s("Thymeleaf 教程 | 範宗雲 (fanlychie.github.io)"),t(a)])]),js,Ms,Cs,n("p",null,[n("a",Rs,[s("整合thymeleaf 实现模板文件转word打印_springboot导出word纸张大小-CSDN博客"),t(a)])]),Ds,n("p",null,[n("a",Ps,[s("《SpringBoot2.0 实战》系列-整合FlyingSaucer + thymeleaf 实现模板文件转pdf打印-CSDN博客"),t(a)])]),Es,n("p",null,[n("a",As,[s("https://wwmj.lanzoue.com/iYBOx1a6cbab"),t(a)]),s(" 密码:guv2")]),Os,n("p",null,[n("a",Ns,[s("文件相关_寂寞旅行的博客-CSDN博客"),t(a)])]),Ls,Qs,n("p",null,[n("a",Us,[s("MinIO对象存储 Linux — MinIO中文文档 | MinIO Linux中文文档"),t(a)])]),zs,n("p",null,[n("a",Fs,[s("Docker 搭建 Minio 容器 (完整详细版)_docker minio-CSDN博客"),t(a)])]),Js,n("p",null,[n("strong",null,[s("检查当前所有"),n("a",Vs,[s("Docker"),t(a)]),s("下载的镜像")]),s(" docker images")]),Ws,n("p",null,[s("访问："),n("a",Hs,[s("http://127.0.0.1:9090/login"),t(a)]),s(" 用户名：密码 minioadmin：minioadmin （自己设置的）")]),n("p",null,[n("a",Ks,[s("minIO设置直接通过访问链接在浏览器中打开文件_minio直接访问文件-CSDN博客"),t(a)])]),Gs,n("p",null,[s("实测可用（java使用 minio）："),n("a",Ys,[s("Docker 搭建 Minio 容器 (完整详细版) (qq.com)"),t(a)])]),Xs,n("p",null,[n("a",$s,[s("告别繁琐：SpringBoot 拦截器与统一功能处理 (qq.com)"),t(a)])])])}const ea=p(l,[["render",Zs],["__file","spring-boot.html.vue"]]);export{ea as default};
