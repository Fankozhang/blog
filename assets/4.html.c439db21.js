import{_ as p}from"./_plugin-vue_export-helper.cdc0426e.js";import{o,c,a as n,b as s,e as t,f as e,r as i}from"./app.d07e8db8.js";const l={},u=e(`<h1 id="vue" tabindex="-1"><a class="header-anchor" href="#vue" aria-hidden="true">#</a> vue</h1><h2 id="vue项目打包一键去掉所有console-log" tabindex="-1"><a class="header-anchor" href="#vue项目打包一键去掉所有console-log" aria-hidden="true">#</a> vue项目打包一键去掉所有console.log</h2><p>在Vue项目中，可以通过使用babel插件来去除所有的console.log语句。以下是一种常用的方法：</p><ol><li>安装babel插件：babel-plugin-transform-remove-console</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install babel-plugin-transform-remove-console --save-dev
...
<span class="token literal-property property">methods</span><span class="token operator">:</span><span class="token punctuation">{</span>
   <span class="token function">next</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span> <span class="token comment">// 往下切换</span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue项目跳转时如何加密路由上面query传递的参数" tabindex="-1"><a class="header-anchor" href="#vue项目跳转时如何加密路由上面query传递的参数" aria-hidden="true">#</a> vue项目跳转时如何加密路由上面query传递的参数</h2>`,9),N={href:"https://blog.csdn.net/weixin_44243061/article/details/107092308",target:"_blank",rel:"noopener noreferrer"},B={href:"https://github.com/wukang0718/vueRouterEncryption",target:"_blank",rel:"noopener noreferrer"},L=n("p",null,"(实际使用有bug,在新页面打开带参数的url时，加密的参数并不能够解析出来)",-1),F=n("h2",{id:"后端返回很大的数据量-前端如何渲染",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#后端返回很大的数据量-前端如何渲染","aria-hidden":"true"},"#"),s(" 后端返回很大的数据量，前端如何渲染")],-1),H={href:"https://mp.weixin.qq.com/s/pWsntJbJnBip5CbP7HkvFg",target:"_blank",rel:"noopener noreferrer"},I=n("h2",{id:"vite创建vue3项目",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vite创建vue3项目","aria-hidden":"true"},"#"),s(" vite创建vue3项目")],-1),O={href:"https://juejin.cn/post/7276408879365636156",target:"_blank",rel:"noopener noreferrer"},J={href:"https://juejin.cn/post/7156957907890733063",target:"_blank",rel:"noopener noreferrer"},U=e(`<p>普通创建vite项目</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm init vite@latest
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>除了前端配置代理之外，后台也要配置跨域，否则请求不到，后台跨域解决可以参考下面的文章</p>`,39),$={href:"https://juejin.cn/post/7229139006080253989",target:"_blank",rel:"noopener noreferrer"},X={href:"https://blog.csdn.net/qq_40185480/article/details/110926273",target:"_blank",rel:"noopener noreferrer"},G=n("h4",{id:"配置pinia",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#配置pinia","aria-hidden":"true"},"#"),s(" 配置pinia")],-1),W={href:"https://mp.weixin.qq.com/s/vxjPAuwQjLd75nt4RPCR8A",target:"_blank",rel:"noopener noreferrer"},Y=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install pinia
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="树形结构插件-vue2-org-tree-组织结构图" tabindex="-1"><a class="header-anchor" href="#树形结构插件-vue2-org-tree-组织结构图" aria-hidden="true">#</a> 树形结构插件 vue2-org-tree(组织结构图)</h3>`,12),K={href:"https://juejin.cn/post/7011705093665849375",target:"_blank",rel:"noopener noreferrer"},Q={href:"https://zhuanlan.zhihu.com/p/117300250",target:"_blank",rel:"noopener noreferrer"},Z=n("h3",{id:"vue3-中引入wangeditor富文本编辑器",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue3-中引入wangeditor富文本编辑器","aria-hidden":"true"},"#"),s(" Vue3 中引入wangeditor富文本编辑器")],-1),nn={href:"https://www.wangeditor.com/v5/getting-started.html#%E5%BC%95%E5%85%A5-js-%E5%88%9B%E5%BB%BA%E7%BC%96%E8%BE%91%E5%99%A8",target:"_blank",rel:"noopener noreferrer"},sn={href:"https://www.wangeditor.com/v5/for-frame.html",target:"_blank",rel:"noopener noreferrer"},an={href:"https://blog.csdn.net/qq_41299955/article/details/107571454",target:"_blank",rel:"noopener noreferrer"},tn=e(`<p>基本使用：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i wangeditor -S
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="视频播放器" tabindex="-1"><a class="header-anchor" href="#视频播放器" aria-hidden="true">#</a> 视频播放器</h3>`,7),on={href:"https://www.uedbox.com/post/68416/",target:"_blank",rel:"noopener noreferrer"},cn={id:"vue3videoplay-vue3可用-效果好",tabindex:"-1"},ln=n("a",{class:"header-anchor",href:"#vue3videoplay-vue3可用-效果好","aria-hidden":"true"},"#",-1),un={href:"https://codelife.cc/vue3-video-play/",target:"_blank",rel:"noopener noreferrer"},rn={href:"https://blog.csdn.net/qq_52752298/article/details/133637931",target:"_blank",rel:"noopener noreferrer"},dn=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i vue3-video-play --save
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>报错:Failed to resolve entry for package &quot;vue3-video-play&quot;. The package may have incorrect main/module/exports specified in its package.json.</p>`,4),kn={href:"https://blog.csdn.net/milk123_/article/details/135293846",target:"_blank",rel:"noopener noreferrer"},vn=e(`<p>步骤：找到node_modules\\vue3-video-play\\package.json 将package.json中 &quot;module&quot;: &quot;./dist/index.es.js&quot;改为&quot;module&quot;: &quot;./dist/index.mjs&quot;</p><p>然后重启项目，可以看到没有报错了</p><p>使用(具体参数看官网展示)：</p><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="aliplayer阿里播放器" tabindex="-1"><a class="header-anchor" href="#aliplayer阿里播放器" aria-hidden="true">#</a> Aliplayer阿里播放器</h4>`,5),mn={href:"https://player.alicdn.com/aliplayer/presentation/index.html?type=cover",target:"_blank",rel:"noopener noreferrer"},bn=n("h4",{id:"西瓜播放器-可音乐播放",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#西瓜播放器-可音乐播放","aria-hidden":"true"},"#"),s(" 西瓜播放器（可音乐播放）")],-1),gn={href:"https://v2.h5player.bytedance.com/gettingStarted/",target:"_blank",rel:"noopener noreferrer"},hn={href:"https://blog.csdn.net/lianghecai52171314/article/details/116812079",target:"_blank",rel:"noopener noreferrer"},fn=n("p",null,"只需三步：安装、DOM占位、实例化即可完成播放器的使用。",-1),yn=n("h4",{id:"mui-player-多端可用-效果好",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#mui-player-多端可用-效果好","aria-hidden":"true"},"#"),s(" Mui Player(多端可用，效果好)")],-1),qn={href:"https://muiplayer.js.org/zh/",target:"_blank",rel:"noopener noreferrer"},xn={href:"https://blog.csdn.net/linx_i/article/details/124190001",target:"_blank",rel:"noopener noreferrer"},wn=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i mui-player --save
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue-搭建组件库v2-简易" tabindex="-1"><a class="header-anchor" href="#vue-搭建组件库v2-简易" aria-hidden="true">#</a> vue 搭建组件库V2（简易）</h2>`,6),_n={href:"https://www.bilibili.com/video/BV1Zf4y1u75o?p=1&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},jn={href:"https://www.cnblogs.com/luoluo-snow/p/11636943.html",target:"_blank",rel:"noopener noreferrer"},Sn=n("p",null,"一开始跟着视频编写代码，但是到了webpack打包，webpack.component.js文件和依赖引入时出现了挺多的报错（尝试了几个解决方法，最终没能解决，在打包完css后直接发布了），在打包发布到了npm网站后引入组件，打开页面控制台报红，果然失败了。",-1),Vn=n("p",null,"后来参考文章，用脚手架自带的打包，成功部署到npm网站上了。使用正常。",-1),Pn=n("p",null,"vue组件库制作：npm初始化项目+编写组件+webpack打包js+gulp打包css+npm发布",-1),Cn={href:"https://zhuanlan.zhihu.com/p/337520239",target:"_blank",rel:"noopener noreferrer"},En=e(`<h3 id="搭建vue项目和运行环境-示例-vue2版本" tabindex="-1"><a class="header-anchor" href="#搭建vue项目和运行环境-示例-vue2版本" aria-hidden="true">#</a> 搭建vue项目和运行环境（示例）vue2版本</h3><p>1、首先，创建一个普通的vue2项目</p><p>2、打开项目，将src目录下的components文件夹放到项目根目录下，改名为packages,将src文件名改为examples。此时运行项目会报错。原因是vue寻找文件默认是从src目录下寻找，我们改了src名为examples，所以需要对配置进行修改。</p><p>修改方法：创建vue.config,js文件，代码如下</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行 npm run build:css 打包css代码，注意文件路径报错</p><h3 id="发布" tabindex="-1"><a class="header-anchor" href="#发布" aria-hidden="true">#</a> 发布</h3>`,37),Mn={href:"https://mp.weixin.qq.com/s/clyH5SFvwtPY19dagUgcDA",target:"_blank",rel:"noopener noreferrer"},An=e(`<p>1、准备一个npm账号</p><p>2、npm login 登录npm账号</p><p>3、npm publish (推送代码，注意修改package.json的配置)</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    &quot;name&quot;: &quot;fankoui3&quot;,
    &quot;version&quot;: &quot;0.1.0&quot;,
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在vue文件中使用Card组件，如可显示正常，则组件库创建成功。</p><h2 id="如何写一个属于自己的vue3组件库" tabindex="-1"><a class="header-anchor" href="#如何写一个属于自己的vue3组件库" aria-hidden="true">#</a> 如何写一个属于自己的Vue3组件库</h2>`,12),zn={href:"https://juejin.cn/post/7207094325897297957",target:"_blank",rel:"noopener noreferrer"},Dn=n("p",null,"pnpm 修改默认安装包的仓库位置 pnpm config set store-dir E:/pnpmPackage",-1),Rn=n("p",null,"使用pnpm的项目最好不要有中文路径，否则下载依赖可能有报错",-1),Tn={href:"https://mp.weixin.qq.com/s/jvLAFzwJPlA5J-iNJSblag",target:"_blank",rel:"noopener noreferrer"},Nn={href:"https://juejin.cn/post/7255514764754894907?searchId=20231030164149D848293E31B857FECA86#heading-6",target:"_blank",rel:"noopener noreferrer"},Bn={href:"https://juejin.cn/post/7285373518836826167",target:"_blank",rel:"noopener noreferrer"},Ln={href:"https://juejin.cn/post/7211521650252398649",target:"_blank",rel:"noopener noreferrer"},Fn={href:"https://juejin.cn/user/78820567165575/posts",target:"_blank",rel:"noopener noreferrer"},Hn={href:"https://github.com/yuanwen0327/learn-create-compoents-lib",target:"_blank",rel:"noopener noreferrer"},In={href:"https://juejin.cn/post/6987735091925483551#heading-14",target:"_blank",rel:"noopener noreferrer"},On={href:"https://juejin.cn/post/7241514309717639228",target:"_blank",rel:"noopener noreferrer"},Jn={href:"https://juejin.cn/post/7117897323014783013",target:"_blank",rel:"noopener noreferrer"},Un=e(`<h2 id="vue3实现-v-model-封装组件" tabindex="-1"><a class="header-anchor" href="#vue3实现-v-model-封装组件" aria-hidden="true">#</a> vue3实现 v-model (封装组件)</h2><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code>// 父组件     v-model 等于 :modelValue=&quot;inContent&quot; @update:modelValue=&quot;inContent = $event&quot;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue3基本使用-用setup-语法糖" tabindex="-1"><a class="header-anchor" href="#vue3基本使用-用setup-语法糖" aria-hidden="true">#</a> vue3基本使用（用setup 语法糖）</h2>`,4),$n={href:"https://cn.vuejs.org/guide/introduction.html",target:"_blank",rel:"noopener noreferrer"},Xn={href:"https://juejin.cn/post/6897030228867022856",target:"_blank",rel:"noopener noreferrer"},Gn=e(`<h3 id="计算属性" tabindex="-1"><a class="header-anchor" href="#计算属性" aria-hidden="true">#</a> 计算属性</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> ref<span class="token punctuation">,</span>reactive<span class="token punctuation">,</span> computed <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;vue&#39;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>特别是注意侦听器是如何两次使用 <code>todoId</code> 的，一次是作为源，另一次是在回调中。</p>`,8),Wn={href:"https://cn.vuejs.org/api/reactivity-core.html#watcheffect",target:"_blank",rel:"noopener noreferrer"},Yn=n("code",null,"watchEffect",-1),Kn=n("code",null,"watchEffect()",-1),Qn=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>watchEffect(async () =&gt; {
  const response = await fetch(
    \`https://jsonplaceholder.typicode.com/todos/\${todoId.value}\`
  )
  data.value = await response.json()
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="异步状态示例" tabindex="-1"><a class="header-anchor" href="#异步状态示例" aria-hidden="true">#</a> 异步状态示例</h4><p>在做异步数据请求时，我们常常需要处理不同的状态：加载中、加载成功和加载失败。</p><p><strong>接收响应式状态</strong></p><p><code>useFetch()</code> 接收一个静态 URL 字符串作为输入——因此它只会执行一次 fetch 并且就此结束。如果我们想要在 URL 改变时重新 fetch 呢？为了实现这一点，我们需要将响应式状态传入组合式函数，并让它基于传入的状态来创建执行操作的侦听器。</p><p>举例来说，<code>useFetch()</code> 应该能够接收一个 ref：或者接收一个 getter 函数：</p>`,33),Zn={href:"https://cn.vuejs.org/api/reactivity-core.html#watcheffect",target:"_blank",rel:"noopener noreferrer"},ns=n("code",null,"watchEffect()",-1),ss={href:"https://cn.vuejs.org/api/reactivity-utilities.html#tovalue",target:"_blank",rel:"noopener noreferrer"},as=n("code",null,"toValue()",-1),ts=n("code",null,"toValue()",-1),es={href:"https://cn.vuejs.org/api/reactivity-utilities.html#unref",target:"_blank",rel:"noopener noreferrer"},ps=n("code",null,"unref()",-1),os=e("<p>注意 <code>toValue(url)</code> 是在 <code>watchEffect</code> 回调函数的<strong>内部</strong>调用的。这确保了在 <code>toValue()</code> 规范化期间访问的任何响应式依赖项都会被侦听器跟踪。</p><p>这个版本的 <code>useFetch()</code> 现在能接收静态 URL 字符串、ref 和 getter，使其更加灵活。watch effect 会立即运行，并且会跟踪 <code>toValue(url)</code> 期间访问的任何依赖项。如果没有跟踪到依赖项（例如 url 已经是字符串），则 effect 只会运行一次；否则，它将在跟踪到的任何依赖项更改时重新运行。</p><p><strong>输入参数</strong></p>",3),cs={href:"https://cn.vuejs.org/api/reactivity-utilities.html#tovalue",target:"_blank",rel:"noopener noreferrer"},is=n("code",null,"toValue()",-1),ls=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>import { toValue } from &#39;vue&#39;
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="getcurrentinstance" tabindex="-1"><a class="header-anchor" href="#getcurrentinstance" aria-hidden="true">#</a> getCurrentInstance</h3><p>在Vue3中，getCurrentInstance() 可以用来获取<strong>当前组件实例</strong></p>`,5),ds={href:"https://blog.csdn.net/Zaralike/article/details/125870367",target:"_blank",rel:"noopener noreferrer"},ks=n("h2",{id:"vite-vue-配置",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vite-vue-配置","aria-hidden":"true"},"#"),s(" Vite vue 配置")],-1),vs=n("h3",{id:"vite打包视图分析-rollup-plugin-visualizer",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vite打包视图分析-rollup-plugin-visualizer","aria-hidden":"true"},"#"),s(" vite打包视图分析(rollup-plugin-visualizer)")],-1),ms={href:"https://juejin.cn/post/7159410085460983839",target:"_blank",rel:"noopener noreferrer"},bs=e(`<p>分析项目中的js文件大小和引用情况，基于展示的依赖项 js 大小对前端项目做优化处理</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install --save-dev rollup-plugin-visualizer
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vite-项目优化-配置-cdn-服务" tabindex="-1"><a class="header-anchor" href="#vite-项目优化-配置-cdn-服务" aria-hidden="true">#</a> vite 项目优化 配置 CDN 服务</h3><p>配置cdn加速，减小打包体积</p>`,6),gs={href:"https://juejin.cn/post/7248118049584332856",target:"_blank",rel:"noopener noreferrer"},hs=n("h2",{id:"vue和react对比学习之路由角色权限",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue和react对比学习之路由角色权限","aria-hidden":"true"},"#"),s(" Vue和React对比学习之路由角色权限")],-1),fs={href:"https://juejin.cn/post/7250386282400596029#heading-23",target:"_blank",rel:"noopener noreferrer"},ys=n("h2",{id:"如何在vue-js中创建模态框-弹出框",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#如何在vue-js中创建模态框-弹出框","aria-hidden":"true"},"#"),s(" 如何在Vue.js中创建模态框(弹出框)")],-1),qs={href:"https://mp.weixin.qq.com/s/MddofJ10zYXtWAeGa5Z_Cw",target:"_blank",rel:"noopener noreferrer"},xs=e(`<h2 id="点击侧边展示导航的组件" tabindex="-1"><a class="header-anchor" href="#点击侧边展示导航的组件" aria-hidden="true">#</a> 点击侧边展示导航的组件</h2><p>用的ant-design-vue的 a-drawer</p><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue3使用jsx" tabindex="-1"><a class="header-anchor" href="#vue3使用jsx" aria-hidden="true">#</a> vue3使用jsx</h2>`,4),ws={href:"https://juejin.cn/post/7213356423810924581",target:"_blank",rel:"noopener noreferrer"},_s={href:"https://juejin.cn/post/7151950058501373989?from=search-suggest",target:"_blank",rel:"noopener noreferrer"},js={href:"https://juejin.cn/post/7261604498924961829",target:"_blank",rel:"noopener noreferrer"},Ss={href:"https://zhuanlan.zhihu.com/p/375527289",target:"_blank",rel:"noopener noreferrer"},Vs={href:"https://juejin.cn/post/7272308621710213161",target:"_blank",rel:"noopener noreferrer"},Ps={href:"https://mp.weixin.qq.com/s/DOBgFqHoupBcoRLngHFNUw",target:"_blank",rel:"noopener noreferrer"},Cs=e(`<p>想在项目中使用 JSX,我们需要安装一个插件<code>@vitejs/plugin-vue-jsx</code>,这个插件可以让我们在项目中使用 JSX/TSX</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i @vitejs/plugin-vue-jsx -D
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue使用tailwindcss" tabindex="-1"><a class="header-anchor" href="#vue使用tailwindcss" aria-hidden="true">#</a> vue使用Tailwindcss</h2>`,12),Es={href:"https://www.tailwindcss.cn/docs/width",target:"_blank",rel:"noopener noreferrer"},Ms={href:"https://juejin.cn/post/7042901516499288077",target:"_blank",rel:"noopener noreferrer"},As=n("p",null,"当有不知道的类可以直接到官网文档查看",-1),zs={href:"https://juejin.cn/post/7228488937505030199",target:"_blank",rel:"noopener noreferrer"},Ds={href:"https://juejin.cn/post/7216990794942201913#heading-5",target:"_blank",rel:"noopener noreferrer"},Rs=e(`<p>安装依赖</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i -D tailwindcss postcss autoprefixer
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vueuse" tabindex="-1"><a class="header-anchor" href="#vueuse" aria-hidden="true">#</a> vueUse</h2>`,2),Bs={href:"https://www.vueusejs.com/guide/",target:"_blank",rel:"noopener noreferrer"},Ls=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i @vueuse/core
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="源码-深入了解" tabindex="-1"><a class="header-anchor" href="#源码-深入了解" aria-hidden="true">#</a> 源码（深入了解）</h2>`,5),Fs={href:"https://www.bilibili.com/video/BV1d4411v7UX/?vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"};function Hs(Is,Os){const a=i("ExternalLinkIcon");return o(),c("div",null,[u,n("ul",null,[n("li",null,[n("a",r,[s("Vue CLI官方文档 - Babel配置"),t(a)])]),n("li",null,[n("a",d,[s("babel-plugin-transform-remove-console"),t(a)])])]),k,n("p",null,[n("a",v,[s("vue中修改props传进来的值_使用计算属性更新prop的值-CSDN博客"),t(a)])]),m,n("p",null,[n("a",b,[s("Vue内置组件的component标签-CSDN博客"),t(a)])]),g,n("p",null,[n("a",h,[s("(202条消息) vue实现登录后跳转到之前的页面_longzhoufeng的博客-CSDN博客"),t(a)])]),f,n("p",null,[s("官网： "),n("a",y,[s("安装 | Pinia 中文文档 (web3doc.top)"),t(a)])]),q,n("p",null,[n("a",x,[s("https://juejin.cn/post/6928468842377117709"),t(a)])]),n("p",null,[n("a",w,[s("https://juejin.cn/post/6994337441314242590#heading-15"),t(a)])]),n("p",null,[n("a",_,[s("https://juejin.cn/post/7087100496762109983#heading-16"),t(a)])]),n("p",null,[s("简明易懂："),n("a",j,[s("https://juejin.cn/post/7280007176776204327?searchId=2024011109491811B46B930D323378F7D4"),t(a)])]),S,n("p",null,[n("a",V,[s("https://juejin.cn/post/7078281612013764616#heading-0"),t(a)])]),P,n("p",null,[s("官网："),n("a",C,[s("https://pinia.vuejs.org/zh/introduction.html"),t(a)])]),E,n("p",null,[M,s(" 配套有个插件 "),n("a",A,[s("pinia-plugin-persist"),t(a)]),s("进行数据持久化，否则一刷新就会造成数据丢失")]),z,n("p",null,[s("页面全屏滚动很多用于官网首页，使用的频率还挺高的，此处的代码实现的功能是 鼠标滚动，页面切换，点击键盘的上下键，页面切换。类似效果看 "),n("a",D,[s(" 全屏滚动_jQuery之家-自由分享jQuery、html5、css3的插件库 (htmleaf.com)"),t(a)]),s(" ，以下内容改自 "),n("a",R,[s("vue实现全屏滚动，非fullpage.js-阿里云开发者社区 (aliyun.com)"),t(a)]),s(" 。")]),T,n("p",null,[n("a",N,[s("vue-router路由中对query中的参数进行加密_router 参数加密_前端_小学生的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",B,[s("vue-router中传递的参数进行自动加密显示，组件中获取自动解密 (github.com)"),t(a)])]),L,F,n("p",null,[n("a",H,[s("https://mp.weixin.qq.com/s/pWsntJbJnBip5CbP7HkvFg"),t(a)])]),I,n("p",null,[n("a",O,[s("十分钟搭建 Vite+Vue3 项目模板 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",J,[s("从 0 搭建 Vite 3 + Vue 3 前端工程化项目 - 掘金 (juejin.cn)"),t(a)])]),U,n("p",null,[n("a",$,[s("SpringBoot 项目解决跨域的几种方案 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[s("（vue3中使用消息提示 "),n("a",X,[s("vue3中使用element-plus调用message_element-plus message_"),t(a)]),s(" ）")]),G,n("p",null,[n("a",W,[s("Vuex 更好的替代品 Pinia，真香 (qq.com)"),t(a)])]),Y,n("p",null,[n("a",K,[s("Vue 树形结构插件 vue2-org-tree - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",Q,[s("详解树状结构图 vue-org-tree - 知乎 (zhihu.com)"),t(a)])]),Z,n("p",null,[n("a",nn,[s("快速开始 | wangEditor"),t(a)]),s(" wangeditor有vue2,vue3,react的版本 "),n("a",sn,[s("用于 Vue React | wangEditor"),t(a)])]),n("p",null,[n("a",an,[s("在vue2中封装一个wangeditor组件_,也可以查看 ruoyi 里面的封装"),t(a)])]),tn,n("p",null,[n("a",en,[s("unplugin-vue-macros(github.com) "),t(a)])]),pn,n("p",null,[n("a",on,[s("几款优秀开源的HTML5 视频播放器 - 体验盒子 - 不再关注网络安全 (uedbox.com)"),t(a)])]),n("h4",cn,[ln,s(),n("a",un,[s("Vue3VideoPlay（vue3可用,效果好）"),t(a)])]),n("p",null,[n("a",rn,[s("Vue3-video-play视频播放器插件_视频播放插件-CSDN博客"),t(a)])]),dn,n("p",null,[s("解决："),n("a",kn,[s('VUE3+VITE:Failed to resolve entry for package “vue3-video-play“._failed to resolve entry for package "vue3-video-pl-CSDN博客'),t(a)])]),vn,n("p",null,[n("a",mn,[s("阿里云Aliplayer播放器 (alicdn.com)"),t(a)])]),bn,n("p",null,[n("a",gn,[s("西瓜播放器 | 快速上手 (bytedance.com)"),t(a)]),s(),n("a",hn,[s("vue3 集成西瓜视频播放器xgplayer_vue3 xiguaplay-CSDN博客"),t(a)])]),fn,yn,n("p",null,[n("a",qn,[s("MuiPlayer"),t(a)]),s(),n("a",xn,[s("vue + mui-player视频播放器_vue+muiplayer-CSDN博客"),t(a)])]),wn,n("p",null,[n("a",_n,[s("b站参考学习视频地址"),t(a)]),s(),n("a",jn,[s("参考文章 vue组件库的基本开发步骤 "),t(a)])]),Sn,Vn,Pn,n("p",null,[n("a",Cn,[s("基于element-ui构建自定义组件库，发布到npm及安装使用，以及生成组件库说明文档 - 知乎 (zhihu.com)"),t(a)])]),En,n("p",null,[n("a",Mn,[s("图文结合简单易学的 npm 包的发布流程 (qq.com)"),t(a)])]),An,n("p",null,[n("a",zn,[s("pnpm 基本详细使用（安装、卸载、使用） - 掘金 (juejin.cn)"),t(a)])]),Dn,Rn,n("p",null,[n("a",Tn,[s("如何写一个属于自己的Vue3组件库 (qq.com)"),t(a)])]),n("p",null,[n("a",Nn,[s("【前端工程化-组件库】从0-1构建Vue3组件库（打包发布） - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",Bn,[s("前端工程化😼开源项目都在用的【Monorepo】🏋🏿 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",Ln,[s("如何写一个属于自己的vue3组件库 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[s("参考,可用："),n("a",Fn,[s("全肝鸽鸽 的个人主页 - 文章 - 掘金 (juejin.cn)"),t(a)]),s(),n("a",Hn,[s("GitHub - yuanwen0327/learn-create-compoents-lib"),t(a)])]),n("p",null,[n("a",In,[s("一文读懂TS的(.d.ts)文件 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",On,[s("从0到1搭建自己的组件库，详解附源码 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",Jn,[s("Monorepo pnpm模式管理多个web项目（Vue3） - 掘金 (juejin.cn)"),t(a)])]),Un,n("p",null,[n("a",$n,[s("https://cn.vuejs.org/guide/introduction.html"),t(a)])]),n("p",null,[n("a",Xn,[s("快速使用Vue3最新的15个常用API - 掘金 (juejin.cn)"),t(a)])]),Gn,n("p",null,[s("用 "),n("a",Wn,[Yn,s(" 函数"),t(a)]),s(" 来简化上面的代码。"),Kn,s(" 允许我们自动跟踪回调的响应式依赖")]),Qn,n("p",null,[s("我们可以用 "),n("a",Zn,[ns,t(a)]),s(" 和 "),n("a",ss,[as,t(a)]),s(" API 来重构我们现有的实现：")]),n("p",null,[ts,s(" 是一个在 3.3 版本中新增的 API。它的设计目的是将 ref 或 getter 规范化为值。如果参数是 ref，它会返回 ref 的值；如果参数是函数，它会调用函数并返回其返回值。否则，它会原样返回参数。它的工作方式类似于 "),n("a",es,[ps,t(a)]),s("，但对函数有特殊处理。")]),os,n("p",null,[s("即便不依赖于 ref 或 getter 的响应性，组合式函数也可以接收它们作为参数。如果你正在编写一个可能被其他开发者使用的组合式函数，最好处理一下输入参数是 ref 或 getter 而非原始值的情况。可以利用 "),n("a",cs,[is,t(a)]),s(" 工具函数来实现：")]),ls,n("p",null,[n("a",us,[s("示例地址"),t(a)])]),rs,n("p",null,[n("a",ds,[s("Vue3组合式API：getCurrentInstance_vue3 getcurrentinstance-CSDN博客"),t(a)])]),ks,vs,n("p",null,[n("a",ms,[s("vue3+vite打包视图分析(rollup-plugin-visualizer)+gzip - 掘金 (juejin.cn)"),t(a)])]),bs,n("p",null,[n("a",gs,[s("【vite 4.3 + vue 3.2 项目优化实战】配置 CDN 服务 - 掘金 (juejin.cn)"),t(a)])]),hs,n("p",null,[n("a",fs,[s("Vue和React对比学习之路由角色权限(页面、按钮权限控制) - 掘金 (juejin.cn)"),t(a)])]),ys,n("p",null,[n("a",qs,[s("如何在Vue.js中创建模态框(弹出框) (qq.com)"),t(a)])]),xs,n("p",null,[n("a",ws,[s("如何在 vue3 中使用 jsx/tsx? - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",_s,[s("在 vue3 中优雅的使用 jsx/tsx - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",js,[s("在Vue3中利用JSX+函数式组件做到更好的代码复用 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",Ss,[s("JSX 设置样式 - 知乎 (zhihu.com)"),t(a)])]),n("p",null,[n("a",Vs,[s("万字长文详解 Vue JSX，带你全面拥抱 JSX 特性！-讲述了jsx的优点 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",Ps,[s("一起玩转Vue中的JSX：让你一次性掌握它的特性! 微信公众平台 (qq.com)"),t(a)])]),Cs,n("p",null,[s("官方文档： "),n("a",Es,[s("Width - TailwindCSS中文文档 | TailwindCSS中文网"),t(a)])]),n("p",null,[n("a",Ms,[s("一次就能看懂的Tailwind CSS介绍 - 掘金 (juejin.cn)"),t(a)])]),As,n("p",null,[n("a",zs,[s("在vite-vue3中快速使用Tailwindcss - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",Ds,[s("Vue中使用 Tailwind CSS - 掘金 (juejin.cn)"),t(a)])]),Rs,n("p",null,[n("a",Ts,[s("https://juejin.cn/post/7320169878644113408?searchId=20240111091116F28599892BCAA27BF8FD"),t(a)])]),Ns,n("p",null,[n("a",Bs,[s("起步 | VueUse中文文档 (vueusejs.com)"),t(a)])]),Ls,n("p",null,[n("a",Fs,[s("尤雨溪教你写vue 高级vue教程 源码分析 中文字幕翻译完毕_哔哩哔哩_bilibili"),t(a)])])])}const $s=p(l,[["render",Hs],["__file","4.html.vue"]]);export{$s as default};
