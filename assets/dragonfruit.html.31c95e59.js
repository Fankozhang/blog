...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="uni-cloud云开发" tabindex="-1"><a class="header-anchor" href="#uni-cloud云开发" aria-hidden="true">#</a> uni-cloud云开发</h2>`,5),an={href:"https://www.bilibili.com/video/BV1PP411E7qG/?spm_id_from=333.337.search-card.all.click&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},tn={href:"https://uniapp.dcloud.net.cn/uniCloud/#",target:"_blank",rel:"noopener noreferrer"},en=n("p",null,"（uni-cloud-project）",-1),pn={href:"https://unicloud.dcloud.net.cn/",target:"_blank",rel:"noopener noreferrer"},on=n("p",null,"uniCloud项目显示关联到的服务空间，则绑定成功",-1),ln=n("h3",{id:"客户端和云函数的通信",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#客户端和云函数的通信","aria-hidden":"true"},"#"),s(" 客户端和云函数的通信")],-1),cn=n("p",null,[s("uni-app客户端和传统服务器通信时，使用"),n("code",null,"uni.request"),s("的ajax请求方式。uniCloud下不再使用它，有更好的云端一体的通信方式。")],-1),un=n("p",null,"uniCloud体系里，客户端和服务端的云函数通信，有4种方式：",-1),rn=n("thead",null,[n("tr",null,[n("th",{style:{"text-align":"center"}}),n("th",{style:{"text-align":"center"}},"传统的restful方式"),n("th",{style:{"text-align":"center"}},"callfunction方式"),n("th",{style:{"text-align":"center"}},"云对象方式"),n("th",{style:{"text-align":"center"}},"clientDB方式")])],-1),dn=n("td",{style:{"text-align":"center"}},"简述",-1),kn={style:{"text-align":"center"}},vn={href:"https://uniapp.dcloud.net.cn/uniCloud/http",target:"_blank",rel:"noopener noreferrer"},mn=n("td",{style:{"text-align":"center"}},"云函数默认并不自带http链接",-1),bn=n("td",{style:{"text-align":"center"}},"把callfunction的函数式调用，升级为模块化的对象调用",-1),gn=n("td",{style:{"text-align":"center"}},"客户端直接操作云数据库",-1),hn=n("tr",null,[n("td",{style:{"text-align":"center"}},"前端调用方式"),n("td",{style:{"text-align":"center"}},"传统ajax"),n("td",{style:{"text-align":"center"}},[s("uni-app客户端通过"),n("code",null,"uniCloud.callFunction(functionname)"),s("来调用云函数")]),n("td",{style:{"text-align":"center"}},[s("uni-app客户端通过"),n("code",null,"uniCloud.importObject(objectname)"),s("导入一个云对象，直接使用这个对象的方法")]),n("td",{style:{"text-align":"center"}},[s("uni-app客户端通过``组件或"),n("code",null,"uniCloud.database()"),s(" API来访问uniCloud数据库。也支持搭配action云函数追加服务器逻辑")])],-1),yn=n("tr",null,[n("td",{style:{"text-align":"center"}},"适用场景"),n("td",{style:{"text-align":"center"}},"http链接需要自己注册域名。如果前端是uni-app，则不推荐使用URL化。如果是非uni-app的系统需要访问云函数，只能使用URL化"),n("td",{style:{"text-align":"center"}},"相比云函数URL，callfunction更加安全、更serverless，不暴露域名和ip，不怕攻击，也无需注册域名"),n("td",{style:{"text-align":"center"}},"uni-app 3.4起支持。相比callfunction方式。代码更加精简、逻辑更加清晰、开发更加高效"),n("td",{style:{"text-align":"center"}},"如果uni-app前端发起的服务器请求目的主要是查询或操作数据库，则推荐使用clientDB方式")],-1),qn=e(`<p>云函数是uniCloud的基础，本质上 clientDB 和 云对象 都是建立在云函数上针对特定场景的优化。</p><ul><li>clientDB针对的场景是数据库操作，它优化了可以不写或少写服务器代码</li><li>云对象针对的场景是非数据库操作或不宜前端暴露的数据库操作时，和uni-app客户端的通信方式。它优化了代码结构，更精简、简单</li></ul><h3 id="clientdb方式" tabindex="-1"><a class="header-anchor" href="#clientdb方式" aria-hidden="true">#</a> clientDB方式</h3><p>clientDB分API方式和组件方式，此处使用API方式来演示 (必须要配合DB Schema 使用)</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 客户端js直接操作云数据库，查询list表的数据。无需服务器代码</span>
...
<span class="token punctuation">}</span>
				...
				db<span class="token punctuation">.</span><span class="token function">collection</span><span class="token punctuation">(</span><span class="token string">&#39;users&#39;</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
				  ...
				  <span class="token punctuation">}</span><span class="token punctuation">)</span>
			<span class="token punctuation">}</span><span class="token punctuation">,</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="uni-id用户体系" tabindex="-1"><a class="header-anchor" href="#uni-id用户体系" aria-hidden="true">#</a> uni-id用户体系</h3>`,49),fn={href:"https://ext.dcloud.net.cn/plugin?name=uni-id-pages",target:"_blank",rel:"noopener noreferrer"},xn=n("code",null,"uniCloud/cloudfunctions/common/uni-config-center/uni-id/config.json",-1),wn={href:"https://uniapp.dcloud.net.cn/uniCloud/uni-id-summary.html#config",target:"_blank",rel:"noopener noreferrer"},_n=n("h3",{id:"注意",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#注意","aria-hidden":"true"},"#"),s(" 注意")],-1),jn=n("p",null,"项目体验在微信小程序上，要发送到体验版的时候，应该在hbuiler里面点击发布，并在微信小程序后台配置域名。",-1);function Cn(Sn,Pn){const a=c("ExternalLinkIcon");return o(),i("div",null,[l(`
