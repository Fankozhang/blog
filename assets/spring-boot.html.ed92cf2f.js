import{_ as i}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as l,c as p,a as n,b as s,e,f as t,r as o}from"./app.684a5af9.js";const c={},u=n("h1",{id:"springboot",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#springboot","aria-hidden":"true"},"#"),s(" springboot")],-1),d={href:"https://jingyan.baidu.com/article/48b558e35cbfc73e39c09a4e.html",target:"_blank",rel:"noopener noreferrer"},r=n("strong",null,"按下Ctrl+Shift+A",-1),v=n("p",null,"java： 错误：无效的源发行版：14",-1),k={href:"https://blog.csdn.net/weixin_43785284/article/details/122015400",target:"_blank",rel:"noopener noreferrer"},m=n("p",null,"JAVA‘无效目标发行版 17’的解决方案",-1),b={href:"https://blog.csdn.net/m0_67391121/article/details/126020133",target:"_blank",rel:"noopener noreferrer"},g=t(`<h2 id="springboot整合junit" tabindex="-1"><a class="header-anchor" href="#springboot整合junit" aria-hidden="true">#</a> springBoot整合junit</h2><p>1.导入测试对应的starter 2,测试类使用@SpringBootTest修饰 3,使用自动装配的形式添加要测试的对象</p><p>springBoot项目创建会自动生成测试类</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>example<span class="token punctuation">.</span>demo</span><span class="token punctuation">;</span>
...
mybatis-plus:
  ...
  <span class="token key atrule">datasource</span><span class="token punctuation">:</span>
    <span class="token key atrule">druid</span><span class="token punctuation">:</span>
      ...
      <span class="token key atrule">username</span><span class="token punctuation">:</span> root
      <span class="token key atrule">password</span><span class="token punctuation">:</span> root
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="ssmp-整合案例" tabindex="-1"><a class="header-anchor" href="#ssmp-整合案例" aria-hidden="true">#</a> SSMP 整合案例</h2><p>maven导入相关依赖</p><h3 id="实体类创建-lombok" tabindex="-1"><a class="header-anchor" href="#实体类创建-lombok" aria-hidden="true">#</a> 实体类创建(lombok)</h3><p><strong>Book.class</strong></p><p>Lombok,一个Java类库，提供了一组注解，简化P0J0实体类开发</p><p>lombok版本由SpringBoot提供，导入依赖无需指定版本</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="表现层开发" tabindex="-1"><a class="header-anchor" href="#表现层开发" aria-hidden="true">#</a> 表现层开发</h3><p>​ 基于Restful进行表现层接口开发 ​ 使用Postman测试表现层接口功能</p><p>1.基于Restfu1制作表现层接口 新增：POST 删除：DELETE 修改：PUT 查询：GET 2.接收参数 实体数据：@RequestBody 路径变量：@PathVariable</p><p>controller/BookController restful接口</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@RestController</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ProjectExceptionAdvice</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="打包" tabindex="-1"><a class="header-anchor" href="#打包" aria-hidden="true">#</a> 打包</h2><p>打开maven面板， 先clean,在点击package打包（点击 Toggle &#39;Skip Tests&#39;Mode 跳过测试过程，提示不安全）</p><p>（MAVEN:打包报错 Failed to execute goal org.apache.maven.plugins:maven-compiler-plugin:3.1:compile）</p>`,107),h={href:"https://blog.csdn.net/Int_Xu/article/details/108184768",target:"_blank",rel:"noopener noreferrer"},y=t(`<p>修改pom.xml （配置和版本如下）</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;build&gt;
		&lt;plugins&gt;
			&lt;plugin&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="部署运行-配置服务环境" tabindex="-1"><a class="header-anchor" href="#部署运行-配置服务环境" aria-hidden="true">#</a> 部署运行(配置服务环境)</h2>`,4),_={href:"https://blog.csdn.net/feosun/article/details/73196299",target:"_blank",rel:"noopener noreferrer"},w=n("p",null,"linux安装java运行环境：jdk",-1),q=n("p",null,"上传 jar 包 到usr/local/app 文件夹下",-1),B=n("p",null,"linux下载mysql usr/local/mysql",-1),I={href:"https://blog.csdn.net/u011421988/article/details/107234718",target:"_blank",rel:"noopener noreferrer"},j={href:"https://blog.csdn.net/qq_41817925/article/details/118674315",target:"_blank",rel:"noopener noreferrer"},M={href:"https://blog.csdn.net/BertonYip/article/details/80829524",target:"_blank",rel:"noopener noreferrer"},D=n("p",null,"Mysql 启动报错解析：Starting MySQL.. ERROR! The server quit without updating PID file (/usr/local/mysql/dat",-1),T={href:"https://blog.csdn.net/Qevery678/article/details/96422599",target:"_blank",rel:"noopener noreferrer"},P={href:"https://www.cnblogs.com/MrYoodb/p/15811199.html",target:"_blank",rel:"noopener noreferrer"},R={href:"https://blog.csdn.net/qq_43611486/article/details/99609644",target:"_blank",rel:"noopener noreferrer"},C=t(`<h3 id="linux安装mysql总结" tabindex="-1"><a class="header-anchor" href="#linux安装mysql总结" aria-hidden="true">#</a> <strong>linux安装MySQL总结</strong></h3><p>/usr/local 目录下</p><p><strong>下载MySQL</strong> <code>wget https://dev.mysql.com/get/Downloads/MySQL-8.0/mysql-8.0.21-linux-glibc2.12-x86_64.tar.xz</code></p><p><strong>解压mysql</strong> <code>tar xvJf mysql-8.0.21-linux-glibc2.12-x86_64.tar.xz</code></p><p><strong>重命名文件夹</strong> （重命名为MySQL） <code>mv mysql-8.0.21-linux-glibc2.12-x86_64 mysql</code></p><p><strong>/usr/local/mysql 目录下创建data文件夹 存储文件</strong> <code>mkdir data</code></p><p><strong>创建用户组以及用户和密码</strong> <code>groupadd mysql</code> <code>useradd -g mysql mysql</code></p><p><strong>授权用户 改变mysql目录权限</strong> <code>chown -R mysql.mysql /usr/local/mysql</code></p><p><strong>数据库初始化</strong> <code>./bin/mysqld --user=mysql --basedir=/usr/local/mysql --datadir=/usr/local/mysql/data --initialize</code> 得到临时密码，要记住，后面修改数据库密码要用到</p><p><strong>修改my.cnf文件</strong> <code>vi /etc/my.cnf</code> 内容如下所示</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>[mysqld]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>执行 使密码生效</strong> <code>flush privileges</code></p><p><strong>设置mysql远程登录</strong></p><p>1）切换数据库，使用use mysql;命令。</p><p>2）修改mysql库中host值，使用update user set host=&#39;%&#39; where user=&#39;root&#39; limit 1;命令。</p><p>3）刷新mysql权限，使用flush privileges;命令。</p><p>navicat连接虚拟机的MySQL连不上，查看打开修改虚拟机的端口</p>`,36),A={href:"https://blog.csdn.net/weixin_49015210/article/details/117748687",target:"_blank",rel:"noopener noreferrer"},N=n("p",null,[s("服务器上指定端口号 java -jar jar包文件名 "),n("strong",null,"--server.port=8085"),s(" 运行jar包时，要开启端口号")],-1),L=n("p",null,"输入命令然后回车 /sbin/iptables -I INPUT -p tcp --dport 8085 -j ACCEPT",-1),E=n("p",null,"再次输入 iptables -vnL|grep 8085 回车即可看到8085端口状态信息",-1),O=n("p",null,"当端口都打开后，用postman测试接口，成功返回数据。",-1),z=n("p",null,"1.使用 jar 命令启动SpringBoot工程时可以使用临时属性替换配置文件中的属性 2.临时属性添加方式：java -jar 工程名.jar --属性名=值 3.多个临时属性之间使用空格分隔 4.临时属性必须是当前boot工程支持的属性，否则设置无效",-1),Q=n("h3",{id:"扩展linux安装redis",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#扩展linux安装redis","aria-hidden":"true"},"#"),s(" 扩展linux安装redis")],-1),V=n("br",null,null,-1),U={href:"https://download.redis.io/releases/",target:"_blank",rel:"noopener noreferrer"},W=n("p",null,"（注意下载版本，有的版本下载make报错）",-1),G=n("p",null,"2.解压安装包，命令：tar -zxvf redis-4.0.0.tar.gz -C /usr/local 3.安装Redis的依赖环境gcc,命令：yum install gcc-c++ 4.进入/usr/local/redis-4.0.0,进行编译，命令：make 5.进入redis的src目录，进行安装，命令：make install",-1),F=n("p",null,"Linux中redis服务启动，可以使用redis-server,默认端口号为6379 ./redis.server",-1),H=n("p",null,"Ctrl+C停止Redis服务",-1),J=n("p",null,"启动redis客户端 ./redis-cli （命令keys * 查看所有数据 ）",-1),Y=n("h3",{id:"扩展linux安装jdk",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#扩展linux安装jdk","aria-hidden":"true"},"#"),s(" 扩展linux安装jdk")],-1),K={href:"https://blog.csdn.net/m0_50217781/article/details/112414571",target:"_blank",rel:"noopener noreferrer"},X={href:"https://so.csdn.net/so/search?q=openjdk&spm=1001.2101.3001.7020",target:"_blank",rel:"noopener noreferrer"},$={href:"https://so.csdn.net/so/search?q=version&spm=1001.2101.3001.7020",target:"_blank",rel:"noopener noreferrer"},Z=n("h3",{id:"linux下打开对外开放端口号",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#linux下打开对外开放端口号","aria-hidden":"true"},"#"),s(" linux下打开对外开放端口号")],-1),nn={href:"https://blog.csdn.net/laidanlove250/article/details/97667113",target:"_blank",rel:"noopener noreferrer"},sn=t(`<h2 id="临时属性设置-开发环境" tabindex="-1"><a class="header-anchor" href="#临时属性设置-开发环境" aria-hidden="true">#</a> 临时属性设置（开发环境）</h2><p>通过编程形式带参数启动SpringBoot程序，为程序添加运行参数</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@SpringBootApplication</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="springboot与maven的多环境兼容" tabindex="-1"><a class="header-anchor" href="#springboot与maven的多环境兼容" aria-hidden="true">#</a> springboot与maven的多环境兼容</h3>`,27),an={href:"https://blog.csdn.net/puzi0315/article/details/127196143",target:"_blank",rel:"noopener noreferrer"},en=t(`<p>1 mave 的 pom.xml 下加入如下环境配置，每个profile配置一个环境变量， activation &gt; activeByDefault 为 true ,代表使用这个环境</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;profiles&gt;
        &lt;profile&gt;
            &lt;id&gt;dev&lt;/id&gt;
            &lt;properties&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3 执行Maven打包指令，并在生成的boot打包文件 .jar文件中查看对应信息</p><p>注意：</p><p>1 当Maven与SpringBoot同时对多环境进行控制时，以Mavn为主，SpringBoot使用@，，@占位符读取Maven.对应的配置属性值 2 基于SpringBoot读取Maveni配置属性的前提下，如果在Idea下测试工程时pom.xml每次更新需要手动compile方可生效</p><h2 id="日志" tabindex="-1"><a class="header-anchor" href="#日志" aria-hidden="true">#</a> 日志</h2><p>日志(log)作用：</p><p>编程期调试代码</p><p>运营期记录信息</p><p>​ 记录日常运营重要信息（峰值流量、平均响应时长…） ​ 记录应用报错信息（错误堆栈） ​ 记录运维过程数据（扩容、宕机、报警…)</p>`,12),tn={href:"https://blog.csdn.net/gjwloveforever/article/details/124774662",target:"_blank",rel:"noopener noreferrer"},ln=t(`<p>日志级别 TRACE:运行堆栈信息，使用率低 DEBUG:程序员调试代码使用 INFO:记录运维过程数据 WARN:记录运维过程报警数据 ERROR:记录错误堆栈信息 FATAL:灾难信息，合并计入ERROR</p><p>1,日志用于记录开发调试与运维过程消息 2,日志的级别共6种，通常使用4种即可，分别是DEBUG,INF0,WARN,ERROR 3,可以通过日志组或代码包的形式进行日志显示级别的控制</p><p>application.yml 日志配置</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">logging</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="热部署-只在开发环境有效" tabindex="-1"><a class="header-anchor" href="#热部署-只在开发环境有效" aria-hidden="true">#</a> 热部署（只在开发环境有效）</h2>`,5),pn={href:"https://blog.csdn.net/lwj_07/article/details/126226074",target:"_blank",rel:"noopener noreferrer"},on=t(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>各种方式一定要加上devtools的依赖（在idea设置也需要引入devtools的依赖）
&lt;dependency&gt;
    &lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="springboot测试用例设置随机数据" tabindex="-1"><a class="header-anchor" href="#springboot测试用例设置随机数据" aria-hidden="true">#</a> SpringBoot测试用例设置随机数据</h3>`,52),cn={href:"https://blog.csdn.net/m0_45877477/article/details/125481585",target:"_blank",rel:"noopener noreferrer"},un=t(`<h2 id="数据层解决方案" tabindex="-1"><a class="header-anchor" href="#数据层解决方案" aria-hidden="true">#</a> 数据层解决方案</h2><p>现有数据层解决方案技术选型 Druid +MyBatis-Plus +MySQL</p><h3 id="内嵌的数据源" tabindex="-1"><a class="header-anchor" href="#内嵌的数据源" aria-hidden="true">#</a> 内嵌的数据源</h3><p>SpringBoot提供了3种内嵌的数据源对象供开发者选择：</p><p>HikariCP:默认内置数据源对象 Tomcat提供DataSource：HikariCP不可用的情况下，且在web环境中，将使用tomcat服务器配置的数据源对象 Commons DBCP:Hikariz不可用，tomcat数据源也不可用，将使用dbcp数据源</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>spring:
  datasource:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="内置持久化解决方案一一jdbctemplate" tabindex="-1"><a class="header-anchor" href="#内置持久化解决方案一一jdbctemplate" aria-hidden="true">#</a> 内置持久化解决方案一一JdbcTemplate</h3>`,7),dn={href:"https://www.imooc.com/article/46879",target:"_blank",rel:"noopener noreferrer"},rn=t('<h3 id="内嵌数据库" tabindex="-1"><a class="header-anchor" href="#内嵌数据库" aria-hidden="true">#</a> 内嵌数据库</h3><p>SpringBoot提供了3种内嵌数据库供开发者选择，提高开发测试效率 H2，HSQL，Derby</p><h3 id="nosql" tabindex="-1"><a class="header-anchor" href="#nosql" aria-hidden="true">#</a> NoSQL</h3><p>市面上常见的NoSQL解决方案 Redis，Mongo，ES</p><h4 id="redis" tabindex="-1"><a class="header-anchor" href="#redis" aria-hidden="true">#</a> Redis</h4><p>Redis是一款key-value存储结构的内存级NoSQL数据库 支持多种数据存储格式 支持持久化 支持集群</p><h5 id="springboot整合redis客户端" tabindex="-1"><a class="header-anchor" href="#springboot整合redis客户端" aria-hidden="true">#</a> <strong>springBoot整合redis</strong>客户端</h5>',7),vn={href:"https://blog.csdn.net/lwj_07/article/details/126265935",target:"_blank",rel:"noopener noreferrer"},kn={href:"https://blog.csdn.net/weixin_59654772/article/details/125692784",target:"_blank",rel:"noopener noreferrer"},mn=t(`<p>依赖：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>        &lt;dependency&gt;
            &lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="jedis" tabindex="-1"><a class="header-anchor" href="#jedis" aria-hidden="true">#</a> jedis</h5>`,11),bn={href:"https://blog.csdn.net/I_r_o_n_M_a_n/article/details/122685882",target:"_blank",rel:"noopener noreferrer"},gn=n("p",null,"lettcus与jedis区别 jedis连接Redis.服务器是直连模式，当多线程模式下使用jedis会存在线程安全问题，解决方案可以通过配置连接池使每个连接专用，这样整体性能就大受影响。 lettcus基于Netty框架进行与Redis服务器连接，底层设计中采用StatefulRedisConnection。StatefulRedisConnection自身是线程安全的，可以保障并发访问安全问题，所以一个连接可以被多线程复用。当然lettcus也支持多连接实例一起工作。",-1),hn=n("h4",{id:"mongodb",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#mongodb","aria-hidden":"true"},"#"),s(" MongoDB")],-1),yn=n("p",null,"MongoDB是一个开源、高性能、无模式的文档型数据库。NoSQL数据库产品中的一种，是最像关系型数据库的非 关系型数据库",-1),fn=n("p",null,"MongoDB数据库的常用命令",-1),xn={href:"https://blog.csdn.net/qq_55648724/article/details/128171457",target:"_blank",rel:"noopener noreferrer"},Sn=n("p",null,"springBoot整合 mongoDB",-1),_n={href:"https://blog.csdn.net/weixin_47343544/article/details/127175205",target:"_blank",rel:"noopener noreferrer"},wn={href:"https://cloud.tencent.com/developer/article/2245018",target:"_blank",rel:"noopener noreferrer"},qn=t(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;!-- 引入mongodb--&gt;
        &lt;dependency&gt;
            &lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="elasticsearch-es" tabindex="-1"><a class="header-anchor" href="#elasticsearch-es" aria-hidden="true">#</a> Elasticsearch (ES)</h4><p>Elasticsearch是一个分布式全文搜索引擎</p>`,4),Bn={href:"https://www.elastic.co/cn/downloads/elasticsearch",target:"_blank",rel:"noopener noreferrer"},In={href:"https://blog.csdn.net/ganquanzhong/article/details/108633025",target:"_blank",rel:"noopener noreferrer"},jn=t(`<h2 id="整合第三方数据" tabindex="-1"><a class="header-anchor" href="#整合第三方数据" aria-hidden="true">#</a> 整合第三方数据</h2><h3 id="缓存" tabindex="-1"><a class="header-anchor" href="#缓存" aria-hidden="true">#</a> 缓存</h3><p>缓存是一种介于数据永久存储介质与数据应用之间的数据临时存储介质</p><p>使用缓存可以有效的减少低速数据读取过程的次数（例如磁IO），提高系统性能 缓存不仅可以用于提高永久性存储介质的数据读取效率，还可以提供临时的数据存储空间</p><p>//测试缓存</p><p>msgService (interface)</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">MsgService</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在不影响方法执行的情况下更新缓存时用CachePut</p><p>@CachePut(value=&quot;cacheSpace&quot;,key=&quot;#id&quot;)</p><p>不推荐将 @Cacheable 和 @CachePut 注解到同一个方法。</p><p>整合其他的缓存技术</p>`,22),Mn={href:"https://blog.csdn.net/Learning_xzj/article/details/125510872",target:"_blank",rel:"noopener noreferrer"},Dn={href:"https://blog.csdn.net/weixin_44299027/article/details/125559446",target:"_blank",rel:"noopener noreferrer"},Tn={href:"https://gitee.com/ld/J2Cache",target:"_blank",rel:"noopener noreferrer"},Pn=t(`<h2 id="任务" tabindex="-1"><a class="header-anchor" href="#任务" aria-hidden="true">#</a> 任务</h2><h3 id="定时任务" tabindex="-1"><a class="header-anchor" href="#定时任务" aria-hidden="true">#</a> 定时任务</h3><p>市面上流行的定时任务技术：Quartz ，Spring Task</p><p>springboot整合Quartz</p><p>相关概念： 工作（job):用于定义具体执行的工作 工作明细（JobDetail):用于描述定时工作相关的信息 触发器(Trigger):用于描述触发工作的规则，通常使用cron表达式定义调度规则 调度器(Scheduler):描述了工作明细与触发器的对应关系</p><h2 id="springboot-项目常用maven配置" tabindex="-1"><a class="header-anchor" href="#springboot-项目常用maven配置" aria-hidden="true">#</a> springBoot 项目常用maven配置</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;
...
reggie:
  #  指定上传文件暂存的位置
  path: D:\\img\\
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9);function Rn(Cn,An){const a=o("ExternalLinkIcon");return l(),p("div",null,[u,n("p",null,[n("a",d,[s("IDEA最右侧栏的Maven窗口不见了怎么调出来-百度经验 (baidu.com)"),e(a)]),s(),r]),v,n("p",null,[n("a",k,[s("https://blog.csdn.net/weixin_43785284/article/details/122015400"),e(a)])]),m,n("p",null,[n("a",b,[s("https://blog.csdn.net/m0_67391121/article/details/126020133"),e(a)])]),g,n("p",null,[n("a",h,[s("(210条消息) MAVEN:打包报错 Failed to execute goal org.apache.maven.plugins:maven-compiler-plugin:3.1:compile_Int_Xu的博客-CSDN博客"),e(a)])]),y,n("p",null,[n("a",f,[s("(227条消息) jar包在linux上持续运行及终止运行的命令_linux 停止持久运行_羊糕的博客-CSDN博客"),e(a)])]),n("p",null,[n("a",x,[s("(227条消息) Linux 解决nohup: 忽略输入并把输出追加到“nohup.out“和nohup: 忽略输入重定向错误到标准输出端_千与千与千的博客-CSDN博客"),e(a)])]),S,n("p",null,[s("VIM中常用命令 "),n("a",_,[s("https://blog.csdn.net/feosun/article/details/73196299"),e(a)])]),w,q,B,n("p",null,[n("a",I,[s("(210条消息) linux 安装mysql8.0 超详细图文教程__亮亮同學的博客-CSDN博客"),e(a)])]),n("p",null,[s("安装mysql，进行初始化时失败报错 ： "),n("a",j,[s(" 初始化Mysql报错：初始化数据库显示libaio.so.1_兔飞小朋友的博客-CSDN博客"),e(a)])]),n("p",null,[s("报错：log-error set to '/var/log/mariadb/mariadb.log', however file don't exists. Create writable for user 'mysql'. "),n("a",M,[s("(219条消息) Linux安装MySQL时候出现log-error set to '/var/log/mariadb/mariadb.log', however file don't exists._BertonYip的博客-CSDN博客"),e(a)])]),D,n("p",null,[n("a",T,[s("(219条消息) Mysql 启动报错解析：Starting MySQL.. ERROR! The server quit without updating PID file (/usr/local/mysql/dat_清风的BLOG的博客-CSDN博客"),e(a)])]),n("p",null,[n("a",P,[s("Linux 安装 MySQL 8.0.26 超详细图文步骤 - yoodb - 博客园 (cnblogs.com)"),e(a)]),s(" (实测有效)")]),n("p",null,[n("a",R,[s("(210条消息) Linux怎样到切换到超级用户_linux超级用户权限怎么打开_bo_无问西东的博客-CSDN博客"),e(a)])]),C,n("p",null,[n("a",A,[s("(210条消息) 05.navicat连接不上虚拟机内的mysql_navicat连不上虚拟机中的mysql_weixin_49015210的博客-CSDN博客"),e(a)])]),N,L,E,O,z,Q,n("p",null,[s("Redis下载与安装"),V,s(" 在Linux系统安装Redis步骤： 1.将Redis安装包上传到Linux 下载地址("),n("a",U,[s("https://download.redis.io/releases/"),e(a)]),s(")")]),W,G,F,H,J,Y,n("p",null,[n("a",K,[s("(227条消息) linux 安装jdk 两种方法：手动安装 和yum安装：_阿尔卑斯狼__的博客-CSDN博客"),e(a)])]),n("p",null,[s("yum install -y java-1.8.0-"),n("a",X,[s("openjdk"),e(a)]),s(".x86_64")]),n("p",null,[s("查看 java -"),n("a",$,[s("version"),e(a)])]),Z,n("p",null,[n("a",nn,[s("(227条消息) linux下打开对外开放端口号_linux开通端口_laidanlove250的博客-CSDN博客"),e(a)])]),sn,n("p",null,[n("a",an,[s("(214条消息) springboot与maven的多环境兼容解决方案_springboot兼容pom_沐雪架构师的博客-CSDN博客"),e(a)])]),en,n("p",null,[n("a",tn,[s("(214条消息) SpringBoot的日志_springboot 日志_威少总冠军的博客-CSDN博客"),e(a)])]),ln,n("p",null,[n("a",pn,[s("(214条消息) springboot实现热部署_springboot热部署_lwj_07的博客-CSDN博客"),e(a)])]),on,n("p",null,[n("a",cn,[s("(215条消息) SpringBoot测试用例设置随机数据_springboot生成随机id_梨轻巧的博客-CSDN博客"),e(a)])]),un,n("p",null,[n("a",dn,[s("SpringBoot使用JdbcTemplate_慕课手记 (imooc.com)"),e(a)])]),rn,n("p",null,[s("参考： "),n("a",vn,[s("(215条消息) springboot整合redis_springboot redis_lwj_07的博客-CSDN博客"),e(a)])]),n("p",null,[s("​ "),n("a",kn,[s("(215条消息) 如何用SpringBoot整合Redis（详细讲解~）_我是一棵卷心菜的博客-CSDN博客"),e(a)])]),mn,n("p",null,[n("a",bn,[s("(216条消息) Redis 基础 Jedis -- Jedis（Java程序操作Redis的工具）_CodeJiao的博客-CSDN博客"),e(a)])]),gn,hn,yn,fn,n("p",null,[n("a",xn,[s("(216条消息) MongoDB数据库的常用命令_mongodb数据库命令_勤奋上进的兔子的博客-CSDN博客"),e(a)])]),Sn,n("p",null,[n("a",_n,[s("(216条消息) 《SpringBoot篇》15.SpringBoot整合MongoDB超详细教程（包括安装教程）_springboot mongodb_陈老老老板的博客-CSDN博客"),e(a)])]),n("p",null,[n("a",wn,[s("全面学习MongoDB，在Spring Boot项目中整合 MongoDB-腾讯云开发者社区-腾讯云 (tencent.com)"),e(a)])]),qn,n("p",null,[s("下载： "),n("a",Bn,[s("Download Elasticsearch | Elastic"),e(a)])]),n("p",null,[s("文档参考： "),n("a",In,[s("(217条消息) ElasticSearch使用教程、设计到实战_ForFuture Code的博客-CSDN博客"),e(a)])]),jn,n("p",null,[n("a",Mn,[s("(218条消息) 【SpringBoot整合缓存】-----Redis缓存篇_springboot redis缓存_潮浪之巅的博客-CSDN博客"),e(a)]),s(),n("a",Dn,[s("(218条消息) 【JetCache】JetCache的使用方法与步骤_No8g攻城狮的博客-CSDN博客"),e(a)])]),n("p",null,[n("a",Tn,[s("J2Cache: Java 两级缓存框架，可以让应用支持两级缓存框架 ehcache(Caffeine) + redis 。避免完全使用独立缓存系统所带来的网络IO开销问题 (gitee.com)"),e(a)])]),Pn])}const En=i(c,[["render",Rn],["__file","spring-boot.html.vue"]]);export{En as default};
