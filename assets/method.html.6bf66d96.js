import{_ as l}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as a,c as t,a as e,b as n,d as s,f as d,r}from"./app.40785ba7.js";const v="/blog/../../.vuepress/public/vscodeTwoSearch.png",o={},c=d(`<h1 id="工作问题及解决方法" tabindex="-1"><a class="header-anchor" href="#工作问题及解决方法" aria-hidden="true">#</a> 工作问题及解决方法</h1><h2 id="后端返回文件流-文档流-如何下载" tabindex="-1"><a class="header-anchor" href="#后端返回文件流-文档流-如何下载" aria-hidden="true">#</a> 后端返回文件流(文档流)如何下载</h2><p>例子：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 导出指定字段Excel列表
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,13);function x(_,q){const i=r("ExternalLinkIcon");return a(),t("div",null,[c,e("p",null,[n("对于blob可点击 "),e("a",u,[n("JS中的Blob对象 - 简书 (jianshu.com)"),s(i)])]),e("p",null,[e("a",m,[n("JavaScript 中 Blob 对象 - 掘金 (juejin.cn)"),s(i)]),n(" 文章查看")]),b,e("p",null,[e("a",p,[n("(115条消息) vue-判断设备是手机端还是pc端，进行两套页面样式的编写_hh3167253066的博客-CSDN博客_vue判断手机端还是pc端"),s(i)])]),g,e("p",null,[e("a",h,[n("(115条消息) vue项目PC端移动端适配方案_coderDragon的博客-CSDN博客_vue项目pc端和移动端适配"),s(i)])]),f])}const w=l(o,[["render",x],["__file","method.html.vue"]]);export{w as default};
