import{_ as p}from"./_plugin-vue_export-helper.cdc0426e.js";import{o,c,a as n,b as s,e as t,f as e,r as i}from"./app.3ddff213.js";const l={},u=e(`<h1 id="vue" tabindex="-1"><a class="header-anchor" href="#vue" aria-hidden="true">#</a> vue</h1><h2 id="vue项目打包一键去掉所有console-log" tabindex="-1"><a class="header-anchor" href="#vue项目打包一键去掉所有console-log" aria-hidden="true">#</a> vue项目打包一键去掉所有console.log</h2><p>在Vue项目中，可以通过使用babel插件来去除所有的console.log语句。以下是一种常用的方法：</p><ol><li>安装babel插件：babel-plugin-transform-remove-console</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install babel-plugin-transform-remove-console --save-dev
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>除了前端配置代理之外，后台也要配置跨域，否则请求不到，后台跨域解决可以参考下面的文章</p>`,40),X={href:"https://juejin.cn/post/7229139006080253989",target:"_blank",rel:"noopener noreferrer"},W={href:"https://blog.csdn.net/qq_40185480/article/details/110926273",target:"_blank",rel:"noopener noreferrer"},G=n("h4",{id:"配置pinia",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#配置pinia","aria-hidden":"true"},"#"),s(" 配置pinia")],-1),Y={href:"https://mp.weixin.qq.com/s/vxjPAuwQjLd75nt4RPCR8A",target:"_blank",rel:"noopener noreferrer"},K=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install pinia
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="aliplayer阿里播放器" tabindex="-1"><a class="header-anchor" href="#aliplayer阿里播放器" aria-hidden="true">#</a> Aliplayer阿里播放器</h4>`,5),hn={href:"https://player.alicdn.com/aliplayer/presentation/index.html?type=cover",target:"_blank",rel:"noopener noreferrer"},fn=n("h4",{id:"西瓜播放器-可音乐播放",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#西瓜播放器-可音乐播放","aria-hidden":"true"},"#"),s(" 西瓜播放器（可音乐播放）")],-1),yn={href:"https://v2.h5player.bytedance.com/gettingStarted/",target:"_blank",rel:"noopener noreferrer"},qn={href:"https://blog.csdn.net/lianghecai52171314/article/details/116812079",target:"_blank",rel:"noopener noreferrer"},xn=n("p",null,"只需三步：安装、DOM占位、实例化即可完成播放器的使用。",-1),wn=n("h4",{id:"mui-player-多端可用-效果好",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#mui-player-多端可用-效果好","aria-hidden":"true"},"#"),s(" Mui Player(多端可用，效果好)")],-1),_n={href:"https://muiplayer.js.org/zh/",target:"_blank",rel:"noopener noreferrer"},jn={href:"https://blog.csdn.net/linx_i/article/details/124190001",target:"_blank",rel:"noopener noreferrer"},Sn=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i mui-player --save
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在vue文件中使用Card组件，如可显示正常，则组件库创建成功。</p><h2 id="如何写一个属于自己的vue3组件库" tabindex="-1"><a class="header-anchor" href="#如何写一个属于自己的vue3组件库" aria-hidden="true">#</a> 如何写一个属于自己的Vue3组件库</h2>`,12),Rn={href:"https://juejin.cn/post/7207094325897297957",target:"_blank",rel:"noopener noreferrer"},Ln=n("p",null,"pnpm 修改默认安装包的仓库位置 pnpm config set store-dir E:/pnpmPackage",-1),Tn=n("p",null,"使用pnpm的项目最好不要有中文路径，否则下载依赖可能有报错",-1),Bn={href:"https://mp.weixin.qq.com/s/jvLAFzwJPlA5J-iNJSblag",target:"_blank",rel:"noopener noreferrer"},Nn={href:"https://juejin.cn/post/7255514764754894907?searchId=20231030164149D848293E31B857FECA86#heading-6",target:"_blank",rel:"noopener noreferrer"},Hn={href:"https://juejin.cn/post/7285373518836826167",target:"_blank",rel:"noopener noreferrer"},In={href:"https://juejin.cn/post/7211521650252398649",target:"_blank",rel:"noopener noreferrer"},Un={href:"https://juejin.cn/user/78820567165575/posts",target:"_blank",rel:"noopener noreferrer"},On={href:"https://github.com/yuanwen0327/learn-create-compoents-lib",target:"_blank",rel:"noopener noreferrer"},Jn={href:"https://juejin.cn/post/6987735091925483551#heading-14",target:"_blank",rel:"noopener noreferrer"},$n={href:"https://juejin.cn/post/7241514309717639228",target:"_blank",rel:"noopener noreferrer"},Xn={href:"https://juejin.cn/post/7117897323014783013",target:"_blank",rel:"noopener noreferrer"},Wn=e(`<h2 id="vue3实现-v-model-封装组件" tabindex="-1"><a class="header-anchor" href="#vue3实现-v-model-封装组件" aria-hidden="true">#</a> vue3实现 v-model (封装组件)</h2><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code>// 父组件     v-model 等于 :modelValue=&quot;inContent&quot; @update:modelValue=&quot;inContent = $event&quot;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vue3-4版本简化了v-model的实现" tabindex="-1"><a class="header-anchor" href="#vue3-4版本简化了v-model的实现" aria-hidden="true">#</a> vue3.4版本简化了v-model的实现</h3><p><code>通过 defineModel 来实现</code></p>`,5),Gn={href:"https://cn.vuejs.org/guide/components/v-model#basic-usage",target:"_blank",rel:"noopener noreferrer"},Yn=n("h2",{id:"vue3基本使用-用setup-语法糖",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue3基本使用-用setup-语法糖","aria-hidden":"true"},"#"),s(" vue3基本使用（用setup 语法糖）")],-1),Kn={href:"https://cn.vuejs.org/guide/introduction.html",target:"_blank",rel:"noopener noreferrer"},Qn={href:"https://juejin.cn/post/6897030228867022856",target:"_blank",rel:"noopener noreferrer"},Zn=e(`<h3 id="计算属性" tabindex="-1"><a class="header-anchor" href="#计算属性" aria-hidden="true">#</a> 计算属性</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> ref<span class="token punctuation">,</span>reactive<span class="token punctuation">,</span> computed <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;vue&#39;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="异步状态示例" tabindex="-1"><a class="header-anchor" href="#异步状态示例" aria-hidden="true">#</a> 异步状态示例</h4><p>在做异步数据请求时，我们常常需要处理不同的状态：加载中、加载成功和加载失败。</p><p><strong>接收响应式状态</strong></p><p><code>useFetch()</code> 接收一个静态 URL 字符串作为输入——因此它只会执行一次 fetch 并且就此结束。如果我们想要在 URL 改变时重新 fetch 呢？为了实现这一点，我们需要将响应式状态传入组合式函数，并让它基于传入的状态来创建执行操作的侦听器。</p><p>举例来说，<code>useFetch()</code> 应该能够接收一个 ref：或者接收一个 getter 函数：</p>`,33),es={href:"https://cn.vuejs.org/api/reactivity-core.html#watcheffect",target:"_blank",rel:"noopener noreferrer"},ps=n("code",null,"watchEffect()",-1),os={href:"https://cn.vuejs.org/api/reactivity-utilities.html#tovalue",target:"_blank",rel:"noopener noreferrer"},cs=n("code",null,"toValue()",-1),is=n("code",null,"toValue()",-1),ls={href:"https://cn.vuejs.org/api/reactivity-utilities.html#unref",target:"_blank",rel:"noopener noreferrer"},us=n("code",null,"unref()",-1),rs=e("<p>注意 <code>toValue(url)</code> 是在 <code>watchEffect</code> 回调函数的<strong>内部</strong>调用的。这确保了在 <code>toValue()</code> 规范化期间访问的任何响应式依赖项都会被侦听器跟踪。</p><p>这个版本的 <code>useFetch()</code> 现在能接收静态 URL 字符串、ref 和 getter，使其更加灵活。watch effect 会立即运行，并且会跟踪 <code>toValue(url)</code> 期间访问的任何依赖项。如果没有跟踪到依赖项（例如 url 已经是字符串），则 effect 只会运行一次；否则，它将在跟踪到的任何依赖项更改时重新运行。</p><p><strong>输入参数</strong></p>",3),ds={href:"https://cn.vuejs.org/api/reactivity-utilities.html#tovalue",target:"_blank",rel:"noopener noreferrer"},ks=n("code",null,"toValue()",-1),vs=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>import { toValue } from &#39;vue&#39;
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="getcurrentinstance" tabindex="-1"><a class="header-anchor" href="#getcurrentinstance" aria-hidden="true">#</a> getCurrentInstance</h3><p>在Vue3中，getCurrentInstance() 可以用来获取<strong>当前组件实例</strong></p>`,5),gs={href:"https://blog.csdn.net/Zaralike/article/details/125870367",target:"_blank",rel:"noopener noreferrer"},hs=n("h2",{id:"vite-vue-配置",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vite-vue-配置","aria-hidden":"true"},"#"),s(" Vite vue 配置")],-1),fs=n("h3",{id:"vite打包视图分析-rollup-plugin-visualizer",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vite打包视图分析-rollup-plugin-visualizer","aria-hidden":"true"},"#"),s(" vite打包视图分析(rollup-plugin-visualizer)")],-1),ys={href:"https://juejin.cn/post/7159410085460983839",target:"_blank",rel:"noopener noreferrer"},qs=e(`<p>分析项目中的js文件大小和引用情况，基于展示的依赖项 js 大小对前端项目做优化处理</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install --save-dev rollup-plugin-visualizer
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vite-项目优化-配置-cdn-服务" tabindex="-1"><a class="header-anchor" href="#vite-项目优化-配置-cdn-服务" aria-hidden="true">#</a> vite 项目优化 配置 CDN 服务</h3><p>配置cdn加速，减小打包体积</p>`,6),xs={href:"https://juejin.cn/post/7248118049584332856",target:"_blank",rel:"noopener noreferrer"},ws=n("h2",{id:"vue和react对比学习之路由角色权限",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue和react对比学习之路由角色权限","aria-hidden":"true"},"#"),s(" Vue和React对比学习之路由角色权限")],-1),_s={href:"https://juejin.cn/post/7250386282400596029#heading-23",target:"_blank",rel:"noopener noreferrer"},js=n("h2",{id:"如何在vue-js中创建模态框-弹出框",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#如何在vue-js中创建模态框-弹出框","aria-hidden":"true"},"#"),s(" 如何在Vue.js中创建模态框(弹出框)")],-1),Ss={href:"https://mp.weixin.qq.com/s/MddofJ10zYXtWAeGa5Z_Cw",target:"_blank",rel:"noopener noreferrer"},Vs=e(`<h2 id="简易组件" tabindex="-1"><a class="header-anchor" href="#简易组件" aria-hidden="true">#</a> 简易组件</h2><h3 id="移动端点击侧边展示导航的组件" tabindex="-1"><a class="header-anchor" href="#移动端点击侧边展示导航的组件" aria-hidden="true">#</a> 移动端点击侧边展示导航的组件</h3><p>用的ant-design-vue的 a-drawer</p><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue3使用jsx" tabindex="-1"><a class="header-anchor" href="#vue3使用jsx" aria-hidden="true">#</a> vue3使用jsx</h2>`,7),Ps={href:"https://juejin.cn/post/7213356423810924581",target:"_blank",rel:"noopener noreferrer"},Cs={href:"https://juejin.cn/post/7151950058501373989?from=search-suggest",target:"_blank",rel:"noopener noreferrer"},Es={href:"https://juejin.cn/post/7261604498924961829",target:"_blank",rel:"noopener noreferrer"},Ms={href:"https://zhuanlan.zhihu.com/p/375527289",target:"_blank",rel:"noopener noreferrer"},As={href:"https://juejin.cn/post/7272308621710213161",target:"_blank",rel:"noopener noreferrer"},zs={href:"https://mp.weixin.qq.com/s/DOBgFqHoupBcoRLngHFNUw",target:"_blank",rel:"noopener noreferrer"},Ds=e(`<p>想在项目中使用 JSX,我们需要安装一个插件<code>@vitejs/plugin-vue-jsx</code>,这个插件可以让我们在项目中使用 JSX/TSX</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i @vitejs/plugin-vue-jsx -D
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vue使用tailwindcss" tabindex="-1"><a class="header-anchor" href="#vue使用tailwindcss" aria-hidden="true">#</a> vue使用Tailwindcss</h2>`,12),Fs={href:"https://www.tailwindcss.cn/docs/width",target:"_blank",rel:"noopener noreferrer"},Rs={href:"https://juejin.cn/post/7042901516499288077",target:"_blank",rel:"noopener noreferrer"},Ls=n("p",null,"当有不知道的类可以直接到官网文档查看",-1),Ts={href:"https://juejin.cn/post/7228488937505030199",target:"_blank",rel:"noopener noreferrer"},Bs={href:"https://juejin.cn/post/7216990794942201913#heading-5",target:"_blank",rel:"noopener noreferrer"},Ns=e(`<p>安装依赖</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i -D tailwindcss postcss autoprefixer
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>vue3 同时使用 element plus 和 Tailwindcss 可能会出现样式冲突（例如el-button显示异常），此时一种解决方法是先引入 Tailwindcss ，然后再引入 element plus 的样式文件</strong></p><p>vscode 安装 Tailwind CSS IntelliSense 插件 ,没有提示功能，通过如下解决：</p><p>1 vscode点击设置</p><p>2 搜索 <code>editor.quickSuggestions</code></p><p>3 strings 改为 on</p><h2 id="权限" tabindex="-1"><a class="header-anchor" href="#权限" aria-hidden="true">#</a> 权限</h2><h3 id="按钮级别权限" tabindex="-1"><a class="header-anchor" href="#按钮级别权限" aria-hidden="true">#</a> 按钮级别权限</h3><p>通过自定义指令来实现</p>`,23),Hs={href:"https://juejin.cn/post/7320169878644113408?searchId=20240111091116F28599892BCAA27BF8FD",target:"_blank",rel:"noopener noreferrer"},Is=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>//  按钮权限--显示隐藏控制实现
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="vueuse" tabindex="-1"><a class="header-anchor" href="#vueuse" aria-hidden="true">#</a> vueUse</h2>`,2),Us={href:"https://www.vueusejs.com/guide/",target:"_blank",rel:"noopener noreferrer"},Os=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i @vueuse/core
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="源码-深入了解" tabindex="-1"><a class="header-anchor" href="#源码-深入了解" aria-hidden="true">#</a> 源码（深入了解）</h2>`,5),Js={href:"https://www.bilibili.com/video/BV1d4411v7UX/?vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"};function $s(Xs,Ws){const a=i("ExternalLinkIcon");return o(),c("div",null,[u,n("ul",null,[n("li",null,[n("a",r,[s("Vue CLI官方文档 - Babel配置"),t(a)])]),n("li",null,[n("a",d,[s("babel-plugin-transform-remove-console"),t(a)])])]),k,n("p",null,[n("a",v,[s("vue中修改props传进来的值_使用计算属性更新prop的值-CSDN博客"),t(a)])]),m,n("p",null,[n("a",b,[s("Vue内置组件的component标签-CSDN博客"),t(a)])]),g,n("p",null,[n("a",h,[s("(202条消息) vue实现登录后跳转到之前的页面_longzhoufeng的博客-CSDN博客"),t(a)])]),f,n("p",null,[s("官网： "),n("a",y,[s("安装 | Pinia 中文文档 (web3doc.top)"),t(a)])]),q,n("p",null,[n("a",x,[s("https://juejin.cn/post/6928468842377117709"),t(a)])]),n("p",null,[n("a",w,[s("https://juejin.cn/post/6994337441314242590#heading-15"),t(a)])]),n("p",null,[n("a",_,[s("https://juejin.cn/post/7087100496762109983#heading-16"),t(a)])]),n("p",null,[s("简明易懂："),n("a",j,[s("https://juejin.cn/post/7280007176776204327?searchId=2024011109491811B46B930D323378F7D4"),t(a)])]),S,n("p",null,[n("a",V,[s("https://juejin.cn/post/7078281612013764616#heading-0"),t(a)])]),P,n("p",null,[s("官网："),n("a",C,[s("https://pinia.vuejs.org/zh/introduction.html"),t(a)])]),E,n("p",null,[M,s(" 配套有个插件 "),n("a",A,[s("pinia-plugin-persist"),t(a)]),s("进行数据持久化，否则一刷新就会造成数据丢失")]),z,n("p",null,[s("页面全屏滚动很多用于官网首页，使用的频率还挺高的，此处的代码实现的功能是 鼠标滚动，页面切换，点击键盘的上下键，页面切换。类似效果看 "),n("a",D,[s(" 全屏滚动_jQuery之家-自由分享jQuery、html5、css3的插件库 (htmleaf.com)"),t(a)]),s(" ，以下内容改自 "),n("a",F,[s("vue实现全屏滚动，非fullpage.js-阿里云开发者社区 (aliyun.com)"),t(a)]),s(" 。")]),R,n("p",null,[n("a",L,[s("vue-router路由中对query中的参数进行加密_router 参数加密_前端_小学生的博客-CSDN博客"),t(a)])]),n("p",null,[n("a",T,[s("vue-router中传递的参数进行自动加密显示，组件中获取自动解密 (github.com)"),t(a)])]),B,N,n("p",null,[n("a",H,[s("https://mp.weixin.qq.com/s/pWsntJbJnBip5CbP7HkvFg"),t(a)])]),I,n("p",null,[n("a",U,[s("十分钟搭建 Vite+Vue3 项目模板 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",O,[s("从 0 搭建 Vite 3 + Vue 3 前端工程化项目 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",J,[s("Vue3+Element-plus前端学习笔记-巨长版 (qq.com)"),t(a)])]),$,n("p",null,[n("a",X,[s("SpringBoot 项目解决跨域的几种方案 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[s("（vue3中使用消息提示 "),n("a",W,[s("vue3中使用element-plus调用message_element-plus message_"),t(a)]),s(" ）")]),G,n("p",null,[n("a",Y,[s("Vuex 更好的替代品 Pinia，真香 (qq.com)"),t(a)])]),K,n("p",null,[n("a",Q,[s("Vue图片预览插件v-viewer - 掘金 (juejin.cn)"),t(a)])]),Z,n("p",null,[n("a",nn,[s("Vue 树形结构插件 vue2-org-tree - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",sn,[s("详解树状结构图 vue-org-tree - 知乎 (zhihu.com)"),t(a)])]),an,n("p",null,[n("a",tn,[s("快速开始 | wangEditor"),t(a)]),s(" wangeditor有vue2,vue3,react的版本 "),n("a",en,[s("用于 Vue React | wangEditor"),t(a)])]),n("p",null,[n("a",pn,[s("在vue2中封装一个wangeditor组件_,也可以查看 ruoyi 里面的封装"),t(a)])]),on,n("p",null,[n("a",cn,[s("unplugin-vue-macros(github.com) "),t(a)])]),ln,n("p",null,[n("a",un,[s("几款优秀开源的HTML5 视频播放器 - 体验盒子 - 不再关注网络安全 (uedbox.com)"),t(a)])]),n("h4",rn,[dn,s(),n("a",kn,[s("Vue3VideoPlay（vue3可用,效果好）"),t(a)])]),n("p",null,[n("a",vn,[s("Vue3-video-play视频播放器插件_视频播放插件-CSDN博客"),t(a)])]),mn,n("p",null,[s("解决："),n("a",bn,[s('VUE3+VITE:Failed to resolve entry for package “vue3-video-play“._failed to resolve entry for package "vue3-video-pl-CSDN博客'),t(a)])]),gn,n("p",null,[n("a",hn,[s("阿里云Aliplayer播放器 (alicdn.com)"),t(a)])]),fn,n("p",null,[n("a",yn,[s("西瓜播放器 | 快速上手 (bytedance.com)"),t(a)]),s(),n("a",qn,[s("vue3 集成西瓜视频播放器xgplayer_vue3 xiguaplay-CSDN博客"),t(a)])]),xn,wn,n("p",null,[n("a",_n,[s("MuiPlayer"),t(a)]),s(),n("a",jn,[s("vue + mui-player视频播放器_vue+muiplayer-CSDN博客"),t(a)])]),Sn,n("p",null,[n("a",Vn,[s("b站参考学习视频地址"),t(a)]),s(),n("a",Pn,[s("参考文章 vue组件库的基本开发步骤 "),t(a)])]),Cn,En,Mn,n("p",null,[n("a",An,[s("基于element-ui构建自定义组件库，发布到npm及安装使用，以及生成组件库说明文档 - 知乎 (zhihu.com)"),t(a)])]),zn,n("p",null,[n("a",Dn,[s("图文结合简单易学的 npm 包的发布流程 (qq.com)"),t(a)])]),Fn,n("p",null,[n("a",Rn,[s("pnpm 基本详细使用（安装、卸载、使用） - 掘金 (juejin.cn)"),t(a)])]),Ln,Tn,n("p",null,[n("a",Bn,[s("如何写一个属于自己的Vue3组件库 (qq.com)"),t(a)])]),n("p",null,[n("a",Nn,[s("【前端工程化-组件库】从0-1构建Vue3组件库（打包发布） - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",Hn,[s("前端工程化😼开源项目都在用的【Monorepo】🏋🏿 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",In,[s("如何写一个属于自己的vue3组件库 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[s("参考,可用："),n("a",Un,[s("全肝鸽鸽 的个人主页 - 文章 - 掘金 (juejin.cn)"),t(a)]),s(),n("a",On,[s("GitHub - yuanwen0327/learn-create-compoents-lib"),t(a)])]),n("p",null,[n("a",Jn,[s("一文读懂TS的(.d.ts)文件 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",$n,[s("从0到1搭建自己的组件库，详解附源码 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",Xn,[s("Monorepo pnpm模式管理多个web项目（Vue3） - 掘金 (juejin.cn)"),t(a)])]),Wn,n("p",null,[s("官网查看："),n("a",Gn,[s("组件 v-model | Vue.js (vuejs.org)"),t(a)])]),Yn,n("p",null,[n("a",Kn,[s("https://cn.vuejs.org/guide/introduction.html"),t(a)])]),n("p",null,[n("a",Qn,[s("快速使用Vue3最新的15个常用API - 掘金 (juejin.cn)"),t(a)])]),Zn,n("p",null,[s("用 "),n("a",ns,[ss,s(" 函数"),t(a)]),s(" 来简化上面的代码。"),as,s(" 允许我们自动跟踪回调的响应式依赖")]),ts,n("p",null,[s("我们可以用 "),n("a",es,[ps,t(a)]),s(" 和 "),n("a",os,[cs,t(a)]),s(" API 来重构我们现有的实现：")]),n("p",null,[is,s(" 是一个在 3.3 版本中新增的 API。它的设计目的是将 ref 或 getter 规范化为值。如果参数是 ref，它会返回 ref 的值；如果参数是函数，它会调用函数并返回其返回值。否则，它会原样返回参数。它的工作方式类似于 "),n("a",ls,[us,t(a)]),s("，但对函数有特殊处理。")]),rs,n("p",null,[s("即便不依赖于 ref 或 getter 的响应性，组合式函数也可以接收它们作为参数。如果你正在编写一个可能被其他开发者使用的组合式函数，最好处理一下输入参数是 ref 或 getter 而非原始值的情况。可以利用 "),n("a",ds,[ks,t(a)]),s(" 工具函数来实现：")]),vs,n("p",null,[n("a",ms,[s("示例地址"),t(a)])]),bs,n("p",null,[n("a",gs,[s("Vue3组合式API：getCurrentInstance_vue3 getcurrentinstance-CSDN博客"),t(a)])]),hs,fs,n("p",null,[n("a",ys,[s("vue3+vite打包视图分析(rollup-plugin-visualizer)+gzip - 掘金 (juejin.cn)"),t(a)])]),qs,n("p",null,[n("a",xs,[s("【vite 4.3 + vue 3.2 项目优化实战】配置 CDN 服务 - 掘金 (juejin.cn)"),t(a)])]),ws,n("p",null,[n("a",_s,[s("Vue和React对比学习之路由角色权限(页面、按钮权限控制) - 掘金 (juejin.cn)"),t(a)])]),js,n("p",null,[n("a",Ss,[s("如何在Vue.js中创建模态框(弹出框) (qq.com)"),t(a)])]),Vs,n("p",null,[n("a",Ps,[s("如何在 vue3 中使用 jsx/tsx? - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",Cs,[s("在 vue3 中优雅的使用 jsx/tsx - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",Es,[s("在Vue3中利用JSX+函数式组件做到更好的代码复用 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",Ms,[s("JSX 设置样式 - 知乎 (zhihu.com)"),t(a)])]),n("p",null,[n("a",As,[s("万字长文详解 Vue JSX，带你全面拥抱 JSX 特性！-讲述了jsx的优点 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",zs,[s("一起玩转Vue中的JSX：让你一次性掌握它的特性! 微信公众平台 (qq.com)"),t(a)])]),Ds,n("p",null,[s("官方文档： "),n("a",Fs,[s("Width - TailwindCSS中文文档 | TailwindCSS中文网"),t(a)])]),n("p",null,[n("a",Rs,[s("一次就能看懂的Tailwind CSS介绍 - 掘金 (juejin.cn)"),t(a)])]),Ls,n("p",null,[n("a",Ts,[s("在vite-vue3中快速使用Tailwindcss - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",Bs,[s("Vue中使用 Tailwind CSS - 掘金 (juejin.cn)"),t(a)])]),Ns,n("p",null,[n("a",Hs,[s("https://juejin.cn/post/7320169878644113408?searchId=20240111091116F28599892BCAA27BF8FD"),t(a)])]),Is,n("p",null,[n("a",Us,[s("起步 | VueUse中文文档 (vueusejs.com)"),t(a)])]),Os,n("p",null,[n("a",Js,[s("尤雨溪教你写vue 高级vue教程 源码分析 中文字幕翻译完毕_哔哩哔哩_bilibili"),t(a)])])])}const Ks=p(l,[["render",$s],["__file","4.html.vue"]]);export{Ks as default};
