import{_ as p}from"./_plugin-vue_export-helper.cdc0426e.js";import{o,c,a as n,b as s,e as t,f as e,r as i}from"./app.cf785be7.js";const l={},u=n("h1",{id:"知识拓展-electron-qiankun",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#知识拓展-electron-qiankun","aria-hidden":"true"},"#"),s(" 知识拓展(electron,qiankun)")],-1),r=n("h1",{id:"electron",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#electron","aria-hidden":"true"},"#"),s(" electron")],-1),d={href:"https://www.bilibili.com/video/BV1QB4y1F722?p=1&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},k=e(`<h2 id="创建electron项目" tabindex="-1"><a class="header-anchor" href="#创建electron项目" aria-hidden="true">#</a> 创建electron项目</h2><p>1 electron/electron-quick-start 官网示例</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># Clone this repository
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注释掉 src/index.js 的 mainWindow.webContents.openDevTools(); 关闭打开窗口默认打开 devtools</p><h2 id="生命周期" tabindex="-1"><a class="header-anchor" href="#生命周期" aria-hidden="true">#</a> 生命周期</h2>`,9),v={href:"https://www.electronjs.org/zh/docs/latest/api/app#apprequestsingleinstancelockadditionaldata",target:"_blank",rel:"noopener noreferrer"},m=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>*生命周期
ready  应用程序初始化完成
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行yarn make 即可打包程序（很慢，在下载东西）</p>`,5),b={href:"https://blog.csdn.net/michaelxuzhi___/article/details/106568543",target:"_blank",rel:"noopener noreferrer"},g=e(`<p>最好有github加速服务，不然很容易打包失败。</p><p>生成out目录，里面有打包出的文件</p><p>2 （我使用的这种，上面的速度实在太慢）可以下载 electron-builder 依赖，注意 electron-builder 只能放置在 devDependencies 中</p><p>package.json中加入如下命令</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&quot;scripts&quot;: {
        &quot;app:dist&quot;: &quot;electron-builder&quot;
    },
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行 npm run app:dist 执行打包命令 （依然有打包下载文件的速度慢问题，加速才能下载下来）</p><p>生成dist目录，里面有打包好的文件</p><p>3 第一次打包时下载的文件存放在C:\\Users\\张帆\\AppData\\Local\\electron\\Cache目录下</p>`,8),h={href:"https://wwmj.lanzoue.com/b02ef6w8d",target:"_blank",rel:"noopener noreferrer"},y=e(`<h2 id="index-js" tabindex="-1"><a class="header-anchor" href="#index-js" aria-hidden="true">#</a> index.js</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token punctuation">{</span> app<span class="token punctuation">,</span> BrowserWindow <span class="token punctuation">}</span> <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;electron&#39;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
一定要在ready之后执行
 let request = net.request(&#39;https://taobao.com&#39;)
    ...
    request.end()
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="electron-vue-打包报错-不推荐使用" tabindex="-1"><a class="header-anchor" href="#electron-vue-打包报错-不推荐使用" aria-hidden="true">#</a> electron-vue（打包报错，不推荐使用）</h2>`,27),w={href:"https://simulatedgreg.gitbooks.io/electron-vue/content/cn/",target:"_blank",rel:"noopener noreferrer"},f=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># 安装 vue-cli 和 脚手架样板代码
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>1 当运行 npm run dev 报错 Object.fromEntries is not a function electron-vue报错，</p>`,2),q={href:"https://blog.csdn.net/y_k_1_2_3_4/article/details/126479427",target:"_blank",rel:"noopener noreferrer"},x=e(`<p>安装polyfill-object.fromentries，在项目根目录执行命令</p><p>npm <strong>i</strong> polyfill-<strong>object</strong>.fromentries</p><p>在 .electron-vue/dev-client.js 引入</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// const hotClient = require(&#39;webpack-hot-middleware/client?noInfo=true&amp;reload=true&#39;)
import &#39;polyfill-object.fromentries&#39;;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="electron-vue-build-打包的坑" tabindex="-1"><a class="header-anchor" href="#electron-vue-build-打包的坑" aria-hidden="true">#</a> electron-vue build 打包的坑</h2>`,5),_={href:"https://www.jianshu.com/p/55d0e5b6c085",target:"_blank",rel:"noopener noreferrer"},j={href:"https://www.cnblogs.com/leestar54/p/12781591.html#electron-vue%E8%84%9A%E6%89%8B%E6%9E%B6",target:"_blank",rel:"noopener noreferrer"},E=n("p",null,"（打包问题很多）",-1),W=n("h2",{id:"ant-design-vue",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#ant-design-vue","aria-hidden":"true"},"#"),s(" ant design vue")],-1),I=n("p",null,"下载导入 ant-design-vue 报错",-1),M={href:"https://blog.csdn.net/qq_52855464/article/details/126255813",target:"_blank",rel:"noopener noreferrer"},B=e(`<p>原因： <strong>ant- design-vue 版本过高</strong></p><p>卸载当前版本 ： npm uninstall ant-design-vue</p><p>安装先前版本：cnpm install ant-design-vue@1.7.2</p><h2 id="electron解决跨域问题-请求数据" tabindex="-1"><a class="header-anchor" href="#electron解决跨域问题-请求数据" aria-hidden="true">#</a> electron解决跨域问题（请求数据）</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>在electron-vue创建的项目中，在目录src/main/index,js中增加配置
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="搭建vue-electron应用" tabindex="-1"><a class="header-anchor" href="#搭建vue-electron应用" aria-hidden="true">#</a> 搭建vue+Electron应用</h2><p><strong>(搭建electron项目，简单快捷,推荐)</strong></p><p>通过脚手架创建一个vue项目</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> vue create vue-electron 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="electron自定义菜单" tabindex="-1"><a class="header-anchor" href="#electron自定义菜单" aria-hidden="true">#</a> electron自定义菜单</h2>`,18),D={href:"https://juejin.cn/post/7209826725365645369#heading-1",target:"_blank",rel:"noopener noreferrer"},S=n("h3",{id:"顶部菜单栏",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#顶部菜单栏","aria-hidden":"true"},"#"),s(" 顶部菜单栏")],-1),T={href:"https://www.misterma.com/archives/896/",target:"_blank",rel:"noopener noreferrer"},R=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>const win = new BrowserWindow({
        width: 800,
        height: 600,
        frame: true
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>重启electron项目，可以看到菜单栏已变成自定义的了。</p><h3 id="侧边菜单栏" tabindex="-1"><a class="header-anchor" href="#侧边菜单栏" aria-hidden="true">#</a> 侧边菜单栏</h3>`,4),C={href:"https://xie.infoq.cn/article/ba9f61c8506c9b67f6b34de06",target:"_blank",rel:"noopener noreferrer"},A={href:"https://www.electronjs.org/zh/docs/latest/api/menu",target:"_blank",rel:"noopener noreferrer"},V=e(`<p>主进程中background.js/main.js</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">export</span> <span class="token keyword">default</span><span class="token punctuation">{</span>
   ...
   <span class="token comment">//https://developer.mozilla.org/zhCN/docs/Web/API/MediaRecorder/dataavailable_event</span>
          <span class="token keyword">this</span><span class="token punctuation">.</span>recordInstance<span class="token punctuation">.</span><span class="token function-variable function">ondataavailable</span><span class="token operator">=</span><span class="token punctuation">(</span><span class="token parameter">e</span><span class="token punctuation">)</span><span class="token operator">=&gt;</span><span class="token punctuation">{</span>
            console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">.</span>blobSlice<span class="token punctuation">,</span><span class="token string">&#39;1234&#39;</span><span class="token punctuation">,</span><span class="token string">&#39;dataavailable&#39;</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="qiankun-微服务" tabindex="-1"><a class="header-anchor" href="#qiankun-微服务" aria-hidden="true">#</a> qiankun 微服务</h1>`,24),N={href:"https://qiankun.umijs.org/zh/guide/getting-started#%E4%B8%BB%E5%BA%94%E7%94%A8",target:"_blank",rel:"noopener noreferrer"},L={href:"https://juejin.cn/post/7121515637624537119#heading-16",target:"_blank",rel:"noopener noreferrer"},O={href:"https://gitee.com/qiaoba_1/qiankun-demo",target:"_blank",rel:"noopener noreferrer"},P=e(`<h2 id="主应用-vue搭建" tabindex="-1"><a class="header-anchor" href="#主应用-vue搭建" aria-hidden="true">#</a> 主应用（vue搭建）：</h2><p>安装qiankun： npm <strong>i</strong> qiankun -S</p><p>在主应用页面上增加一个 显示子应用页面的容器</p><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>app<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,11),U={href:"https://blog.csdn.net/qq_40259641/article/details/125501246",target:"_blank",rel:"noopener noreferrer"},z=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// const { name } = require(&#39;./package&#39;);
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1);function $(F,H){const a=i("ExternalLinkIcon");return o(),c("div",null,[u,r,n("p",null,[s("学习视频地址："),n("a",d,[s("https://www.bilibili.com/video/BV1QB4y1F722?p=1&vd_source=f25f5a8d75a3a60d5a288f726803ec11"),t(a)])]),k,n("p",null,[s("官网 api "),n("a",v,[s("app | Electron (electronjs.org)"),t(a)])]),m,n("p",null,[s("打包超时可以看这个 "),n("a",b,[s("(195条消息) 解决electron打包时，下载超时导致失败_michaelxuzhi___的博客-CSDN博客"),t(a)])]),g,n("p",null,[s("下载文件为 "),n("a",h,[s("https://wwmj.lanzoue.com/b02ef6w8d"),t(a)]),s(" 密码:7ylu")]),y,n("p",null,[n("a",w,[s("简介 · electron-vue (gitbooks.io)"),t(a)])]),f,n("p",null,[s("解决： "),n("a",q,[s("(196条消息) Object.fromEntries is not a function electron-vue报错_24k唇动的博客-CSDN博客"),t(a)])]),x,n("p",null,[n("a",_,[s("electron-vue build的坑 - 简书 (jianshu.com)"),t(a)])]),n("p",null,[n("a",j,[s("基于Electron搭建跨平台应用程序 - leestar54 - 博客园 (cnblogs.com)"),t(a)])]),E,W,I,n("p",null,[s("解决： "),n("a",M,[s("(196条消息) Uncaught TypeError: (0 , vue__WEBPACK_IMPORTED_MODULE_3__.createVNode) is not a function_潮汐未见潮落的博客-CSDN博客"),t(a)])]),B,n("p",null,[n("a",D,[s("Electron 中的原生菜单 - 掘金 (juejin.cn)"),t(a)])]),S,n("p",null,[s("菜单栏部分配置可查看 "),n("a",T,[s("Electron 编写菜单栏 - Mr. Ma's Blog (misterma.com)"),t(a)])]),R,n("p",null,[s("借鉴 "),n("a",C,[s("vue + electronの文件读写_Electron_空城机_InfoQ写作社区"),t(a)]),s(),n("a",A,[s("Menu | Electron (electronjs.org)"),t(a)])]),V,n("p",null,[s("官网："),n("a",N,[s("快速上手 - qiankun (umijs.org)"),t(a)])]),n("p",null,[s("参考："),n("a",L,[s("基于qiankun（乾坤）的微前端实践总结 - 掘金 (juejin.cn)"),t(a)]),s(),n("a",O,[s("qiankun-demo: 基于qiankun（乾坤）框架的微前端实践demo (gitee.com)"),t(a)])]),P,n("p",null,[s("子应用 vue.config.js配置如下代码，否则会报错，错误和原因 应该是 application ‘xxx‘ died in status LOADING_SOURCE_CODE: "),n("a",U,[s("qiankun] You need to export lifecycle functio_喜樂的CC的博客-CSDN博客"),t(a)])]),z])}const J=p(l,[["render",$],["__file","desk.html.vue"]]);export{J as default};
