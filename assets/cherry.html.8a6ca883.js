import{_ as l}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as t,c as r,a as n,b as e,e as i,f as a,r as d}from"./app.57c9ff20.js";const c="/blog/press4.png",o="/blog/press1.png",p="/blog/press2.png",v="/blog/press3.png",u={},m=a('<h1 id="vuepress-and-nginx-and-docker" tabindex="-1"><a class="header-anchor" href="#vuepress-and-nginx-and-docker" aria-hidden="true">#</a> vuePress and nginx and docker</h1><h2 id="vuepress基本使用-部署github" tabindex="-1"><a class="header-anchor" href="#vuepress基本使用-部署github" aria-hidden="true">#</a> vuePress基本使用（部署github）</h2><h2 id="非自动化部署" tabindex="-1"><a class="header-anchor" href="#非自动化部署" aria-hidden="true">#</a> (非自动化部署)</h2><p>github 创建仓库 blog<br> 在 blog 下新建分支 gh-pages</p><p><img src="'+c+'" alt="press1" loading="lazy"></p><p>切换分支到 gh-pages<br> 本地新建 blog 文件夹 连接远程 github仓库<br> 在blog文件夹下下载配置vuepress,并将源代码打包<br> 在github的blog仓库下的settings里面设置git pages,切换到gh-pages<br> 将打包后的dist目录下的文件上传至github的gh-pages 分支。</p><p><img src="'+o+'" alt="press1" loading="lazy"></p><p><img src="'+p+'" alt="press1" loading="lazy"></p>',8),b={href:"https://fankozhang.github.io/blog/",target:"_blank",rel:"noopener noreferrer"},h=a('<p><img src="'+v+`" alt="press1" loading="lazy"></p><p>如果出现样式不显示问题，记得修改base路径<br> 一般base路径改成 &#39; /blog/&#39; ，视自己的文件而定。</p><h2 id="自动化部署" tabindex="-1"><a class="header-anchor" href="#自动化部署" aria-hidden="true">#</a> （自动化部署）</h2><p>github 创建仓库 blog</p><p>本地新建 blog 文件夹 连接远程 github仓库</p><p>在本地blog文件夹中编写源码，在package.json中配置如下的运行命令。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> &quot;scripts&quot;: {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="nginx跨域配置" tabindex="-1"><a class="header-anchor" href="#nginx跨域配置" aria-hidden="true">#</a> nginx跨域配置</h3>`,24),$={href:"https://blog.csdn.net/qq_38011415/article/details/107095403",target:"_blank",rel:"noopener noreferrer"},Z=a(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>server <span class="token punctuation">{</span>
        listen       <span class="token number">90</span><span class="token punctuation">;</span>
        server_name  localhost<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="nginx中的upstream指令参数" tabindex="-1"><a class="header-anchor" href="#nginx中的upstream指令参数" aria-hidden="true">#</a> nginx中的upstream指令参数</h3>`,6),H={href:"https://blog.csdn.net/qq_44299529/article/details/122946397",target:"_blank",rel:"noopener noreferrer"},W=n("h3",{id:"nginx控制浏览器缓存",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#nginx控制浏览器缓存","aria-hidden":"true"},"#"),e(" nginx控制浏览器缓存")],-1),X=n("p",null,"expires用于对缓存的设置（可以在server里面配置，也可以在location里面配置）",-1),F={href:"https://cloud.tencent.com/developer/article/1918457",target:"_blank",rel:"noopener noreferrer"},J=a(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>server {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="nginx搭建高可用集群" tabindex="-1"><a class="header-anchor" href="#nginx搭建高可用集群" aria-hidden="true">#</a> nginx搭建高可用集群</h3><p>高可用：一般指2台机器启动着相同的业务系统，当有一台机器down机了，另外一台服务器能快速的接管，对于访问当用户是无感知的</p><p>nginx+keepalived</p>`,6),Y={href:"https://juejin.cn/post/7025845075217219614",target:"_blank",rel:"noopener noreferrer"},Q={href:"https://developer.aliyun.com/article/885619",target:"_blank",rel:"noopener noreferrer"},R=n("h2",{id:"docker",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#docker","aria-hidden":"true"},"#"),e(" docker")],-1),nn={href:"https://www.bilibili.com/video/BV1gr4y1U7CY/?spm_id_from=333.337.search-card.all.click&vd_source=f25f5a8d75a3a60d5a288f726803ec11",target:"_blank",rel:"noopener noreferrer"},en={href:"https://www.aliyundrive.com/s/nh9WKM1ZG6A",target:"_blank",rel:"noopener noreferrer"};function sn(an,ln){const s=d("ExternalLinkIcon");return t(),r("div",null,[m,n("p",null,[e("在访问github pages显示的地址就可以了，我的地址是 "),n("a",b,[e("https://fankozhang.github.io/blog/"),i(s)])]),h,n("p",null,[e("当真正想搞一个vuepree文档网站的时候，不一定从头搭建，可以使用适应的主题，使用主题可以实现快速搭建项目，主题可以自己搜索，我使用的主题是 "),n("a",g,[e("vuepress-theme-hope "),i(s)])]),_,n("p",null,[n("a",x,[e("参考视频 nginx_哔哩哔哩_bilibili"),i(s)])]),n("p",null,[n("a",k,[e("参考博客专栏"),i(s)])]),n("p",null,[n("a",f,[e("Nginx expires 页面缓存时间配置 (w3schools.cn)"),i(s)])]),w,z,n("p",null,[n("a",y,[e("Linux Nginx安装及使用 - 掘金 (juejin.cn)"),i(s)])]),n("p",null,[n("a",C,[e("Linux安装Nginx - 掘金 (juejin.cn)"),i(s)])]),j,n("p",null,[n("a",q,[e("(141条消息) 故障排查（Nginx服务启动失败）报错：still could not bind()_吃不吃西红柿的博客-CSDN博客"),i(s)])]),n("p",null,[n("a",A,[e("emerg] still could not bind()怎么解决_一枝风的博客-CSDN博客"),i(s)])]),N,n("p",null,[n("a",E,[e("(关于nginx新增对外开放端口的问题_nginx开放端口"),i(s)])]),P,S,T,D,n("p",null,[n("a",L,[e("Nginx 生产推荐配置以及日志切割清理 )"),i(s)])]),n("p",null,[e("创建定时任务 "),n("a",U,[e("(141条消息) Linux 定时执行shell 脚本_spearhead_cai的博客-CSDN博客"),i(s)])]),G,n("p",null,[n("a",O,[e("http://192.168.64.128:90/"),i(s)]),e(" 这个会访问到第一个的location的文件")]),n("p",null,[n("a",B,[e("http://192.168.64.128:90/assets/12345678.png"),i(s)]),e(" 这个会访问到第二个的location的文件（静态资源）")]),n("p",null,[n("a",I,[e("http://192.168.64.128:90/static/12345678.png)"),i(s)]),e(" 这个会访问到第三个的location的文件，路径设置别名，访问到的内容一样（静态资源）")]),V,n("p",null,[n("a",K,[e("参考文章 Nginx优化之gzip压缩提升网站速度_苦艾酒丶的博客-CSDN博客"),i(s)])]),M,n("p",null,[e("参考文章 "),n("a",$,[e("(141条消息) Nginx跨域配置_程序员小强的博客-CSDN博客_nginx 跨域"),i(s)])]),Z,n("p",null,[n("a",H,[e("nginx中的upstream指令参数__nginx upstream参数"),i(s)])]),W,X,n("p",null,[n("a",F,[e("nginx expires配置详解 - 腾讯云开发者社区-腾讯云 (tencent.com)"),i(s)])]),J,n("p",null,[n("a",Y,[e("手把手教你nginx生产环境下高可用环境搭建 - 掘金 (juejin.cn)"),i(s)])]),n("p",null,[n("a",Q,[e("Nginx+keepalived实现高可用集群-阿里云开发者社区 (aliyun.com)"),i(s)])]),R,n("p",null,[n("a",nn,[e("视频地址 2022版 尚硅谷Docker实战教程_哔哩哔哩_bilibili"),i(s)])]),n("p",null,[e("资料 ："),n("a",en,[e("https://www.aliyundrive.com/s/nh9WKM1ZG6A"),i(s)])])])}const dn=l(u,[["render",sn],["__file","cherry.html.vue"]]);export{dn as default};
