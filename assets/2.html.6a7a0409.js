...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="边框样式" tabindex="-1"><a class="header-anchor" href="#边框样式" aria-hidden="true">#</a> 边框样式</h2>`,13),_={href:"https://blog.csdn.net/blbyu/article/details/128710565",target:"_blank",rel:"noopener noreferrer"},y=e(`<h2 id="css阴影" tabindex="-1"><a class="header-anchor" href="#css阴影" aria-hidden="true">#</a> css阴影</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>box-shadow: 10px 10px 5px #888888;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>包含两个参数值，分别表示X轴和Y轴倾斜的角度，如果第二个参数为空，则默认为0，参数为负表示向相反方向倾斜。</p><p>1 skewX();表示只在X轴(水平方向)倾斜。</p><p>2 skewY();表示只在Y轴(垂直方向)倾斜。</p><p>transform: skew(30deg,20deg); 元素在 <strong>X</strong> 轴和 <strong>Y</strong> 轴上倾斜 20 度 30 度。</p><h4 id="matrix-方法-2d变换方法合并成一个" tabindex="-1"><a class="header-anchor" href="#matrix-方法-2d变换方法合并成一个" aria-hidden="true">#</a> matrix() 方法 2D变换方法合并成一个</h4><p>有六个参数，包含旋转，缩放，移动（平移）和倾斜功能。</p><p>transform:matrix(0.866,0.5,-0.5,0.866,0,0);</p><h2 id="css-3d-转换" tabindex="-1"><a class="header-anchor" href="#css-3d-转换" aria-hidden="true">#</a> css 3D 转换</h2><h4 id="rotatex-围绕其在一个给定度数x轴旋转的元素。" tabindex="-1"><a class="header-anchor" href="#rotatex-围绕其在一个给定度数x轴旋转的元素。" aria-hidden="true">#</a> rotateX() 围绕其在一个给定度数X轴旋转的元素。</h4><p>transform: rotateX(120deg); 沿着x轴转动120度</p><h4 id="rotatey-围绕其在一个给定度数y轴旋转的元素。" tabindex="-1"><a class="header-anchor" href="#rotatey-围绕其在一个给定度数y轴旋转的元素。" aria-hidden="true">#</a> rotateY() 围绕其在一个给定度数Y轴旋转的元素。</h4><p>transform: rotateY(120deg); 沿着y轴转动120度</p><h2 id="css3-过渡" tabindex="-1"><a class="header-anchor" href="#css3-过渡" aria-hidden="true">#</a> css3 过渡</h2>`,50),S={href:"https://www.runoob.com/cssref/css3-pr-transition.html",target:"_blank",rel:"noopener noreferrer"},z=n("th",null,"简写属性，用于在一个属性中设置四个过渡属性。",-1),C=n("th",null,"3",-1),j={href:"https://www.runoob.com/cssref/css3-pr-transition-property.html",target:"_blank",rel:"noopener noreferrer"},N=n("td",null,"规定应用过渡的 CSS 属性的名称。",-1),Y=n("td",null,"3",-1),X={href:"https://www.runoob.com/cssref/css3-pr-transition-duration.html",target:"_blank",rel:"noopener noreferrer"},E=n("td",null,"定义过渡效果花费的时间。默认是 0。",-1),D=n("td",null,"3",-1),B={href:"https://www.runoob.com/cssref/css3-pr-transition-timing-function.html",target:"_blank",rel:"noopener noreferrer"},T=n("td",null,'规定过渡效果的时间曲线。默认是 "ease"。',-1),V=n("td",null,"3",-1),F={href:"https://www.runoob.com/cssref/css3-pr-transition-delay.html",target:"_blank",rel:"noopener noreferrer"},A=n("td",null,"规定过渡效果何时开始。默认是 0。",-1),G=n("td",null,"3",-1),U=e('<blockquote><p>transition-property: width;</p><p>transition-duration: 1s;</p><p>transition-timing-function: linear;</p><p>transition-delay: 2s;</p></blockquote><p>等效于</p><blockquote><p>transition: width 1s linear 2s;</p></blockquote><p>transition-timing-function的可取值如下表所示</p><table><thead><tr><th style="text-align:left;">值</th><th style="text-align:left;">描述</th></tr></thead><tbody><tr><td style="text-align:left;">linear</td><td style="text-align:left;">规定以相同速度开始至结束的过渡效果（等于 cubic-bezier(0,0,1,1)）。</td></tr><tr><td style="text-align:left;">ease</td><td style="text-align:left;">规定慢速开始，然后变快，然后慢速结束的过渡效果（cubic-bezier(0.25,0.1,0.25,1)）。</td></tr><tr><td style="text-align:left;">ease-in</td><td style="text-align:left;">规定以慢速开始的过渡效果（等于 cubic-bezier(0.42,0,1,1)）。</td></tr><tr><td style="text-align:left;">ease-out</td><td style="text-align:left;">规定以慢速结束的过渡效果（等于 cubic-bezier(0,0,0.58,1)）。</td></tr><tr><td style="text-align:left;">ease-in-out</td><td style="text-align:left;">规定以慢速开始和结束的过渡效果（等于 cubic-bezier(0.42,0,0.58,1)）。</td></tr><tr><td style="text-align:left;">cubic-bezier(<em>n</em>,<em>n</em>,<em>n</em>,<em>n</em>)</td><td style="text-align:left;">在 cubic-bezier 函数中定义自己的值。可能的值是 0 至 1 之间的数值。</td></tr></tbody></table><h2 id="css3-动画" tabindex="-1"><a class="header-anchor" href="#css3-动画" aria-hidden="true">#</a> CSS3 动画</h2>',6),L=n("thead",null,[n("tr",null,[n("th",{style:{"text-align":"left"}},"属性"),n("th",{style:{"text-align":"left"}},"描述"),n("th",{style:{"text-align":"left"}},"CSS")])],-1),H={style:{"text-align":"left"}},O={href:"https://www.runoob.com/cssref/css3-pr-animation-keyframes.html",target:"_blank",rel:"noopener noreferrer"},I=n("td",{style:{"text-align":"left"}},"规定动画。",-1),P=n("td",{style:{"text-align":"left"}},"3",-1),J={style:{"text-align":"left"}},M={href:"https://www.runoob.com/cssref/css3-pr-animation.html",target:"_blank",rel:"noopener noreferrer"},R=n("td",{style:{"text-align":"left"}},"所有动画属性的简写属性。",-1),$=n("td",{style:{"text-align":"left"}},"3",-1),Q={style:{"text-align":"left"}},W={href:"https://www.runoob.com/cssref/css3-pr-animation-name.html",target:"_blank",rel:"noopener noreferrer"},K=n("td",{style:{"text-align":"left"}},"规定 @keyframes 动画的名称。",-1),Z=n("td",{style:{"text-align":"left"}},"3",-1),nn={style:{"text-align":"left"}},sn={href:"https://www.runoob.com/cssref/css3-pr-animation-duration.html",target:"_blank",rel:"noopener noreferrer"},an=n("td",{style:{"text-align":"left"}},"规定动画完成一个周期所花费的秒或毫秒。默认是 0。",-1),tn=n("td",{style:{"text-align":"left"}},"3",-1),en={style:{"text-align":"left"}},ln={href:"https://www.runoob.com/cssref/css3-pr-animation-timing-function.html",target:"_blank",rel:"noopener noreferrer"},pn=n("td",{style:{"text-align":"left"}},'规定动画的速度曲线。默认是 "ease"。',-1),on=n("td",{style:{"text-align":"left"}},"3",-1),cn={style:{"text-align":"left"}},dn={href:"https://www.runoob.com/cssref/css3-pr-animation-fill-mode.html",target:"_blank",rel:"noopener noreferrer"},rn=n("td",{style:{"text-align":"left"}},"规定当动画不播放时（当动画完成时，或当动画有一个延迟未开始播放时），要应用到元素的样式。",-1),un=n("td",{style:{"text-align":"left"}},"3",-1),vn={style:{"text-align":"left"}},kn={href:"https://www.runoob.com/cssref/css3-pr-animation-delay.html",target:"_blank",rel:"noopener noreferrer"},mn=n("td",{style:{"text-align":"left"}},"规定动画何时开始。默认是 0。",-1),gn=n("td",{style:{"text-align":"left"}},"3",-1),bn={style:{"text-align":"left"}},hn={href:"https://www.runoob.com/cssref/css3-pr-animation-iteration-count.html",target:"_blank",rel:"noopener noreferrer"},fn=n("td",{style:{"text-align":"left"}},"规定动画被播放的次数。默认是 1。",-1),xn=n("td",{style:{"text-align":"left"}},"3",-1),_n={style:{"text-align":"left"}},yn={href:"https://www.runoob.com/cssref/css3-pr-animation-direction.html",target:"_blank",rel:"noopener noreferrer"},wn=n("td",{style:{"text-align":"left"}},'规定动画是否在下一周期逆向地播放。默认是 "normal"。',-1),qn=n("td",{style:{"text-align":"left"}},"3",-1),Sn={style:{"text-align":"left"}},zn={href:"https://www.runoob.com/cssref/css3-pr-animation-play-state.html",target:"_blank",rel:"noopener noreferrer"},Cn=n("td",{style:{"text-align":"left"}},'规定动画是否正在运行或暂停。默认是 "running"。',-1),jn=n("td",{style:{"text-align":"left"}},"3",-1),Nn=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 以下是最通常的用法
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>animation-timing-function:linear;</p><p>animation-timing-function使用的数学函数，称为三次贝塞尔曲线，速度曲线。使用此函数，您可以使用您自己的值，或使用预先定义的值之一：</p>`,3),Yn=n("thead",null,[n("tr",null,[n("th",{style:{"text-align":"left"}}),n("th",{style:{"text-align":"left"}}),n("th",{style:{"text-align":"left"}})])],-1),Xn=n("tr",null,[n("td",{style:{"text-align":"left"}},"值"),n("td",{style:{"text-align":"left"}},"描述"),n("td",{style:{"text-align":"left"}},"测试")],-1),En=n("td",{style:{"text-align":"left"}},"linear",-1),Dn=n("td",{style:{"text-align":"left"}},"动画从头到尾的速度是相同的。",-1),Bn={style:{"text-align":"left"}},Tn={href:"https://www.runoob.com/try/playit.php?f=animation-timing-function&preval=linear",target:"_blank",rel:"noopener noreferrer"},Vn=n("td",{style:{"text-align":"left"}},"ease",-1),Fn=n("td",{style:{"text-align":"left"}},"默认。动画以低速开始，然后加快，在结束前变慢。",-1),An={style:{"text-align":"left"}},Gn={href:"https://www.runoob.com/try/playit.php?f=animation-timing-function&preval=ease",target:"_blank",rel:"noopener noreferrer"},Un=n("td",{style:{"text-align":"left"}},"ease-in",-1),Ln=n("td",{style:{"text-align":"left"}},"动画以低速开始。",-1),Hn={style:{"text-align":"left"}},On={href:"https://www.runoob.com/try/playit.php?f=animation-timing-function&preval=ease-in",target:"_blank",rel:"noopener noreferrer"},In=n("td",{style:{"text-align":"left"}},"ease-out",-1),Pn=n("td",{style:{"text-align":"left"}},"动画以低速结束。",-1),Jn={style:{"text-align":"left"}},Mn={href:"https://www.runoob.com/try/playit.php?f=animation-timing-function&preval=ease-out",target:"_blank",rel:"noopener noreferrer"},Rn=n("td",{style:{"text-align":"left"}},"ease-in-out",-1),$n=n("td",{style:{"text-align":"left"}},"动画以低速开始和结束。",-1),Qn={style:{"text-align":"left"}},Wn={href:"https://www.runoob.com/try/playit.php?f=animation-timing-function&preval=ease-in-out",target:"_blank",rel:"noopener noreferrer"},Kn=n("tr",null,[n("td",{style:{"text-align":"left"}},"steps(int,start|end)"),n("td",{style:{"text-align":"left"}},"指定了时间函数中的间隔数量（步长）。有两个参数，第一个参数指定函数的间隔数，该参数是一个正整数（大于 0）。 第二个参数是可选的，表示动画是从时间段的开头连续还是末尾连续。含义分别如下：start：表示直接开始。end：默认值，表示戛然而止。"),n("td",{style:{"text-align":"left"}})],-1),Zn=n("tr",null,[n("td",{style:{"text-align":"left"}},[s("cubic-bezier("),n("em",null,"n"),s(","),n("em",null,"n"),s(","),n("em",null,"n"),s(","),n("em",null,"n"),s(")")]),n("td",{style:{"text-align":"left"}},"在 cubic-bezier 函数中自己的值。可能的值是从 0 到 1 的数值。"),n("td",{style:{"text-align":"left"}})],-1),ns=e(`<h2 id="background-size-cover和contain以及100" tabindex="-1"><a class="header-anchor" href="#background-size-cover和contain以及100" aria-hidden="true">#</a> background-size：cover和contain以及100%**</h2><p><code>contain</code>:<strong>图片放大至满足背景区域的最小边即止</strong>，当背景区域与背景图片的宽高比不一致的情况下，<strong>背景区域可能会长边下有空白覆盖不全</strong>。<code>cover</code>:<strong>图片放大至能满足最大变时为止</strong>，当背景区域与背景图片的宽高比不一致时，<strong>背景图片会在短边下有裁切，显示不全</strong>。</p><p><code>百分比</code>:可以设置两个值</p><ul><li><p>第一个设置宽度，第二个设置高度</p></li><li><p>如果只设置了一个值，那么第二个值默认会被设置为<code>auto</code></p></li></ul><h2 id="elementui样式修改的方式" tabindex="-1"><a class="header-anchor" href="#elementui样式修改的方式" aria-hidden="true">#</a> <strong>elementui样式修改的方式:</strong></h2><h4 id="样式穿透" tabindex="-1"><a class="header-anchor" href="#样式穿透" aria-hidden="true">#</a> 样式穿透</h4><p><code>vue</code>项目中，在修改<code>elementui</code>的样式时通常使用样式穿透，<code>style</code>使用<code>css</code>的预处理器(<code>less</code>, <code>sass</code>, <code>scss</code>)等， 即</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;style lang=&quot;less&quot; scoped&gt;
&lt;/style&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10),ss={href:"https://blog.csdn.net/Yukinoshita_kino/article/details/117259198",target:"_blank",rel:"noopener noreferrer"},as=e(`<h4 id="使用样式穿透还是无效" tabindex="-1"><a class="header-anchor" href="#使用样式穿透还是无效" aria-hidden="true">#</a> 使用样式穿透还是无效</h4><p>有时会发现使用了以上方法修改 element 组件样式还是会不生效，对于这种情况可以重写一个style标签，在style标签里对需要穿透的样式进行修改</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;style lang=&quot;less&quot; scoped&gt;
&lt;/style&gt;
&lt;style lang=&quot;less&quot;&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),ts={href:"https://blog.csdn.net/qq_42611074/article/details/120674761",target:"_blank",rel:"noopener noreferrer"},es=e(`<p>不显示滚动条</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>::-webkit-scrollbar {
        width: 0px;
    }
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),is={href:"https://www.php.cn/faq/477233.html",target:"_blank",rel:"noopener noreferrer"},ls=n("div",{class:"language-text line-numbers-mode","data-ext":"text"},[n("pre",{class:"language-text"},[n("code",null,`::-webkit-scrollbar {display:none}
`)]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"})])],-1),ps={href:"https://mp.weixin.qq.com/s/qiPO46N-wrYCfO9nHMdACw",target:"_blank",rel:"noopener noreferrer"},os=n("h2",{id:"vue-项目引入animate-css",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue-项目引入animate-css","aria-hidden":"true"},"#"),s(" vue 项目引入animate.css")],-1),cs={href:"https://animate.style/",target:"_blank",rel:"noopener noreferrer"},ds=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm install animate.css --save
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="实现页脚始终在页面底部" tabindex="-1"><a class="header-anchor" href="#实现页脚始终在页面底部" aria-hidden="true">#</a> 实现页脚始终在页面底部</h2>`,39),vs={href:"https://www.jb51.net/css/838364.html",target:"_blank",rel:"noopener noreferrer"},ks=e(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;div class=&quot;all-container&quot;&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="css实现聊天对话框" tabindex="-1"><a class="header-anchor" href="#css实现聊天对话框" aria-hidden="true">#</a> css实现聊天对话框</h2>`,7),ms={href:"https://juejin.cn/post/7000250044976726024",target:"_blank",rel:"noopener noreferrer"},gs=n("h2",{id:"",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#","aria-hidden":"true"},"#")],-1);function bs(hs,fs){const a=c("ExternalLinkIcon");return p(),o("div",null,[i(`
 ...
 * @param: 
 * @return: 
`),r,i(" icon: edit "),u,n("p",null,[n("a",v,[s("Grid网格布局实例 - 掘金 (juejin.cn)"),t(a)])]),n("p",null,[n("a",k,[s("CSS Grid 网格布局教程 - 阮一峰的网络日志 (ruanyifeng.com)"),t(a)])]),n("p",null,[s("grid布局调试：["),n("a",m,[s("CSS Grid Generator (cssgrid-generator.netlify.app)"),t(a)])]),n("p",null,[n("a",g,[s("grid - CSS：层叠样式表 | MDN (mozilla.org)"),t(a)])]),n("p",null,[n("a",b,[s("CSS 网格布局 | 菜鸟教程 (runoob.com)"),t(a)])]),h,n("p",null,[n("a",f,[s("JS如何判断文字被ellipsis了？ 微信公众平台 (qq.com)"),t(a)])]),x,n("p",null,[n("a",_,[s("CSS给元素添加边框（样式、颜色、宽度）_css加边框-CSDN博客"),t(a)])]),y,n("p",null,[n("a",w,[s("CSS 两行文字两端对齐与字符间距的处理 (qq.com)"),t(a)])]),q,n("table",null,[n("thead",null,[n("tr",null,[n("th",null,[n("a",S,[s("transition"),t(a)])]),z,C])]),n("tbody",null,[n("tr",null,[n("td",null,[n("a",j,[s("transition-property"),t(a)])]),N,Y]),n("tr",null,[n("td",null,[n("a",X,[s("transition-duration"),t(a)])]),E,D]),n("tr",null,[n("td",null,[n("a",B,[s("transition-timing-function"),t(a)])]),T,V]),n("tr",null,[n("td",null,[n("a",F,[s("transition-delay"),t(a)])]),A,G])])]),U,n("table",null,[L,n("tbody",null,[n("tr",null,[n("td",H,[n("a",O,[s("@keyframes"),t(a)])]),I,P]),n("tr",null,[n("td",J,[n("a",M,[s("animation"),t(a)])]),R,$]),n("tr",null,[n("td",Q,[n("a",W,[s("animation-name"),t(a)])]),K,Z]),n("tr",null,[n("td",nn,[n("a",sn,[s("animation-duration"),t(a)])]),an,tn]),n("tr",null,[n("td",en,[n("a",ln,[s("animation-timing-function"),t(a)])]),pn,on]),n("tr",null,[n("td",cn,[n("a",dn,[s("animation-fill-mode"),t(a)])]),rn,un]),n("tr",null,[n("td",vn,[n("a",kn,[s("animation-delay"),t(a)])]),mn,gn]),n("tr",null,[n("td",bn,[n("a",hn,[s("animation-iteration-count"),t(a)])]),fn,xn]),n("tr",null,[n("td",_n,[n("a",yn,[s("animation-direction"),t(a)])]),wn,qn]),n("tr",null,[n("td",Sn,[n("a",zn,[s("animation-play-state"),t(a)])]),Cn,jn])])]),Nn,n("table",null,[Yn,n("tbody",null,[Xn,n("tr",null,[En,Dn,n("td",Bn,[n("a",Tn,[s("测试"),t(a)])])]),n("tr",null,[Vn,Fn,n("td",An,[n("a",Gn,[s("测试"),t(a)])])]),n("tr",null,[Un,Ln,n("td",Hn,[n("a",On,[s("测试"),t(a)])])]),n("tr",null,[In,Pn,n("td",Jn,[n("a",Mn,[s("测试"),t(a)])])]),n("tr",null,[Rn,$n,n("td",Qn,[n("a",Wn,[s("测试"),t(a)])])]),Kn,Zn])]),ns,n("p",null,[n("a",ss,[s("the ＞＞＞ and /deep/ combinators have been deprecated. Use :deep() instead终端报该警告的解决办法_霜雪遥的博客-CSDN博客"),t(a)]),s(" (警告不影响正常运行)")]),as,n("p",null,[n("a",ts,[s("css-滚动但不显示滚动条的两种写法_css不显示滚动条但可以滚动_永远不会太晚的博客-CSDN博客"),t(a)])]),es,n("p",null,[n("a",is,[s("https://www.php.cn/faq/477233.html"),t(a)])]),ls,n("p",null,[n("a",ps,[s("裁剪的3种方式，CSS 如何隐藏移动端的滚动条？ (qq.com)"),t(a)])]),os,n("p",null,[n("a",cs,[s("Animate.css | A cross-browser library of CSS animations."),t(a)])]),ds,n("p",null,[n("a",rs,[s("iconfont-阿里巴巴矢量图标库"),t(a)])]),us,n("p",null,[n("a",vs,[s("css让页脚保持在底部位置的四种方案_CSS教程_CSS_网页制作_脚本之家 (jb51.net)"),t(a)])]),ks,n("p",null,[n("a",ms,[s("css实现聊天对话框 - 掘金 (juejin.cn)"),t(a)])]),gs])}const ys=l(d,[["render",bs],["__file","2.html.vue"]]);export{ys as default};
